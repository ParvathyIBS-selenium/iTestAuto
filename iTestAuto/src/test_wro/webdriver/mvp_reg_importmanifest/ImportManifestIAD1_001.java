...
public class ImportManifestIAD1_001 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("TransitAirport", WebFunctions.getPropertyValue(custproppath, "WRO"));
			map.put("OriginAirport", WebFunctions.getPropertyValue(custproppath, "LCJ"));
			map.put("DestinationAirport", WebFunctions.getPropertyValue(custproppath, "CDG"));
			map.put("TransitCountry", WebFunctions.getPropertyValue(custproppath, "creditCustomercountryId_PL"));
