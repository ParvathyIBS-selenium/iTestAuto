package rapix;
/**  TC_02_Verify block is not released when screening is received as FAIL for a AWB from RAPIX.-HHT  **/
...
public class SaveAWBScreening_TC_8977 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/******* POST REQUEST - PAWBS with Fail Status ****/	
			...
			/***** OPR023 - AWB Clearance *******/            
			//Verify that Screening block is retained
			cust.searchScreen("OPR023", "AWB Clearance");
			OPR023.listAWB("CarrierNumericCode","AWBNo");
			OPR023.verifyBlock(cust.data("BlockType"), cust.data("AWBNo"));
			OPR023.verifySCCs("val~NSC");
			...
			//Verify RFC is not stamped and Acceptance is not finalised
