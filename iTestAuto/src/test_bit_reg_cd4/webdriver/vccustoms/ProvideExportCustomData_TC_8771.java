...
//Verify MRN retrieval to Icargo from VCCustoms interface as part of Manual retrieval
public class ProvideExportCustomData_TC_8771 extends BaseSetup {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) throws IOException {
		...
		try {
			...
			OPR026.verifyOCIDetails("val~ECS","InfoId", "CustomsInfoId", "MRN");
            OPR026.clickSave();
