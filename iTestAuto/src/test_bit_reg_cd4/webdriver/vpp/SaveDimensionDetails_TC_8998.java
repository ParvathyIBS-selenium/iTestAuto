package vpp;
/**      TC02_Verify details provided in SFMI request are reflected in iCargo.    **/
...
public class SaveDimensionDetails_TC_8998 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR335.saveAcceptanceWithBlockExists("Weighing Not Completed");
			...
			map.put("SU", cust.data("awbNumber")+"001");
			WHS009.enterSU("SU");
			WHS009.listAwbDetails();
			//Full Relocation to VPP Entry Point
			WHS009.markCheckbox();
			WHS009.clickFullRelocationButton();
			WHS009.enterDestinationLocAndSU("VPPEntryPoint","SU");
			cust.switchToMainScreen("WHS009");
			WHS009.clickSaveButton();
			cust.closeTab("WHS009", "Warehouse Relocation");
			
			/******* POST REQUEST - Triggering SFMI EVENT ****/		
			jsonbody.postRequest(cust.data("awbNumber"),cust.data("SUWeight"),cust.data("SUVolume"),cust.data("Length"),cust.data("Width"),cust.data("Height"));
		
			/**** OPR335 -Goods Acceptance****/
			cust.searchScreen("OPR335", "Goods Acceptance");
			cust.listAWB("AWBNo", "CarrierNumericCode", "Goods Acceptance");
			OPR335.verifyAWBDetails("Pieces", "Weight", "Volume");
			//Verifying SFMI details
			OPR335.verifySUWeightAndVolume("SUWeight","SUVolume");
			OPR335.verifyDimensionDetails("Length","Width","Height","SUWeight","SUVolume");
			OPR335.verifyDimensionPieces("Pieces");
