...
/**  CheckSheet capture at export manifest and verify in Patriarch System - ULD and Loose Shipment    **/
...
public class ExportManifestChecksheet_TC_3061 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR344.verifyShipmentInPlannedSection("AWBNo2");
			OPR344.clickShipemntFromPlannedSection("AWBNo2");
			OPR344.selectULD("val~BULK");
			...
			map.put("pmKey",cust.data("val~BULK")+cust.data("CarrierNumericCode")+cust.data("AWBNo2")+"11");
			OPR344.clickCheckSheet("pmKey");
			OPR344.captureCheckSheet(true);
