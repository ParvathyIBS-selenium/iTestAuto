package wcs;
/**  TC_07_Verify iCargo  assigns (buildup) the Cart to the flight after UOB message is received from WCS to icargo   **/
...
public class ActionStorageUnit_TC_10349 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Create New Cart
			String cartNo = cust.create_uld_number("UldType", "carrierCode");
			map.put("CartNum", cartNo);
			map.put("CartNo", cust.data("CartNum").replaceAll("[^0-9]", ""));

			/******* POST REQUEST ****/		
			jsonbody.postRequest("Cart",cust.data("UldType"),cust.data("CartNo"),cust.data("carrierCode"),cust.data("Destination"),flightdate,cust.data("FlightNo"));

			/**** OPR344 - Export manifest****/
			cust.searchScreen("OPR344", "Export manifest");
			OPR344.listFlight("carrierCode", "FlightNo","StartDate");
			OPR344.verifyULDInAssignedShipment("CartNum",true);
			OPR344.clickShipemntFromPlannedSection("AWBNo");
			OPR344.clickShipemntFromPlannedSection("AWBNo2");
			OPR344.selectULD("CartNum");
			OPR344.clickBuildUpComplete();
			OPR344.verifyBuildUpComplete("CartNum");
