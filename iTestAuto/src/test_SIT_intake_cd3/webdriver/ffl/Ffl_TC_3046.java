...
/**************TC_01_Verify ULD is offloaded from the flight when FFL offloading pieces and weight is same as build up pieces and weight..********/

public class Ffl_TC_3046 extends BaseSetup {
	int counter = 0;
