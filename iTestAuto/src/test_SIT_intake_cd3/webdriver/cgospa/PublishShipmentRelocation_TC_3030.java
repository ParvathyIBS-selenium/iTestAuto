...
/**TC_06_Verify shipment location details during partial loose acceptance via HHT  to CGOSPA**/
...
public class PublishShipmentRelocation_TC_3030 extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Capture Remaining pieces and weight
			gahht.enterLooseAcceptanceDetails("Pieces2", "Weight2", "Location1");
			...
			jsonbody1.postRequest(cust.data("awbNumber"),cust.data("Weight1"),cust.data("ShipmentVolume"),cust.data("val~10"),cust.data("val~10"),cust.data("val~10"),"001"+cust.data("awbNumber"));
			
			/******* SFMI POST REQUEST SU2 ****/		
			jsonbody1.postRequest(cust.data("awbNumber"),cust.data("Weight2"),cust.data("Volume1"),cust.data("val~10"),cust.data("val~10"),cust.data("val~10"),"002"+cust.data("awbNumber"));
			...
			String su =cust.data("CarrierNumericCode")+cust.data("AWBNo")+"001";
			...
			String[] actVerfValues2 ={cust.data("Pieces2"),cust.data("Weight2"),cust.data("HA")+cust.data("Location1")};
            ...
            //built up the shipment to the flight
