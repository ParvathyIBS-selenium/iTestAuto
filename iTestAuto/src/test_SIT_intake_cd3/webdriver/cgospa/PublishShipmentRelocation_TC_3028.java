...
/**TC_04_Verify shipment location details during partial pieces acceptance in ULD via webscreen  to CGOSPA**/
...
public class PublishShipmentRelocation_TC_3028 extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			libr.waitForSync(6);
			OPR335.uldShipmentDetails("Pieces1", "Weight1", "Location", "UldNum", "Contour");
			...
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			libr.waitForSync(6);
			OPR335.addNewULDAcceptance("Pieces2","Weight2", "Location", "UldNum1","Contour");
			OPR335.addULDDetails();
			OPR335.clickSave("OPR335");
			...
			jsonbody1.postRequest(cust.data("AWB"),cust.data("Weight1"),cust.data("Volume1"),cust.data("val~10"),cust.data("val~10"),cust.data("val~10"),cust.data("UldNum"));

			/******* SFMI POST REQUEST ULD No2 ****/		
			jsonbody1.postRequest(cust.data("AWB"),cust.data("Weight2"),cust.data("ShipmentVolume"),cust.data("val~10"),cust.data("val~10"),cust.data("val~10"),cust.data("UldNum1"));
			...
			//verifying scc details for first Uldnum
			Cgospa.verifySCCDetails("UldNum", cust.data("ExpectedSCCs"), cust.data("SCC"));

			//verifying scc details for first Uldnum
			Cgospa.verifySCCDetails("UldNum1", cust.data("ExpectedSCCs"), cust.data("SCC"));
			...
			Cgospa.verifyFlightDetails(verfCols2, actVerfValues2,uld1);		
			libr.quitBrowser();
