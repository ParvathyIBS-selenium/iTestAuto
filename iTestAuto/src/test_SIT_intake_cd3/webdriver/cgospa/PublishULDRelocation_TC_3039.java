...
/**  TC_01_Verify ULD  sighted details sent to CGOSPA at ULD sighting   **/
...
public class PublishULDRelocation_TC_3039 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//verifying the details in publishULDRelocation message reflected in CGOSPA
			String pmkey ="DF";
			int[] verfCols1={13,14};
			...
			//verifying the PublishULDRelocation message details
			...
			MSG005.verifyMessageDetails(verfColsCGOSPADetails, actVerfValuesverfColsCGOSPADetails, pmKeyCGOSPADetails, "val~PublishULDRelocation", false);
			...
			msgContents.add("val~<ns2:sourceWarehouseCode>"+cust.data("WareHouseCode")+"</ns2:sourceWarehouseCode>");	
			...
			msgContents.add("val~<ns2:targetWarehouseCode>"+cust.data("WareHouseCode")+"</ns2:targetWarehouseCode>");	
