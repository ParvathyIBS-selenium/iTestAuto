...
public class UCLS_TC_2960_KL extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cust.printAndVerifyReport("val~CARGO MANIFEST", "OPR344","Flight Number & Date"+"\n" + cust.data("prop~flight_code_KL")+" "+cust.data("FlightNo"),
					cust.data("UldNum"), cust.data("UldNum1"));
			...
			String[] awb2Cont= {cust.data("Contour")};
			...
			cfd.verifyULDDetails(col1,awb2Cont,cust.data("UldNum1"));
			cfd.verifyULDCount(2);
