...
/**  Verify RTI validation when all checks passed (ECS,DGV,Customs) for non eFAST shipments. **/
...
public class getRTIstatus_TC_3099 extends BaseSetup {
