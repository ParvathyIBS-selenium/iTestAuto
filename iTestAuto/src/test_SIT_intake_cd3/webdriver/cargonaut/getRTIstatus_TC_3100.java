...
/**  TC_04_Verify individual validation checks when RTI is NOK - ECS check fails**/
...
public class getRTIstatus_TC_3100 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			TGC013.clickCHIconAndVerifyTooltip("AWBNo","RTI Status","MRN Missing/NOK, please update MRN");					

			TGC013.clickMoreOption("AWBNo");		
			
			/** Capture AWB Screen **/
			TGC013.clickCaptureAwb();
            TGC013.checkStatusOPR026("val~MRN Missing/NOK, please update MRN");
            ...
            /**** OPR023 - AWB Clearance****/
			 ...
			 int[] verfCols={4,8};
			 String[] actVerfValues={cust.data("BlockType"),"Blocked"};
			 OPR023.verifyBlockDetails(verfCols, actVerfValues, "RTI-ECS block auto c");
			 OPR023.releaseBlock("val~RTI Block removed");       
			 OPR023.closeTab("OPR023", "AWB Clearance");
			 
			 /**** OPR023 - AWB Clearance****/
			 cust.searchScreen("OPR023", "AWB Clearance");
			 OPR023.listAWB("CarrierNumericCode","AWBNo");
			 String[] actVerfValues1={cust.data("BlockType"),"Released"};
			 OPR023.verifyBlockDetails(verfCols, actVerfValues1, "RTI Block removed");
			 OPR023.closeTab("OPR023", "AWB Clearance");
			 libr.quitBrowser();
