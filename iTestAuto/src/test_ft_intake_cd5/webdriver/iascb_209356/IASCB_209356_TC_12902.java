...
public class IASCB_209356_TC_12902 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/******* POST REQUEST****/	
			jsonbody.postRequest(cust.data("carrierCode"),cust.data("FlightNo"),flightDate,cust.data("ScreeningResult").split(",")[0],screenmethod,cust.data("Location"),cust.data("ScreenerName"),cust.data("Tokenid"),cust.data("AgentType"));
			...
			OPR339.verifyAgentDetailsAutopopulated("AgentType1", "AgentCountryId", "RegulatedAgentCode");
			...
			TGC010.clickList();
			TGC010.verifyTokenIsunsecured("Tokenid");
