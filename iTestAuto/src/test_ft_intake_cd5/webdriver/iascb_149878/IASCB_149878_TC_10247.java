...
/** TC_33_Verify Updation of only SCCs for short captured AWB based on XFFM or FFM after XFWB process or AWB save when config is set  **/
...
public class IASCB_149878_TC_10247  extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Adding FDCA information
			OPR367.addNewULDInfoWithSCC("val~BULK", "CarrierNumericCode", "AWBNo2", "Pieces", "Weight", "Origin", "Destination", "Pieces", "Weight",2,"SCC");
			OPR367.SaveDetails();
			String ULDNo[]={cust.data("UldNum"),cust.data("val~BULK")};
			//verifying new uld details are displayed
