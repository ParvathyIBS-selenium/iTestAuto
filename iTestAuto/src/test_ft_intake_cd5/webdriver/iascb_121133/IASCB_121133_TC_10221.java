...
/**  TC_01_Verify the split SCC creation in the split popup for a data created via manual buildup and manifest   **/
...
public class IASCB_121133_TC_10221 extends BaseSetup {
	...
	@DataProvider(name = "IASCB_121133_TC_10221")
	...
	@Test(dataProvider = "IASCB_121133_TC_10221")
...
//		
//			/** MSG005-XFSU-BKD Message loading AWB**/
//
...
//
//			// Verifying split shipment details using.
//			OPR335.clickInfoiconforSplitShipment();
//			OPR335.verifysplitshipmentInfoFromInfoIcon(cust.data("SCC").split(",")[0],
//					libr.data("SplitPcs").split(",")[0]);
//			OPR335.verifysplitshipmentInfoFromInfoIcon(cust.data("SCC").split(",")[1],
//					libr.data("SplitPcs").split(",")[1]);
//
//			OPR335.editShipmentLocation("", cust.data("SCC").split(",")[0], cust.data("Location"));
//			OPR335.verifySUNotNull(cust.data("SCC").split(",")[0]);
//			OPR335.editShipmentLocation("", cust.data("SCC").split(",")[1], cust.data("Location1"));
