...
public class IASCB_121133_TC_10221_KL extends BaseSetup {
	...
	@DataProvider(name = "IASCB_121133_TC_10221_KL")
	...
	@Test(dataProvider = "IASCB_121133_TC_10221_KL")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("AWB",cust.data("CarrierNumericCode")+cust.data("prop~AWBNo"));
			...
			OPR026.splitShipmentWithSCC(libr.data("SCC1"), pcs,wgt);
			OPR026.saveAWB();
