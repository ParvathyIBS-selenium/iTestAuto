...
/**
 * 
 *  TC_04_To Verify the AWB No should be in hyperlink  in the Pending acceptance tab on Export planning progress screen

 *
 *
 */

public class IASCB_133016_TC_9210 extends BaseSetup {
		...
		try {
		   ...
		   libr.launchSSTApp("sst-app", true);
			...
			ADD007.clickAwbLink("AWBNo");
              String [] actverf={cust.data("TokenID"),cust.data("VehicleNo"),cust.data("ServicePointMode"),cust.data("SCC")};
			String [] tokenDetails={"Tokenno","vehclno","PurposeofVisit","Nature of shipment"};
			
			ADD007.verifyVisitDeclarationDetails("TokenID","ServicePoint");
			
			ADD007.verifyTokenDetails(actverf,tokenDetails,1);
