...
public class Web_e2e_import_kl  extends BaseSetup {
	...
	@DataProvider(name = "Web_import_kl")
	...
	@Test(dataProvider = "Web_import_kl")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
		   ...
		   /*******Verify xFSU-RCF message in MSG005******/
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyXFSU1=cust.data("prop~CarrierNumericCodeAMS")+" - "+cust.data("prop~AWBNo");
			int verfColsXFSU[]={9};
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyXFSUNFD1 = cust.data("prop~CarrierNumericCodeAMS") + " - " + cust.data("prop~AWBNo");
