...
public class SST_RFSTruck_Export extends BaseSetup {
	...
	String sheetName = "sst_rfsTruck_Export";
	...
	@DataProvider(name = "SST_RFSTruck_Export")
	...
	@Test(dataProvider = "SST_RFSTruck_Export")
