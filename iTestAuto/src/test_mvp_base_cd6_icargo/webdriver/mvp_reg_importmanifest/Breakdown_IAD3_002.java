...
//			
	     ...
	     // Clicking AWB Document recieved checkboxes
			...
			OPR001.clickAWBDocumentReceived(cust.data("awb3"));
			OPR001.clickAWBDocumentReceived(cust.data("awb4"));
			OPR001.saveDetails();
			...
			map.put("awbNumber", cust.data("CarrierNumericCode")+"-"+cust.data("awb3"));
			OPR001.verifyCustomerNotification("awbNumber");
			//Customer notification verification for 4th awb
			map.put("awbNumber", cust.data("CarrierNumericCode")+"-"+cust.data("awb4"));
			OPR001.verifyCustomerNotification("awbNumber");
			OPR001.closeTab("OPR001", "Import Documentation: OPR001");
			...
			String pmKeyXFSURCF3=cust.data("CarrierNumericCode")+" - "+cust.data("awb3");
			String pmKeyXFSURCF4=cust.data("CarrierNumericCode")+" - "+cust.data("awb4");
			...
			String pmKeyXFSUNFD3=cust.data("CarrierNumericCode")+" - "+cust.data("awb3");
			String pmKeyXFSUNFD4=cust.data("CarrierNumericCode")+" - "+cust.data("awb4");
