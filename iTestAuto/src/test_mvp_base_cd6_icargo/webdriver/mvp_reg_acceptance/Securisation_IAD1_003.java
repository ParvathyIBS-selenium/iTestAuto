...
public class Securisation_IAD1_003 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//verification of SCC (NSC should be retained since SM used was VCK)
			String[] scc1={"NSC",cust.data("SCC")};
			OPR339.verifyScc(scc1);
			String[] scc2={"SPX"};
			OPR339.verifySccNotPresent(scc2);
			cust.closeTab("OPR339", "Security & Screening");
			
			/**** OPR339 - Security & Screening with another SM ****/       
			cust.searchScreen("OPR339", "Security and Screening");
			OPR339.listAWB("AWBNo", "CarrierNumericCode", "OPR339 - Security & Sceening");
			...
			cust.searchScreen("OPR339", "Security and Screening");
			OPR339.listAWB("AWBNo", "CarrierNumericCode", "OPR339 - Security & Screening");
			//verification of SCC - SPX should be stamped
