...
public class ImportAITransit_631 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("carrierCode", WebFunctions.getPropertyValue(proppath, "flight_code"));
			map.put("carrierCodeAI","AI");
			...
			OPR001.listFlightDetails("carrierCodeAI", "FlightNo", "StartDate");
			OPR001.verifyFWB("1");
			...
			OPR367.listFlight("carrierCodeAI", "FlightNo", "StartDate");
