...
public class IASCB_31512_TC_2353_KL extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			MSG005.clickList();
			String pmKeyPRE = cust.data("prop~CarrierNumericCodeAMS") + " - " + cust.data("prop~AWBNo2")+" - "+cust.data("Origin") + " - " + cust.data("Destination");
			int verfColsPRE[] = { 9 };
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyPRE2 = cust.data("prop~CarrierNumericCodeAMS") + " - " + cust.data("prop~AWBNo")+" - "+cust.data("Origin") + " - " + cust.data("Destination");
			int verfColsPRE2[] = { 9 };
			...
			cust.listAWB("AWBNo2", "prop~CarrierNumericCodeAMS", "Goods Acceptance");
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyRCS = cust.data("prop~CarrierNumericCodeAMS") + " - " + cust.data("AWBNo2");
			int verfColsRCS[] = { 9 };
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyRCS2 = cust.data("prop~CarrierNumericCodeAMS") + " - " + cust.data("AWBNo");
			int verfColsRCS2[] = { 9 };
			...
			WHS011. enterAWBdetails("CarrierNumericCode", "prop~AWBNo2");
			WHS011.clickList();
