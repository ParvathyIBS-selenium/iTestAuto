package wp5;
/**  Irregularity stamping for check sheet for DG shipment involving airline transfer   **/
...
public class IASCB_31396_TC_2341 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("FullFlightNo", cust.data("otherAirline") + cust.data("prop~flightNo"));
			map.put("FlightNo", cust.data("prop~flightNo"));
			
			//To Carrier - AF
			cust.createFlight("FullFlightNumber");
			map.put("FullFlightNo1", cust.data("carrierCode") + cust.data("prop~flightNo"));
			...
			OPR335.provideCTMdetails("otherAirline", "StartDate");
			...
			String answers[]={getPropertyValue("\\src\\resources\\Checksheet.properties","ObligatoryQuestions_AWBRefused" )};
			OPR335.captureChecksheetsWithMultiFormat(true,answers);
			...
			cust.listAWB("AWBNo", "CarrierNumericCode", "List Irregularity");
			int[] verfCols={3,4,6,9,10};
			String[] actVerfValues={cust.data("IrregularityDetails").split(",")[1],cust.data("FullAWBNo"),cust.data("val~CheckSheet"),cust.data("Pieces"),cust.data("Weight")};
			OPR341.verifyIrregularityDetailsValue(verfCols, actVerfValues, cust.data("IrregularityDetails").split(",")[0]);
