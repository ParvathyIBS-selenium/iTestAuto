...
public class IASCB_6202_TC_2245  extends BaseSetup {
	...
	@DataProvider(name = "IASCB_6202_TC_2245")
	...
	@Test(dataProvider = "IASCB_6202_TC_2245")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("Pcs1", cust.data("SplitPcs").split(",")[0]);
			map.put("Pcs2", cust.data("SplitPcs").split(",")[1]);
			String HAWB[]= {"HAWB1","HAWB2"};
			String Shipper[]={"ShipperCode","ShipperCode"};
			String Consignee[]={"ConsigneeCode","ConsigneeCode"};
			String Origin[]={"Origin","Origin"};
			String Destination[]={"Destination","Destination"};
			String Pcs[]={"Pcs1","Pcs2"};
			String Wgt[]={"Weight1","Weight2"};
			OPR026.addHAWBDetails(HAWB,Shipper,Consignee, Origin, Destination,Pcs, Wgt);
			...
			String pmkey = Excel.getCellValue(path1,sheetName, "IASCB_6202_TC_2245", "UldNum");
			...
			System.out.println(cust.data("Statuscode"));
			cust.createXMLMessage("MessageExcelAndSheetXCSN", "MessageParamXCSN");
			MSG005.loadFromFile("All", "ALL", "MQ-SERIES", "", "Origin", "", "XCSN", true);
			cust.closeTab("MSG005", "List Message");
