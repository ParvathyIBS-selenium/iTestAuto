package wp4;
/** Manual CART sighting in Scanner    **/
...
public class IASCB_6181_IASCB_25355_TC_2213 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			SHR011.listDetails();
			map.put("pmKey","EXPMFTCRT");
			int verfCols[]={3,4};
			String actVerfValues[]={currDate,"Total pieces="+cust.data("Pieces")+", Total Weight="+cust.data("Weight")};
