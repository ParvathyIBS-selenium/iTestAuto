package wp4;
/** Verify label on the ULD level in the Import Manifest screen.**/
...
public class IASCB_96710_TC_2300 extends BaseSetup {
	...
	@DataProvider(name = "IASCB_96710_TC_2300")
	...
	@Test(dataProvider = "IASCB_96710_TC_2300")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String uldwgt= Integer.toString(Integer.parseInt(cust.data("Weight"))+Integer.parseInt(cust.data("UldTareWgt")));
			String uldDetails[] = { "-L1/"+cust.data("UldNum")+"/"+cust.data("Destination")+"/"+uldwgt+"/U" ,"-L2/"+cust.data("UldNum1")+"/"+cust.data("Destination")+"/"+uldwgt+"/U"};
			//Create CPM Message
			...
			String[] ulds={"UldNum2"};
			OPR367.verifyNotInCpmLabel(ulds);
