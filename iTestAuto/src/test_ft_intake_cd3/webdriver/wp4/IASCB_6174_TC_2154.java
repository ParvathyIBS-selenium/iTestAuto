package wp4;
/** Test for EPS time not available in ULD sighting screen **/
...
public class IASCB_6174_TC_2154 extends BaseSetup {
	...
	@DataProvider(name = "IASCB_83237_TC_2287")
	...
	@Test(dataProvider = "IASCB_83237_TC_2287")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
		   ...
		   cust.createFlight("FullFlightNumber");
			...
			//Verify EPS time
			uldsighthht.verifyEPSNotAvailable();
			libr.quitApp();
