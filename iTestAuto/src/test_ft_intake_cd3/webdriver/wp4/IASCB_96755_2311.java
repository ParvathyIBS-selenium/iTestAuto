package wp4;
/** Display of split indicator against the AWB in the AWB list. **/
...
public class IASCB_96755_2311 extends BaseSetup {
	...
	String sheetName = "wp4_IASCB_96755";
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			jsonbody1.postRequest(cust.data("AWB"),cust.data("Weight2"),cust.data("Volume2"),cust.data("val~10"),cust.data("val~10"),cust.data("val~10"),cust.data("UldNum1"));
			...
			map.put("AWBNum", cust.data("prop~stationCode")+ " - " +cust.data("prop~AWBNo")+" "+"*");	

			//Verifying split shipment
			bdhht.verifySplitShipment("AWBNum");
			bdhht.selectSplitAWB("AWBNum");
