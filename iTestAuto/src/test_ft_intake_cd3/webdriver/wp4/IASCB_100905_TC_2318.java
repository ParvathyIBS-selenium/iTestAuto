package wp4;
/**  Customs block stamped as part of CSN xCSN message processing to import transaction - Breakdown.  **/
...
public class IASCB_100905_TC_2318 extends BaseSetup {
	...
	@DataProvider(name = "IASCB_100905_TC_2318")
	...
	@Test(dataProvider = "IASCB_100905_TC_2318")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cust.verifyErrorMessage("Breakdown", "val~Blocked by CSN");
            ...
            /******** Import Manifest - Verify Breakdown Successfull *********/
			cust.searchScreen("OPR367", "Import Manifest");
			OPR367.listFlight("carrierCode","FlightNo", "StartDate");
