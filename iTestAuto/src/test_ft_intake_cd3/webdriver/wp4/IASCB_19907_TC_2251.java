...
public class IASCB_19907_TC_2251 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String shipment[] = { libr.data("FullAWBNo") + ";" + cust.data("Pieces1") + ";" + cust.data("Weight1")
			+ ";" + cust.data("Volume1") + ";" + libr.data("ShipmentDesc"),libr.data("FullAWBNo2") + ";" + cust.data("Pieces1") + ";" + cust.data("Weight1")
			+ ";" + cust.data("Volume1") + ";" + libr.data("ShipmentDesc") };
			String sccs[] = { cust.data("SCC"), cust.data("SCC")};
			String routings[] = { cust.data("Origin") + ";" + cust.data("Destination"),cust.data("Origin") + ";" + cust.data("Destination") };
			...
			int []shipments={2};
			// Create XFFM message
			cust.createXFFMMessage_MultipleShipments("XFFM", shipment1, sccs, routing1, uld,shipments);
			Cgocxml.sendMessageCgoCXML("ICARGO");
			libr.quitBrowser();
			...
			map.put("bufferOpenTime",cust.timeCalculation(currtme, "HH:mm","MINUTE",25));		
			WHS059.enterOpenTime("currdate", "bufferOpenTime");
			cust.closeTab("WHS059", "Assign Flight Locations");
			
			/*** Assign Flight Locations - WHS059 ***/
			//Saving the Open Buffer time for Onward Flight -Flight3
			cust.searchScreen("WHS059", "Assign Flight Locations");
			WHS059.selectZone("0");
			...
			map.put("bufferOpenTime1",cust.timeCalculation(currtme, "HH:mm","MINUTE",5));		
			WHS059.enterOpenTime("currdate", "bufferOpenTime1");
			cust.closeTab("WHS059", "Assign Flight Locations");
			...
			OPR367.verifyLPSTransitTime("currdate", "bufferOpenTime1","BCT","UldNum");
