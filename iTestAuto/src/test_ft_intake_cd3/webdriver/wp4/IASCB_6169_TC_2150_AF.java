package wp4;
/** Verify for flights with 1) Anticipatory check completed 2) FFM received 3)Flight pouch received  **/
...
public class IASCB_6169_TC_2150_AF extends BaseSetup {
	...
	@DataProvider(name = "IASCB_6169_TC_2150")
	...
	@Test(dataProvider = "IASCB_6169_TC_2150")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cust.searchScreen("OPR367", "Import Manifest");
			OPR367.listFlight("carrierCode", "FlightNo", "StartDate");
			OPR367.verifyPlanningisCompleted();
			OPR367.closeTab("OPR367", "Import Manifest");
			
			/** OPR001 - Import Documentation **/
            cust.searchScreen("OPR001", "Import Documentation");
			...
			OPR001.saveDetails();
			OPR001.closeTab("OPR001", "Import Documentation");
			...
			ADD008.clickList();
			ADD008.verifyFlight("FullFlightNo");
			ADD008.verifyPlanStatus("val~Completed");
			ADD008.verifyFlightPouchIcon();
			ADD008.verifyFFMIndicator();
