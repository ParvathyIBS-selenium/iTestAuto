package wp4;
/** SCC ranking in the AWB list in Breakdown screen  **/
...
public class IASCB_96775_2315 extends BaseSetup {
	...
	String sheetName = "wp4_IASCB_96775";
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String shipment[] = {
					cust.data("awbNumber1") + ";" + cust.data("Pieces") + ";" + cust.data("Weight") + ";"
							...
							cust.data("awbNumber2") + ";" + cust.data("Pieces") + ";" + cust.data("Weight") + ";"
									+ cust.data("Volume") + ";" + cust.data("ShipmentDesc2"),cust.data("awbNumber3") + ";" + cust.data("Pieces") + ";" + cust.data("Weight") + ";"
											+ cust.data("Volume") + ";" + cust.data("ShipmentDesc3") };
			String scc[] = { cust.data("SCC"), cust.data("SCC2"),cust.data("SCC3") };
			...
			String sortedSccs[]=new String[scc.length];		
			int rank=SHR097.getShipmentRank("ShpRank Master",scc[0],cust.data("Destination"));		
			rankMaster.put(rank, scc[0]);	
			int rank2=SHR097.getShipmentRank("ShpRank Master",scc[1],cust.data("Destination"));			
			rankMaster.put(rank2, scc[1]);	
			int rank3=SHR097.getShipmentRank("ShpRank Master",scc[2],cust.data("Destination"));		
			rankMaster.put(rank3, scc[2]);				
			sortedSccs=SHR097.sortSCCs(scc, rankMaster);			
