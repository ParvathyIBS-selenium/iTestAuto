...
/**
 *  IASCB-57969_Column Chooser in Service Point Overview Screen-TC_01_Choosing columns to be displayed.- Select
 **/


public class IASCB_57969_TC_1968 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/*	
			/**verify column is displayed in service point overview screen when the respective column is selected in column choser**/
			cust.searchScreen("TGC015", "Servicepointoverview");	
			libr.waitForSync(3);
			TGC015.selectWarehouse("servicetype");
			TGC015.freeCounterToken(cust.data("Tokenid"));
			TGC015.selectColumn("column");
			TGC015.listToken("currentdate");
	        TGC015.verifyColumnDisplayed("Tokenid",true);
			...
			/**verify column selection is retained  after logout login**/
			cust.searchScreen("TGC015", "Servicepointoverview");
			libr.waitForSync(3);
			TGC015.selectWarehouse("servicetype");
			TGC015.listToken("currentdate");
