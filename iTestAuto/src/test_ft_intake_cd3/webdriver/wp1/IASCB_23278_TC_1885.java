...
/**
 * 
 *  1885 - TC_01_Verify linking of the AWB s to ULD while declaring the ULD
 *  
 *	XFWB status is not processed successfully, it is coming as processed with warning with invalid product code

 *
 */

public class IASCB_23278_TC_1885 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			sstDP.verifyAddButton();
			sstDP.addShipmentInUld("prop~CarrierNumericCode", "prop~AWBNo");
			sstDP.clickDone();
			sstDP.clickProceed();
			...
			TGC013.clickList();
			TGC013.verifyULDNumber("AWBNo", "UldNum");
