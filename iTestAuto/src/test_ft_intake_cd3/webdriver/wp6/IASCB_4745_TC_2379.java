...
/**  TC_08_ Print Delivery slip for token based delivery **/


public class IASCB_4745_TC_2379 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cust.searchScreen("CHK002", "Capture Check Sheet");
			CHK002.listCheckSheetType("AWB");
			CHK002.listAWBWithTransaction("AWBNo", "prop~CarrierNumericCode","Breakdown");
			...
			cust.printAndVerifyReport("val~DELIVERY SLIP", "OPR038",cust.data("Destination"),cust.data("FullAWBNo"),cust.data("Origin"),cust.data("ShipmentDesc"),cust.data("UldNum"),cust.data("Pieces"),cust.data("Weight1"),cust.data("ConsigneeName"),DNdetails,"DELIVERY COMPLETE");
