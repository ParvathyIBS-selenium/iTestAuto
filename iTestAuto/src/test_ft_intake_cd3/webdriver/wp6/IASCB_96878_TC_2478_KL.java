...
//TC_01_Provision to capture damage in delivery screen



public class IASCB_96878_TC_2478_KL extends BaseSetup {
	...
	String sheetName = "wp6_IASCB_96878";
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		libr.quitBrowser();
			...
			cust.listAWB("AWBNo", "prop~CarrierNumericCodeAMS", "Delivery Documentation");
			...
			OPR038.listByAWB("prop~CarrierNumericCodeAMS", "AWBNo");
			
			String pmKey = cust.data("ConsigneeCode");
			int verfCols [] = { 3,4,9};
			String[] actVerfValues= {cust.data("Pieces"),cust.data("Weight"),"DELIVERY COMPLETE" };
