...
/**
 *  TC_01_ Delivery of all shipment on Token from bonded area
 *  
 * 
 */
...
public class IASCB_4748_TC_2380_AF extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cust.searchScreen("CHK002", "Capture Check Sheet");
			CHK002.listCheckSheetType("AWB");
			CHK002.listAWBWithTransaction("AWBNo2", "CarrierNumericCode","Manifest");
			CHK002.captureCheckSheet(true, "leakage");
			CHK002.closeTab("CHK002", "Capture Check Sheet");
			...
			cust.searchScreen("CHK002", "Capture Check Sheet");
			CHK002.listCheckSheetType("AWB");
			CHK002.listAWBWithTransaction("AWBNo2", "CarrierNumericCode","Breakdown");
			CHK002.captureCheckSheetAnswers(true,"leakage");
			CHK002.closeTab("CHK002", "Capture Check Sheet");
			...
			/***** CAPTURE CHECK SHEET***/
			cust.searchScreen("CHK002", "Capture Check Sheet");
			CHK002.listCheckSheetType("AWB2");
			CHK002.listAWBWithTransaction("AWBNo2", "prop~CarrierNumericCode","Lodgement");
			CHK002.enterCheckSheetAns();
			CHK002.save();
			CHK002.closeTab("CHK002", "Capture Check Sheet");
			...
			//verify customer reference number is populated
			deliveryhht.verifyCustomsReferenceNumber("customRefNo");
			deliveryhht.clickNext();
			...
			String DNdetails=cust.data("DNinfo1").substring(0, 5)+"( "+cust.data("Pieces")+"/"+cust.data("Weight")+"kg,"+"\n"+"Customs reference "+"number: "+cust.data("customRefNo")+" )";
			...
			OPR038.clickReprint();
			//Steps to verify the delivery slip contents 
			DNdetails=cust.data("DNinfo2").substring(0, 5)+"( "+cust.data("Pieces")+"/"+cust.data("Weight")+"kg,"+"\n"+"Customs reference "+"number: "+cust.data("customRefNo")+" )";
			cust.printAndVerifyReport("val~DELIVERY SLIP", "OPR038",cust.data("Destination"),cust.data("FullAWBNo"),cust.data("Origin"),cust.data("ShipmentDesc"),cust.data("Pieces"),cust.data("Weight1"),cust.data("ConsigneeName"),DNdetails,"DELIVERY COMPLETE");
			OPR038.closeTab("OPR038", "Delivery Slip");
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			pmKeyDLV=cust.data("CarrierNumericCode")+" - "+cust.data("AWBNo2");
