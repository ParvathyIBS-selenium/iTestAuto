...
/** 1.14 Test ID : 2513 -  Verify the remaining time for build-up closure is more than 240 minutes and it is displayed in green colour. **/

public class IASCB_9195_TC_2513 extends BaseSetup {
...
//			/******* FLT003 - MAINTAIN OPERATIONAL FLIGHT ******/
			...
			String STD=cust.timeCalculation(currtimeCDG, "dd-MMM-yyyy HH:mm","HOUR",8);
			...
			String STA=cust.timeCalculation(currtimeCDG, "dd-MMM-yyyy HH:mm","HOUR",9);
      ...
      /***Verifying the color and remaining time for the flight closure for the AWB1***/
			...
			expbuildup.verifyColour("Green","FlightNo");
			...
			Cgomon.clickSearch();
			Cgomon.verifyMessageStatus("FullAWBNo1", "Outgoing XFWB", "PELICAN");
