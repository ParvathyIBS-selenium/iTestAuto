...
/** Split shipment indicator across the flight**/

public class IASCB_9255_TC_2525 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String shipment1[] = { libr.data("FullAWBNo") + ";" + libr.data("SplitPieces1") + ";" + libr.data("SplitWeight1") + ";"
					+ libr.data("SplitVolume1") + ";" + libr.data("ShipmentDesc") };
			String scc[] = { cust.data("SCC") };
			String routing[] = { cust.data("Origin") + ";" + cust.data("Destination") };
			cust.createXFBLMessage("XFBL_2", shipment1, scc, routing);
			cust.modifyMessageMap("<ram:TransportSplitDescription>T</ram:TransportSplitDescription>","<ram:TransportSplitDescription>P</ram:TransportSplitDescription>");
			...
			map.put("flightNumber", FlightNum2);
			cust.createXMLMessage("MessageExcelAndSheetXFBL", "MessageParamXFBL");
			String shipment2[] = { libr.data("FullAWBNo") + ";" + libr.data("SplitPieces2") + ";" + libr.data("SplitWeight2") + ";"
					+ libr.data("SplitVolume2") + ";" + libr.data("ShipmentDesc") };
			...
			map.put("FlightNum1", cust.data("carrierCode") + " " + cust.data("FlightNo"));
			map.put("FlightNum2", cust.data("carrierCode") + " " + cust.data("FlightNo2"));
			...
			excelRead.writeDataInExcel(map, path1, sheetName, testName);		
			expbuildup.verifytaskCreated("FlightNum1");
			expbuildup.selectTaskCreated("FlightNum1");
			expbuildup.markTaskInProgress();	
			//verifying split indicator in awb splitted across flight1
			expbuildup.verifySplitIndicatorAcrossFlight("FullAWBNo");
			...
			expbuildup.verifytaskCreated("FlightNum2");
			expbuildup.selectTaskCreated("FlightNum2");
			expbuildup.markTaskInProgress();
			//verifying split symbol in awb splitted across flight2
			expbuildup.verifySplitIndicatorAcrossFlight("FullAWBNo");
			expbuildup.clickUldType("UldType");
			...
			//verifying split indicator in awb splitted across flight2
