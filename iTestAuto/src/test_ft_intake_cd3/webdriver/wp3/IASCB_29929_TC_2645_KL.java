...
public class IASCB_29929_TC_2645_KL extends BaseSetup {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR344.addNewULDWithAWBAndContour("UldNum2","0","CarrierNumericCode","AWBNo3","Pieces","Weight","contour");
			OPR344.addNewULDWithAWBAndContour("UldNum3","0","CarrierNumericCode","AWBNo4","Pieces","Weight","contour");
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyRCS1=cust.data("prop~CarrierNumericCodeAMS")+" - "+cust.data("AWBNo1");
			int verfColsRCS1[]={9};
