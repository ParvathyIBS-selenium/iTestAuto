...
public class IASCB_19290_TC_2605 extends BaseSetup
...

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR344.verifyFilter("SccFilter", "ULDFilter");
			OPR344.considerformanifestprint();
			// Delete files
			String filePath=System.getProperty("user.dir")+"\\src\\resources\\Downloads\\";
			cust.deleteAllFilesInFolder(filePath);
			OPR344.printManifestOkWithoutFrame();
			cust.closeTab("OPR344", "Export manifest");
			cust.renameFile(filePath, "Manifest"+cust.data("FlightNo"));
			OPR344.extractPDFContentAndCompare("Manifest"+cust.data("FlightNo"),cust.data("carrierCode")+" "+cust.data("FlightNo"));	
			OPR344.extractPDFContentAndCompareContentsNotPresent("Manifest"+cust.data("FlightNo"),cust.data("UldNum"),cust.data("FullAWBNo"));
			libr.quitBrowser();
