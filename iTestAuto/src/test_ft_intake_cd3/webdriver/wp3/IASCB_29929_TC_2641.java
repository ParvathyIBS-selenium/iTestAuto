...
public class IASCB_29929_TC_2641 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyFOH1=cust.data("prop~CarrierNumericCode")+" - "+cust.data("AWBNo1");
			int verfColsRCS1[]={9};
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyFOH2=cust.data("prop~CarrierNumericCode")+" - "+cust.data("AWBNo2");
