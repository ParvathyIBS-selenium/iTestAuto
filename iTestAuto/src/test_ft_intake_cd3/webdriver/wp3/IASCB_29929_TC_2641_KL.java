...
/**  TC_03_Commercial Linkage of CTR containers  **/
public class IASCB_29929_TC_2641_KL  extends BaseSetup {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("FullAWBNo4", cust.data("awbNumber4"));
			map.put("AWBNo4", cust.data("awb4"));
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			...
			map.put("FullAWBNum", cust.data("awbNumber4"));
			...
			cust.searchScreen("OPR339", "Security and Screening");
			OPR339.listAWB("AWBNo4", "CarrierNumericCode", "OPR339 - Security & Sceening");
			OPR339.clickYesButton();
			OPR339.enterScreeningDetails("ScreeningMethod", "Pieces", "Weight", "val~Pass");
			OPR339.saveSecurityDetails();
			cust.closeTab("OPR339", "Security & Sceening");
			...
			OPR344.addNewULDWithAWB("UldNum2","0","CarrierNumericCode","AWBNo3","Pieces","Weight");
			OPR344.addNewULDWithAWB("UldNum3","0","CarrierNumericCode","AWBNo4","Pieces","Weight");
			...
			buhht.captureLInkageDetails("UldNum1","val~COMMERCIALLINKAGE");
			buhht.clicksave();
			...
			buhht.clickMoreOptions();
			buhht.clickCaptureLinkageAndFloatingPallets();
			buhht.captureLInkageDetails("UldNum3","val~COMMERCIALLINKAGE");
			buhht.clicksave();
			cust.clickBack("Build Up");
			cust.clickBack("Build Up");
			...
			OPR063.verifyLinkageReason("val~COMMERCIALLINKAGE");
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyPRE=cust.data("prop~CarrierNumericCodeAMS")+" - "+cust.data("AWBNo1");
			int verfColsPRE[]={9};
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyFOH1=cust.data("prop~CarrierNumericCodeAMS")+" - "+cust.data("AWBNo1");
			int verfColsRCS1[]={9};
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyFOH2=cust.data("prop~CarrierNumericCodeAMS")+" - "+cust.data("AWBNo2");
			MSG005.verifyMessageDetails(verfColsRCS1, actVerfValuesRCS1, pmKeyFOH2,"val~XFSU-FOH",false);
			libr.waitForSync(1);
			MSG005.closeTab("MSG005", "MSG005 - List Messages");
			...
			cfd.verifyCommercialLink("Commercial link:  2","UldNum2");
			cfd.verifyCommercialLink("Commercial link:  2","UldNum3");
			libr.quitBrowser();
