...
/** Test ID : 2561 - TC_01_Flight representation image should be shown based on aircraft in ULD Instruction Screen in web application **/

/**Test case comments**/

public class IASCB_9318_2561 extends BaseSetup {
	...
	String sheetName = "wp3_IASCB_9318";
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
		  ...
		  cust.searchScreen("MSG005", "MSG005 - List Messages");
			...
			OPR063.verifyFlightIconIsSquare();
