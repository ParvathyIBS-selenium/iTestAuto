...
public class IASCB_28271_2633 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		/** MSG005 -XFWB Message loading for AWB 1 **/
			...
			//Verify the behaviour WHEN USER UPDATES THE OVP/APIO value
			...
			OPR350.selectUNID("UNID");
			OPR350.overPackingDetails("AllPackedInOne",cust.data("No of pack"),cust.data("length"),cust.data("width"),cust.data("height"));			
			OPR350.clickSaveButton(); 		
			OPR350.verifySystemGeneratedNo("UNID");
			OPR350.clickMoreOption("UNID");
			OPR350.selectEditbutton("UNID");
			OPR350.modifyUNIDDetails("UNID","Packaging details");
			OPR350.clickSaveButton();
			OPR350.verifyPackageDetails("UNID","Packaging details");
			OPR350.clickMoreOption("UNID");
			OPR350.selectEditbutton("UNID");		
			OPR350.modifyUNIDWithNoPackingdetails("UNID");
			...
			cfd.verifyAPIONumber(cust.data("Packaging details"));
			libr.quitBrowser();
