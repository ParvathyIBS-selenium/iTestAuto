...
public class IASCB_19208_TC_2497_AF extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("flightNumber", FlightNum2);
			cust.createXMLMessage("MessageExcelAndSheetXFBL", "MessageParamXFBL");
			String shipment2[] = { libr.data("FullAWBNo") + ";" + libr.data("Pieces2") + ";" + libr.data("Weight2") + ";"	+ libr.data("Volume2") + ";" + libr.data("ShipmentDesc") };
			...
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			OPR344.addNewULDWithAWBSplitShipment("UldNum","0","prop~CarrierNumericCode","AWBNo","Pieces1","Weight1");
			...
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			OPR344.addNewULDWithAWBSplitShipment("UldNum2","0","prop~CarrierNumericCode","AWBNo","Pieces2","Weight2");
			OPR344.manifestDetails();
			OPR344.verifyFlightStatus("val~Manifested");
			OPR344.finalizeFlight(true);
			OPR344.verifyFlightStatus("val~Finalized");
			...
			String pmkey1 = Excel.getCellValue(path1,sheetName, "IASCB_19208_TC_2497_AF", "UldNum");
			...
			String pmkey2 = Excel.getCellValue(path1,sheetName, "IASCB_19208_TC_2497_AF", "UldNum2");
