...
public class IASCB_19215_TC_2725 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			// Writing the full AWB No
			cust.setPropertyValue("FullAWBNo2", cust.data("prop~CarrierNumericCodeAMS") + "-" + cust.data("prop~AWBNo"), proppath);
			...
			// Writing the full AWB No
			cust.setPropertyValue("FullAWBNo3", cust.data("prop~CarrierNumericCodeAMS") + "-" + cust.data("prop~AWBNo"), proppath);
