...
//Test for capturing split shipment details if total split pieces of the AWB is not equal to Stated pieces 


public class IASCB_117087_TC_2944 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR026.splitShipmentWithSCCWithInvalidSplitPcs(libr.data("SCC"), pcs,
