...
public class IASCB_80451_TC_2885 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR335.uldShipmentDetails("Pieces", "Weight", "ULDAcceptanceLocation_AMS", "UldNum", "");
			...
			to.retrieveAndVerifyOriginLocation("UldNum", "ULDAcceptanceLocation_AMS");
			...
			map.put("ULDAcceptanceZone_AMS", WebFunctions.getPropertyValue(toproppath, "ULDAcceptanceZone_AMS"));
			//verifying zone of the destination location
			to.verifyZone(cust.data("storageAreaLocation"), "ULDAcceptanceZone_AMS");


			//verifying the generated TO status in the TO app
			to.verifyShipmentDetails("UldNum", "val~Open", "ULDAcceptanceLocation_AMS");
			libr.quitApp();
...
//			int verfCols [] = {3};
//
//			//Verifying the storage area destination location and zone for ULD
...
//			cust.closeTab("WHS008", "Handling Area Set Up");
			...
			String TODetails[]={"Open", WebFunctions.getPropertyValue(toproppath, "AcceptanceHA_AMS"),WebFunctions.getPropertyValue(toproppath, "ULDStorageAreaHA_AMS"),"RELOCATION"};
