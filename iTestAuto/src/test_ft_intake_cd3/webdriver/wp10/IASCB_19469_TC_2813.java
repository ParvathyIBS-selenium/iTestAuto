...
/**
 *  TC_02_Verify warning displayed if location is not compatible for GEN shipment.
 **/


public class IASCB_19469_TC_2813 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
            ...
            relocationhht.enterValue("UldNum");
            relocationhht.enterDestLocation("WrongLocation");
            relocationhht.clickCompleteRelocation();
            relocationhht.verifyWarningAndClickYes("Shipment SCC is incompatible with the zone. Do you want to continue?");
            libr.quitApp();
			...
			WHS011.clickList();
			// Verify Location
			String pmyKeySU = cust.data("UldNum");			
			int[] verfColsSU={4};
			String[] actVerfValuesSU ={cust.data("WrongLocation")}; 
