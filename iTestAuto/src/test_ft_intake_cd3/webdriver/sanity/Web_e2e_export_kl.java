...
public class Web_e2e_export_kl extends BaseSetup {
	...
	@DataProvider(name = "Web_export_kl")
	...
	@Test(dataProvider = "Web_export_kl")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/*** Auto Execution is happening if XFWB is processed with screening info and valid RA details**/
			/***** OPR026 - Execute AWB ****/
			cust.searchScreen("OPR026", "Capture AWB");
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyFOH=cust.data("prop~CarrierNumericCodeAMS")+" - "+cust.data("prop~AWBNo");
			int verfColsFOH[]={9};
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyPRE=cust.data("prop~CarrierNumericCodeAMS")+" - "+cust.data("prop~AWBNo");
			int verfColsPRE[]={9};
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyMAN = cust.data("prop~CarrierNumericCodeAMS") + " - " + cust.data("prop~AWBNo");
			int verfColsMAN[] = { 9 };
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyXFFM = cust.data("prop~flight_code_KL") + " - " + cust.data("FlightNo") + " - " + cust.data("Day")
