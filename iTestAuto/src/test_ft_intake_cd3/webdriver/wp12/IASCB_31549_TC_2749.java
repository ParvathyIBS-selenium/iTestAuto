...
/** Verify shipment is released from AWB clearance screen **/



public class IASCB_31549_TC_2749 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
            ...
            OPR023.listAWB("prop~CarrierNumericCodeAMS","prop~AWBNo");
            int[] verfCols={4,8};
            String[] actVerfValues={cust.data("BlockType"),"Blocked"};
            OPR023.verifyBlockDetails(verfCols, actVerfValues, "RESTRICTED BY VALIDA");
			...
			OPR344.verifyErrorMessage("val~Temparature Check Failed");
            ...
            cust.searchScreen("OPR023", "AWB Clearance");
            OPR023.listAWB("prop~CarrierNumericCodeAMS","prop~AWBNo");
            OPR023.releaseBlock("val~Released");
            OPR023.closeTab("OPR023", "AWB Clearance");
