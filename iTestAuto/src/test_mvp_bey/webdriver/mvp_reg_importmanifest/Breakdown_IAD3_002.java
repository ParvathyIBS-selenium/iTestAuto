...
/**
 * 
BDN of multiple shipments groups to be stored in one location
 *
 */

public class Breakdown_IAD3_002 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("DestinationCountry", WebFunctions.getPropertyValue(custproppath, "credit_exp_cash_imp_countryId_LB"));
			...
			//AWBNumber4
			map.put("awbNumber4", cust.data("prop~CarrierNumericCodeAMS")+"-"+cust.data("prop~AWBNo"));
			...
			map.put("SCC2", cust.data("SCC").split(",")[2]);
			map.put("ShipmentDesc2", cust.data("ShipmentDesc").split(",")[1]);
			System.out.println(cust.data("SCC2"));
			System.out.println(cust.data("ShipmentDesc2"));
			...
			String shipment[] = { cust.data("awbNumber1") + ";" + cust.data("Pieces") + ";" + cust.data("Weight")
					...
					+ ";" + cust.data("Volume") + ";" + cust.data("ShipmentDesc").split(",")[1],cust.data("awbNumber4") + ";" + cust.data("Pieces") + ";" + cust.data("Weight")
					+ ";" + cust.data("Volume") + ";" + cust.data("ShipmentDesc").split(",")[1] };
			String scc[] = {cust.data("SCC").split(",")[0] + ";" +cust.data("SCC").split(",")[1],cust.data("SCC").split(",")[0] + ";" +cust.data("SCC").split(",")[1],cust.data("SCC").split(",")[2],cust.data("SCC").split(",")[2]};
			...
			//manually marked the breakdown instruction as breakdown
			String pmkey = Excel.getCellValue(path1,sheetName, "Breakdown_IAD3_002", "UldNum");
			OPR367.clickCheckBox_ULD(pmkey);
			OPR367.clickBreakdownButton();
			String[] awb={cust.data("awb1"),cust.data("awb2")};
			OPR004.selectAWBs(awb);
			OPR004.addWarehouseLocation("BDNlocation");
			String[] awb2={cust.data("awb3"),cust.data("awb4")};
			OPR004.selectAWBs(awb2);
			OPR004.addWarehouseLocation("Location");
			String[] pcs = {"Pieces","Pieces","Pieces","Pieces"};
			String[] wgt = {"Weight","Weight","Weight","Weight"};			
			OPR004.piecesWeightIfAutoPopulated(4,pcs,wgt);		
			...
			OPR001.verifyCustomerNotification("awbNumber");
			//Customer notification verification for 3rd awb
			map.put("awbNumber", cust.data("prop~CarrierNumericCodeAMS")+"-"+cust.data("awb3"));
			OPR001.verifyCustomerNotification("awbNumber");
			//Customer notification verification for 4th awb
			map.put("awbNumber", cust.data("prop~CarrierNumericCodeAMS")+"-"+cust.data("awb4"));
			OPR001.verifyCustomerNotification("awbNumber");
			...
			String pmKeyXFSURCF3=cust.data("prop~CarrierNumericCodeAMS")+" - "+cust.data("awb3");
			String pmKeyXFSURCF4=cust.data("prop~CarrierNumericCodeAMS")+" - "+cust.data("awb4");
			...
			MSG005.verifyMessageDetails(verfColsXFSURCF, actVerfValuesXFSURCF, pmKeyXFSURCF3,"val~XFSU-RCF",true);
			MSG005.verifyMessageDetails(verfColsXFSURCF, actVerfValuesXFSURCF, pmKeyXFSURCF4,"val~XFSU-RCF",true);
			libr.waitForSync(6); 
			...
			String pmKeyXFSUNFD3=cust.data("prop~CarrierNumericCodeAMS")+" - "+cust.data("awb3");
			String pmKeyXFSUNFD4=cust.data("prop~CarrierNumericCodeAMS")+" - "+cust.data("awb4");
			...
			MSG005.verifyMessageDetails(verfColsXFSUNFD, actVerfValuesXFSUNFD, pmKeyXFSUNFD3,"val~XFSU-NFD",true);
			MSG005.verifyMessageDetails(verfColsXFSUNFD, actVerfValuesXFSUNFD, pmKeyXFSUNFD4,"val~XFSU-NFD",true);
			libr.waitForSync(6); 
			MSG005.closeTab("MSG005", "MSG005 - List Messages");
