...
/**
 * 
 * Breakdown of an intact unit with damages
 *
 */

public class BreakdownIntactDGRWithDamage extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String pmkey = Excel.getCellValue(path1,sheetName, "BreakdownIntactDGR", "UldNum");
