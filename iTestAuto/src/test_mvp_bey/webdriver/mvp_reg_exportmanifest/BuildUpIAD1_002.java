...
public class BuildUpIAD1_002 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String[] pcs={cust.data("Pieces"),cust.data("Pieces")};
			String[] wt={cust.data("Weight"),cust.data("Weight")};
			String[] result={cust.data("val~Pass"),cust.data("val~Pass")};
			OPR339.captureDoubleScreeningDetails(screeningMethod, pcs, wt, result);
