...
/**
 *TC_03_Verify the Build up plan when FFM is received
 **/


public class IASCB_121165_TC_8630 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("flight", cust.data("FullFlightNo"));
			...
			String scc2[] = {cust.data("SCC")};
			String uld[] = {cust.data("UldType") + ";" + cust.data("ULDNo") + ";" + cust.data("carrierCode") };

			// Create XFFM message
			cust.createXFFMMessage("XFFM", shipment, scc2, routing, uld);
			...
			/***Checking planned build up plan got deleted after xffm loading***/
			cust.searchScreen("OPR043", "Import Shipment Listing");
			OPR043.selectDateType("val~Planned Date");
			OPR043.enterFlightNumber("carrierCode", "FlightNo1");
			OPR043.enterFlightDate("StartDate");
			...
			OPR043.enterFlightNumber("carrierCode", "FlightNo1");
			OPR043.enterFlightDate("StartDate");
			OPR043.selectStatusType("val~Pending Arrival");
			OPR043.clickList();
			OPR043.verifyPlannedPieces("Pieces","FullAWBNo");
			OPR043.verifyPlannedWeight("Weight","FullAWBNo");
			OPR043.verifyMftPieces("Pieces","FullAWBNo");
			OPR043.verifyMftWeight("Weight","FullAWBNo");
			cust.closeTab("OPR043", "Import Shipment Listing");
