...
public class IASCB_56364_TC_10951 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			ADD013.clickList();
			ADD013.selectEquipmentType(cust.data("Equipment"), "EquipmentType");
			cust.waitForSync(1);
			...
			ADD013.verifyEquipmentTypeAssigned("EquipmentType");
			...
			int verfcols1[]={4};
			String actverfValues1[]={"Flight:"+" "+cust.data("carrierCode")+" "+cust.data("FlightNo")+","+" "+cust.data("flightdate")+";"+" "+"Assigned"+" "+"Equipments"+":"+" "+cust.data("Equipment")+" "+"-"+" "+cust.data("EquipmentType")};
