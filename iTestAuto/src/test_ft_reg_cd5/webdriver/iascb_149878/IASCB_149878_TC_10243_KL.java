...
public class IASCB_149878_TC_10243_KL extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/***** Capture AWB OPR026- Verifying Short Captured Details are not overwritten with XFSU BKD data after AWB save on OPR026 *****/
			cust.searchScreen("OPR026", "Capture AWB");
			OPR026.listAWB("AWBNo", "CarrierNumericCode");
			OPR026.verifyStatedPieces("Pieces");
			OPR026.verifyStatedWeight("Weight");
