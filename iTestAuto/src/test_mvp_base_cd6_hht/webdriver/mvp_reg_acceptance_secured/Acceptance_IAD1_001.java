...
/**
 * "Loose shipments with complete acceptance. AWB data capture and screening are executed"
 **/
public class Acceptance_IAD1_001 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			msgContents.add("val~<IncludedCustomsNote>"+"\n"+"<ContentCode>"+"SM"+"</ContentCode>"+
					...
					"\n"+"<Content>"+"T133072"+"</Content>"+"\n"+"</IncludedCustomsNote>");
			msgContents.add("val~<ContentCode>"+cust.data("AgentTypeCode")+"</ContentCode>"+"\n"+"<Content>"+cust.data("RegulatedAgentCode")+"</Content>");
			msgContents.add("val~<ContentCode>ED</ContentCode>"+"\n"+"<Content>"+cust.data("Expiry")+"</Content>");
