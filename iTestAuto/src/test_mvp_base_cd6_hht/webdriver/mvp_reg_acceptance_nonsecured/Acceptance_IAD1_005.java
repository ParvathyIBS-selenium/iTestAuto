...
public class Acceptance_IAD1_005 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cust.searchScreen("OPR026","Capture AWB");
			OPR026.listAWB("AWBNo", "CarrierNumericCode");
			//Sending FWB manually
			OPR026.sendFWB();
			OPR026.selectSendFwbDetails("XFWB");
			cust.closeTab("OPR026", "Capture AWB");	
			...
			MSG005.verifyIfMessageTriggered(pmKeyXFWB,cust.data("ProfileId1"),"XFWB",true);
			libr.waitForSync(1); 
			...
			/*** HHT - ACCEPTING REMAINING PIECES   ****/
 			...
 			gahht.saveAcceptanceDetails();
 			gahht.verifyBlock("FullAWBNo", "val~Screening");
 			libr.quitApp();
			...
			MSG005.verifyIfMessageTriggered(pmKeyXFWB,cust.data("ProfileId2"),"XFWB",true);
			libr.waitForSync(1); 
			MSG005.closeTab("MSG005", "MSG005 - List Messages");	
