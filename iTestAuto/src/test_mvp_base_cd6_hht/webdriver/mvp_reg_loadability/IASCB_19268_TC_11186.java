...
/** TC_15_Verify Frangible loadability status of ULD when built up volume in ULD is 75 percent and rigid ratio in builtup volume is between 12-50 percent (excluding 12 and 50)***/


public class IASCB_19268_TC_11186 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("awbNum4", cust.data("CarrierNumericCode")  + cust.data("prop~AWBNo"));
			...
			String scc[] = { cust.data("SCC").split(",")[0], cust.data("SCC").split(",")[0], cust.data("SCC").split(",")[1], cust.data("SCC").split(",")[2] };
			...
			/**** OPR339 - Security & Screening -AWB4****/
		    ...
		    /*************OPR023 - Remove compliance block************/
			cust.searchScreen("OPR023","AWB CLearance");
			OPR023.listAWB("CarrierNumericCode", "AWBNo3");
			OPR023.selectCheckboxandReleaseBlock("val~Compliance","val~Customs Block removed");  
		    OPR023.closeTab("OPR023", "AWB Clearance");
		    
		    /*************OPR023 - Remove compliance block************/
			cust.searchScreen("OPR023","AWB CLearance");
			OPR023.listAWB("CarrierNumericCode", "AWBNo4");
			OPR023.selectCheckboxandReleaseBlock("val~Compliance","val~Customs Block removed");  
		    OPR023.closeTab("OPR023", "AWB Clearance");
			...
			/**** OPR335 -Goods Acceptance for AWB4 ****/
			...
			buhht.enterAWBDetailsWithoutPcsWgt("awbNumber");
			buhht.enterShipmentDetails("Pieces", "Weight");
			map.put("awbNumber", cust.data("CarrierNumericCode")+cust.data("AWBNo3"));
			buhht.enterAWBDetailsWithoutPcsWgt("awbNumber");
			buhht.enterShipmentDetails("Pieces", "Weight");
			map.put("awbNumber", cust.data("CarrierNumericCode")+cust.data("AWBNo4"));
			buhht.enterAWBDetailsWithoutPcsWgt("awbNumber");
			buhht.enterShipmentDetails("Pieces", "Weight");
