...
public class Breakdown_IAD2_002 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			bdhht.enterBulkValue("val~BULK");
			bdhht.updateFlightDetails("prop~flight_code_KL", "prop~flightNo","nextDay");
			bdhht.addAWB("FullAWBNo1");
			bdhht.addLocation(cust.data("BDNlocation").split(",")[0]);
			String[] scc1={cust.data("SCC")};
			bdhht.selectSCC(scc1);
			map.put("RcvdPcs1",cust.data("RcvdPcs").split(",")[0]);
			map.put("RcvdWt1", cust.data("RcvdWt").split(",")[0]);
			bdhht.addPcsWgt("RcvdPcs1","RcvdWt1");	
			bdhht.clickSave();
			...
			bdhht.selectSCC(scc1);
			map.put("RcvdPcs2",cust.data("RcvdPcs").split(",")[1]);
			map.put("RcvdWt2", cust.data("RcvdWt").split(",")[1]);
			bdhht.addPcsWgt("RcvdPcs2","RcvdWt2");
			bdhht.clickSave();
			cust.clickBack("Breakdown");
			cust.clickBack("Breakdown");
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyXFSUNFD=cust.data("CarrierNumericCode")+" - "+cust.data("prop~AWBNo");
