...
public class HighShow_TC_9483 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			gahht.selectSccs(scc);
			gahht.enterLooseAcceptanceDetails("Pieces", "Weight1","Location");
			gahht.checkAllPartsReceived();
			gahht.verifyErrorMessage("val~Accepted weight should not be greater than stated weight");
