package iascb_161755;

/** TC_07_Verify the latest flight instruction received from CFP is getting displayed in panel in Export planning progress screen **/
...
public class IASCB_161755_TC_10429 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			aflsfp.enterFlightInstructionRemarks("FlightInstruction");
			aflsfp.clickSave();
			...
			ADD004.verifyFlightInstruction("FlightInstruction");
			...
			ADD007.clickList();
			ADD007.clickFlightInstructionIcon("FlightNo");
			String fltInstructions[]={cust.data("FlightInstruction")};
		    ADD007.verifyFlightInstructions(fltInstructions,"CFP");
			...
			aflsfp.enterFlightDetails("carrierCode", "FlightNo", "BookDate","BookDate");
			aflsfp.clickSearch();
			aflsfp.clickWHUnHandOver();

			//CFP Trigger to send updated Flight Instruction
			aflsfp.selectShipment("FullAWBNo");
			aflsfp.enterLoadingPriority("UpdatedloadingPrio", "FullAWBNo");
			aflsfp.enterFlightInstructionRemarks("UpdatedFlightInstruction");
			aflsfp.clickSave();
			aflsfp.clickWHHandOver();
			aflsfp.verifyWHHandOverStatus();
			libr.quitBrowser();
			...
			ADD004.listFlight("carrierCode","FlightNo","StartDate");
			ADD004.verifyShipmentInLoadPlan("AWBNo");
			ADD004.verifyLoadingPriorityfromCFP("UpdatedloadingPrio", "AWBNo");
		    //Verifying updated flight instruction
			ADD004.verifyFlightInstruction("UpdatedFlightInstruction");
			cust.closeTab("ADD004", "Buildup Planning");
			...
			ADD007.clickFlightInstructionIcon("FlightNo");
			//Verifying updated flight instruction
			String fltInstruction[]={cust.data("UpdatedFlightInstruction"),cust.data("FlightInstruction")};
		    ADD007.verifyFlightInstructions(fltInstruction,"CFP");
			cust.closeTab("ADD007", "Export Planning Progress");
