...
/** TC_05_Verify Auto SU is generated as part of Split offload of a shipment from HHT scanner **/
public class IASCB_162860_TC_10487_KL extends BaseSetup {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			WHS011.clickList();
			int verfCol[]={5};
			String[] actVerfVal={cust.data("UldNum")};
			WHS011.verifyWarehouseDetailsWithPmKey(verfCol, actVerfVal,"Pieces");
			...
			//Offloading the some pieces of the Shipment
			map.put("FullAWB", cust.data("CarrierNumericCode") + cust.data("AWBNo"));
			offloadhht.enterValue("FullAWB");
			offloadhht.enterLocation("Location");
			offloadhht.enterPieces("Pieces1");
			...
			WHS011.enterAWBdetails("CarrierNumericCode","AWBNo");
			WHS011.clickList();
			//Verifying the new Auto generated SU
			int verfCols[]={4,9,10};
			String[] actVerfVal1={cust.data("Location"),cust.data("Pieces1"),cust.data("Weight1")};
			map.put("SU1", cust.data("CarrierNumericCode") + cust.data("AWBNo")+"002");
			WHS011.verifyWarehouseDetailsWithPmKey(verfCols, actVerfVal1,"SU1");
			cust.closeTab("WHS011", "Warehouse Shipment Enquiry");

			/*** HHT - OFFLOAD****/
			offloadhht.invokeOffloadHHTScreen();
			//Offloading the remaining pieces of the Shipment
			offloadhht.enterValue("UldNum");
			offloadhht.clickArrow();
			map.put("AWB",cust.data("CarrierNumericCode") + " - " + cust.data("AWBNo"));
			offloadhht.clickOnAWBNo("AWB");		
			offloadhht.enterLocation("Location");
			...
			WHS011.enterAWBdetails("CarrierNumericCode","AWBNo");
			WHS011.clickList();
			//Verifying the next new Auto generated SU
			String[] actVerfVal2={cust.data("Location"),cust.data("Pieces2"),cust.data("Weight2")};
			map.put("SU2", cust.data("CarrierNumericCode") + cust.data("AWBNo")+"003");
			WHS011.verifyWarehouseDetailsWithPmKey(verfCols, actVerfVal2,"SU2");
			cust.closeTab("WHS011", "Warehouse Shipment Enquiry");
