...
/** TC_39_Verify shipment is marked non secure when XFWB received with no valid RA , NSC security status for shipment and block is not getting released  when Screening is failed -AMS
  **/
...
public class IASCB_164029_TC_12659 extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cust.searchScreen("OPR339", "Security and Screening");
			OPR339.listAWB("AWBNo", "CarrierNumericCode", "OPR339 - Security & Sceening");
			//Second Screening Method as Pass
			...
			OPR339.verifyNewSecurityStatusGivenIsTicked();
			OPR339.verifySecurityDataReviewedIsTicked();
			//Verify SCC SPX
			OPR339.verifyScc(sccs);
			//Verify Scc does not contain NSC
			OPR339.verifySccNotPresent(scc);
			cust.closeTab("OPR339", "Security & Screening");
