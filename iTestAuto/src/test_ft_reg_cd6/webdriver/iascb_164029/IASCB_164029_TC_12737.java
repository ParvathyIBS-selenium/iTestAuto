...
/** TC_45_Verify RA accepting issue ID is getting populated in OPR339 when partial acceptance done by the user which is configured in ADM007 **/
...
public class IASCB_164029_TC_12737 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("RAAgentType", WebFunctions.getPropertyValue(custproppath, "regulated_Agent_Accepting_TypeCDG"));
			map.put("RAAcceptingCountryId", WebFunctions.getPropertyValue(custproppath, "regulated_Agent_Accepting_CountryIdCDG"));
			map.put("RAAcceptingCode", WebFunctions.getPropertyValue(custproppath, "regulated_Agent_Accepting_Carrier_CodeCDG"));
			map.put("RAAcceptingExpiry", WebFunctions.getPropertyValue(custproppath, "regulated_Agent_Accepting_ExpiryCDG"));
			...
			/**** OPR335 - Partial Goods Acceptance****/
			...
			cust.searchScreen("OPR335", "Goods Acceptance");
			cust.listAWB("AWBNo", "CarrierNumericCode", "Goods Acceptance"); 
			OPR335.looseAcceptanceDetails("Location", "Pieces1","Weight1");
			OPR335.addLooseShipment();
