...
/**TC_15_Verify Planning status not able to change when flight is flagged**/
...
public class IASCB_6168_TC_12778 extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			FLT006.listFlight("prop~flight_code","FlightNo", "StartDate");
			...
			/** Flag flight - Import Manifest**/

			cust.searchScreen("OPR367", "Import Manifest");
			OPR367.listFlight("prop~flight_code","FlightNo", "StartDate");
			OPR367.flagFlight();
			OPR367.clickReopen();
			//verify user not able to change the status of planning once it is already planned 
			OPR367.verifyPlanningCompleteButtonDisabled();
			OPR367.closeTab("OPR367", "Import Manifest");
			libr.quitBrowser();
