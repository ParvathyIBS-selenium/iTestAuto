...
/***TC_03_Verify user input Storage unit (SU) in warehouse relocation screen(WHS009) is retained and SU is not generated automatically .**/
public class IASCB_162868_TC_10432_KL extends BaseSetup {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			WHS009.enterDestinationLocAndSU("Location1","SU");
			cust.switchToMainScreen("WHS009");
			String []actverfval={cust.data("Location1"),cust.data("Pieces"),cust.data("SU")};
			//verify relocation details after relocation
			WHS009.verifyRelocationDetailsAfterRelocation(actverfval);
			...
			WHS009.enterAWB("CarrierNumericCode","AWBNo");
			WHS009.listAwbDetails();
			//verify current location after relocation done
			WHS009.VerifyCurrentLocOfULD("SU","Location1");
			int verfCols1[]={7,8};
			String[] actVerfValues1={cust.data("Location1"),cust.data("SU")};
			WHS009.verifyAWBDetails(verfCols1, actVerfValues1,pmkey,true);
			cust.closeTab("WHS009", "Warehouse Relocation");
			
			/** WAREHOUSE shipment Enquiry screen  - WHS011 **/
			cust.searchScreen("WHS011", "Warehouse shipment Enquiry");
			WHS011.enterAWBdetails("CarrierNumericCode","AWBNo");
			WHS011.clickList();
			int[] verfCols2={4,5};
			String[] actVerfValues2={cust.data("Location1"),cust.data("SU")};
			WHS011.verifyWarehouseDetailsWithPmKey(verfCols2, actVerfValues2,"Location1");
