package cgopush;
/**  Verify SMS is sent to the truck drivers mobile number  from iCargo -Customer Truck pickup**/
...
public class Cgopush_TC_10196 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws IOException {
		...
		try {
			...
			String pmkey = Excel.getCellValue(path1, sheetName, "Cgopush_TC_10196", "UldNum");
			...
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			dpsst.enterMobileNumber("MobileNumber");
			dpsst.enterDriverDetailsWithScroll("StartDate","Origin");
			dpsst.clickProceed();
			dpsst.selectVehicletype("VehicleType");
			dpsst.clickProceed();
			libr.waitForSync(2);
			dpsst.verifyTokenGeneration("TokenId");
			dpsst.verifyDirectedToDock("val~Dock");
