package vccustoms;
/** TC_04_Check Exception is there for MAWB with SCI C, as MRN will not be mandatory for those MAWBs   **/
...
public class ProvideExportCustomData_TC_7804 extends BaseSetup {
