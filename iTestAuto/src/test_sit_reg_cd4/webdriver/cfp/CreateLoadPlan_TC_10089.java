...
/**  TC_10_Verify manual update of instructions in build up planning screen  **/
...
public class CreateLoadPlan_TC_10089 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			ADD004.enterFlightlevelInstruction(cust.data("UpdatedRemarks"));
			...
			String[] intructions={cust.data("Remarks"),cust.data("UpdatedRemarks")};
