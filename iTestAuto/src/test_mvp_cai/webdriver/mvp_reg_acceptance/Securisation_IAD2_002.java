...
public class Securisation_IAD2_002 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("AgentCountryId", WebFunctions.getPropertyValue(custproppath, "cashCustomercountryId_FR"));
			map.put("RegulatedAgent", WebFunctions.getPropertyValue(custproppath, "regulatedAgentId_EG"));
