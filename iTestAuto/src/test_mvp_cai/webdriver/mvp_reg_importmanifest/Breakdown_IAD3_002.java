...
public class Breakdown_IAD3_002 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String pmKeyXFSURCF3=cust.data("prop~CarrierNumericCode")+" - "+cust.data("awb3");
			String pmKeyXFSURCF4=cust.data("prop~CarrierNumericCode")+" - "+cust.data("awb4");
			...
			Cgomon.verifyMessageStatus("awbNumber", "Incoming XFSU", "ICARGO");
			//verify 3rd awb
			map.put("awbNumber", cust.data("prop~CarrierNumericCode")+"-"+cust.data("awb3"));
			Cgomon.enterAWB("awbNumber");
			Cgomon.clickSearch();
			Cgomon.verifyMessageStatus("awbNumber", "Incoming XFSU", "ICARGO");
			//verify 4th awb
			map.put("awbNumber", cust.data("prop~CarrierNumericCode")+"-"+cust.data("awb4"));
			Cgomon.enterAWB("awbNumber");
			Cgomon.clickSearch();
			Cgomon.verifyMessageStatus("awbNumber", "Incoming XFSU", "ICARGO");
