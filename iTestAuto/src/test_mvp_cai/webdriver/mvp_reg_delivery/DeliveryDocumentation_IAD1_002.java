...
/**
 * Delivery of loose shipments for the same customer with other charges to be added manually(ex: DJ / MG / MC / UD)
 **/
public class DeliveryDocumentation_IAD1_002 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ConsigneePhoneNo", WebFunctions.getPropertyValue(custproppath, "cash_telephoneNo_EG"));
