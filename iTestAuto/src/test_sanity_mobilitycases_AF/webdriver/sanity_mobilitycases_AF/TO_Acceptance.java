...
public class TO_Acceptance extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String TODetails[]={"Open",WebFunctions.getPropertyValue(toproppath, "AcceptanceHA_CDG"),WebFunctions.getPropertyValue(toproppath, "ControlLocationHA_CDG"),"RELOCATION"};
