...
/**
 * 
 *TC_12_02_Verify TO to destocking IM- Forklift
 *
 *
 */

public class Destocking_IM_ForkLift_TC_13532 extends BaseSetup {
	...
	@DataProvider(name = "Destocking_IM_ForkLift_TC_13532")
	...
	@Test(dataProvider = "Destocking_IM_ForkLift_TC_13532")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("BuildupLocation_ForkLift", WebFunctions.getPropertyValue(toproppath, "BuildupLocation_ForkLift"));
			OPR344.captureLocationAndAWBDetails("BuildupLocation_ForkLift", "CarrierNumericCode", "AWBNo", "Pieces", "Weight", "Volume");
			...
			map.put("IM_EquipmentType_ForkLift", WebFunctions.getPropertyValue(toproppath, "IM_EquipmentType_ForkLift"));
			ADD013.selectEquipmentType(cust.data("IM_Equipment"),"IM_EquipmentType_ForkLift");
			...
			String srcBuildupLocation_ForkLift=to.retrieveSrcLocation("UldNum");
			map.put("srcBuildupLocation_ForkLift", srcBuildupLocation_ForkLift);
			
			//fetch and verify the src location 
			to.retrieveAndVerifyOriginLocation("UldNum", "BuildupLocation_ForkLift");
			
			
			//fetch destination location
			String IM_ForkLiftExitLocation=to.retrieveDestnLocation("UldNum");
			map.put("IM_ForkLiftExitLocation", IM_ForkLiftExitLocation);
			
			
			//verifying the generated TO status in the TO app
			to.verifyShipmentDetails("UldNum", "val~Open", "BuildupLocation_ForkLift");
			libr.quitApp();
			...
			//Verifying IM exit location of forklift and zone for ULD
			String[] actVerfValues2= {WebFunctions.getPropertyValue(toproppath, "IMExitZone_Forklift")};
			//verifying the location displayed is in the correct Zone as per the configuration
			WHS008.verifyLocationAndCorrespondingZone("IM_ForkLiftExitLocation", verfCols, actVerfValues2);
			...
			String TODetails[]={"Open",WebFunctions.getPropertyValue(toproppath, "BuildupHA_ForkLift"),WebFunctions.getPropertyValue(toproppath, "IM_ForkLiftExit_HA")};
			WHS052.verifyTODetails(3, ColumnNames, "UldNumber", TODetails);
			WHS052.maximizeAwbDetails("UldNum");
			WHS052.verifyCurrentLocation("UldNum", "Current.Loc","Current.Loc"+"\n"+cust.data("srcBuildupLocation_ForkLift"));
			WHS052.verifyDestinationLocation("UldNum", "Dest.Loc","Dest.Loc"+"\n"+cust.data("IM_ForkLiftExitLocation"));
			//verifying the vehicle type as ForkLift
			WHS052.verifyVehicleType("UldNum", "Vehicle Type", "Vehicle Type"+"\n"+cust.data("val~FORKLIFT"));
