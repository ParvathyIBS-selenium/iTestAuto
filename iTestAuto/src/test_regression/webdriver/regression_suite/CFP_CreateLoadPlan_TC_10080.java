...
public class CFP_CreateLoadPlan_TC_10080 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Verify auto-release of Customs block is happening
			/************ OPR023-AWB Clearance************/
			cust.searchScreen("OPR023", "AWB Clearance");
			OPR023.listAWB("CarrierNumericCode","AWBNo");
			OPR023.verifyBlockReleasedForShipment(cust.data("val~Customs"),cust.data("FullAWBNo"),cust.data("Origin"));
			OPR023.closeTab("OPR023", "AWB Clearance");
			
			/**** OPR026 - Capture AWB ****/
			cust.searchScreen("OPR026", "Capture AWB");
			OPR026.listAWB("AWBNo", "CarrierNumericCode");		
			//Customs block will be auto-released in this case
