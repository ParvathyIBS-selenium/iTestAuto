...
/** TC_02_Verify iCargo  updates the scale weight against the ULD  in message with the grossWeight after UOW message is received from WCS to icargo  **/
...
import rest_wcsusu_uow.Jsonbody;
...
public class WCS_UOW_ActionStorageUnit_TC_7615 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/******* POST REQUEST - UOB****/		
			jsonbody1.postRequest("ULD",cust.data("UldType"),cust.data("ULDNo"),cust.data("carrierCode"),cust.data("Destination"),flightdate,cust.data("FlightNo"));
			...
			/******* POST REQUEST - UOW ****/		
			jsonbody.postRequest("ULD",cust.data("UldType"),cust.data("ULDNo"),cust.data("carrierCode"),flightdate,cust.data("FlightNo"),cust.data("ActualWgt"));
			...
			OPR063.verifyULDActualWeight("UldNum","ActualWgt");
			...
			OPR344.verifyActualULDWeight("ActualWgt");
			cust.closeTab("OPR344", "Export Manifest");
				
			/**** OPR013 - ULD Tag Screen ****/
			cust.searchScreen("OPR013", "ULD Tag Screen");
			OPR013.listUldTagDetails("carrierCode","FlightNo","StartDate","UldNum");
			OPR013.verifyAcutalULDWeight("ActualWgt");
			cust.closeTab("OPR013", "ULD Tag Screen");
