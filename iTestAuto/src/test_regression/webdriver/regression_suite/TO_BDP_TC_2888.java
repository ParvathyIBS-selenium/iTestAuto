...
public class TO_BDP_TC_2888 extends BaseSetup
{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			expbuildup.assignBuildupLocation("FullAWBNo","PITLocation_CDG","PITLocationZone_CDG");
			expbuildup.verifyupdatedBuildupLocation("PITLocation_CDG");
			...
			String TODetails[]={"Open",WebFunctions.getPropertyValue(toproppath, "ControlLocationHA_CDG"),WebFunctions.getPropertyValue(toproppath, "PITLocationHA_CDG"),cust.data("carrierCode")+"-"+cust.data("FlightNo")+" "+cust.data("StartDate")+"(E)","RELOCATION TASK"};
