...
/**   Build-up task must be created automatically based on the allocation.  **/
...
public class ExportBDP_TC_2107 extends BaseSetup {
	...
	String sheetName = "exportbuildup";
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cust.loginExportBuildUp(hht[0], hht[1]);
