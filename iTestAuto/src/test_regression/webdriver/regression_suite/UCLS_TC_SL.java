...
/** TC_13_Verify Compressible  loadibility status of ULD when built up volume in ULD is equal to 75 percent and rigid ratio in builtup volume is equal to  12 percent***/


public class UCLS_TC_SL extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Verify loadability status getting displayed as Compressibility�
			...
			String[]awbs={cust.data("FullAWBNo2")};
