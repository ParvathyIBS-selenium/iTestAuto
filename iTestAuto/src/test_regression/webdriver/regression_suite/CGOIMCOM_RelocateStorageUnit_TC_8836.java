...
/**  TC_01_Verify ULD will be relocated from the current location to location provided in the message.**/
...
public class CGOIMCOM_RelocateStorageUnit_TC_8836 extends BaseSetup {
	...
	String sheetName = "cgoimcom_Relocatestorage";
