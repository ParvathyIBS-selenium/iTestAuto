...
/**
 * Generate DN for part-shipments with additional charges
**/
public class DeliveryDocumentation_IAD3_002 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ConsigneeCode", WebFunctions.getPropertyValue(custproppath, "credit_CustomerId_CM"));
			map.put("ConsigneeName", WebFunctions.getPropertyValue(custproppath, "credit_CustomerName_CM"));
			map.put("ConsigneePostCode", WebFunctions.getPropertyValue(custproppath, "credit_postCode_CM"));
			map.put("ConsigneeStreetName", WebFunctions.getPropertyValue(custproppath, "credit_streetName_CM"));
			map.put("ConsigneeCityName", WebFunctions.getPropertyValue(custproppath, "credit_cityName_CM"));
			map.put("ConsigneeCountryId", WebFunctions.getPropertyValue(custproppath, "credit_countryId_CM"));
			map.put("ConsigneeCountryName", WebFunctions.getPropertyValue(custproppath, "credit_countryName_CM"));
			map.put("ConsigneeCountrySubDiv", WebFunctions.getPropertyValue(custproppath, "credit_countrySubdivision_CM"));
			map.put("ConsigneePhoneNo", WebFunctions.getPropertyValue(custproppath, "credit_telephoneNo_CM"));
			map.put("ConsigneeEmail", WebFunctions.getPropertyValue(custproppath, "credit_email_CM"));
			...
			map.put("DestinationAirport", WebFunctions.getPropertyValue(custproppath, "DLA"));
		...
		//	mercuryScreen.verifyMsgStatus("SSM");
           ...
           //Relaunch browser
			...
			OPR293.generateDeliveryIDforPartialPiecesWithFop("Remarks","CREDIT",true,"val~CD",true);
			OPR293.selectAllAWBs();
