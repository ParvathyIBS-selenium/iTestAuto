...
/**
 * Export of AWB for which FWB have been sent by the customers FBL received for
 * an "other airline" flight
 **/
public class ExportOtherAirlineAWB_646 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR344.clickEditULDdetails("UldNum");
			OPR344.addAWBDetails("CarrierNumericCode", "prop~AWBNo", false);
			...
			/********** CHECKING IF FSU-RCS GOT TRIGGERD ****/
			...
			String pmKeyXFFM=cust.data("carrierCode")+" - "+cust.data("FlightNo1")+" - "+cust.data("Day")+" - "+cust.data("Month").toUpperCase()
					+" - "+cust.data("Transit");
			int verfColsFFM[] = { 9 };
			String[] actVerfValuesFFM = { "Sent" };
			MSG005.verifyMessageDetails(verfColsFFM, actVerfValuesFFM, pmKeyXFFM, "val~xFFM", false);
			libr.waitForSync(1);
			MSG005.closeTab("MSG005", "MSG005 - List Messages");
			libr.quitBrowser();
