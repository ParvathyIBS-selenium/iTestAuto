...
//Manual data capture of a paper AWB for secured shipments unvalid IAC and CCSF certificates
...
public class PaperDCSPXTSA_5_1 extends BaseSetup{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Store other charges
			OPR026.storeOtherChargesValue("OtherCharges","IATAcharge");
			...
			msgContents.add("val~<ApplicableLogisticsAllowanceCharge>"+"\n"+
			         ...
			         "\n"+"<PartyTypeCode>C</PartyTypeCode>" +
			    	     "\n"+"<ActualAmount currencyID="+currency+">"+cust.data("IATAcharge")+"</ActualAmount>"+
