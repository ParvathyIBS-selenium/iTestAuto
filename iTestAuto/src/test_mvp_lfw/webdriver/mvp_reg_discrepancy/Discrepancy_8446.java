...
public class Discrepancy_8446 extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR045.selectDiscCode("FDAW");
			OPR045.enterRemarks("Found AWB");
			OPR045.createDisc();
			...
			msgContents.add("val~<DiscrepancyDescriptionCode>FDAW</DiscrepancyDescriptionCode>");
