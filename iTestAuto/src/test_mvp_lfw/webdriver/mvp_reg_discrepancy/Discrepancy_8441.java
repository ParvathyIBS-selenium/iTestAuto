...
//capture FDCA from capture miscallaneous discrepancy opr045 web screen
public class Discrepancy_8441 extends BaseSetup {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR045.enterRemarks("Found Cargo");
			OPR045.createDisc();
