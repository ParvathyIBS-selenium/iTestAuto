...
public class Discrepancy_8447 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws Exception {
		...
		try {
			...
			map.put("ConsigneeCode", WebFunctions.getPropertyValue(custproppath, "cash_customerId_TG"));
			map.put("ConsigneeName", WebFunctions.getPropertyValue(custproppath, "cash_customerName_TG"));
			map.put("ConsigneePostCode", WebFunctions.getPropertyValue(custproppath, "cash_postCode_TG"));
			map.put("ConsigneeStreetName", WebFunctions.getPropertyValue(custproppath, "cash_streetName_TG"));
			map.put("ConsigneeCityName", WebFunctions.getPropertyValue(custproppath, "cash_cityName_TG"));
			map.put("ConsigneeCountryId", WebFunctions.getPropertyValue(custproppath, "cash_countryId_TG"));
			map.put("ConsigneeCountryName", WebFunctions.getPropertyValue(custproppath, "cash_countryName_TG"));
			map.put("ConsigneeCountrySubDiv", WebFunctions.getPropertyValue(custproppath, "cash_countrySubdivision_TG"));
			map.put("ConsigneePhoneNo", WebFunctions.getPropertyValue(custproppath, "cash_telephoneNo_TG"));
			map.put("ConsigneeEmail", WebFunctions.getPropertyValue(custproppath, "cash_email_TG"));
			...
			//Verify Outbound XFSU - DIS trigerred to mercury with recipient QVIF1AF
			...
			map.put("RecipientAddressAfls1",WebFunctions.getPropertyValue(telexproppath, "ReceiptaddressAfls1"));
			...
			Cgomon.enterRecipientAddress("RecipientAddressAfls1");
			Cgomon.clickSearch();
			Cgomon.verifyMessageStatus("awbNumber", "Outgoing Discrepency", "Mercury");

			Cgomon.cleanDetails();
			
			//Verifying Outbound XFSU - DIS trigerred to Pelican 
			Cgomon.enterFromandToDates(cust.createDateFormatWithTimeZone("dd-MM-YYYY", -1, "DAY", ""), cust.createDateFormatWithTimeZone("dd-MM-YYYY", 1, "DAY", ""));
			Cgomon.enterAWB("awbNumber");
			Cgomon.enterMessageType("XFSU-DIS");
			Cgomon.enterChannel("PELICAN","Outgoing");
			Cgomon.clickSearch();
			Cgomon.verifyMessageStatus("awbNumber", "Outgoing Discrepency", "PELICAN");
