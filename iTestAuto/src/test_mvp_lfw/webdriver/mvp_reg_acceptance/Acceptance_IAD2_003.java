...
/**
 * "Goods acceptance with DG,AWB data capture and screening not done"
 **/
public class Acceptance_IAD2_003 extends BaseSetup{
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("AgentName", WebFunctions.getPropertyValue(custproppath, "cash_customerName_TG"));
			...
			String sccs[]={cust.data("SCC").split(";")[0].split(",")[0],cust.data("SCC").split(";")[0].split(",")[1]};
