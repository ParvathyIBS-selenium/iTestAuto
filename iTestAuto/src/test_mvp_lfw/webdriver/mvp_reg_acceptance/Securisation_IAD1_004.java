...
/**
 * Screening of unsecured shipments (NSC) with pass result
**/
public class Securisation_IAD1_004 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("AgentCountryId", WebFunctions.getPropertyValue(custproppath, "cash_countryId_TG"));
