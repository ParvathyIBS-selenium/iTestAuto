...
/**
 * "Loose shipments with complete acceptance AWB data capture is not executed
 * and screening are not done (or fail) (FWB received)"
 **/
public class Acceptance_IAD1_003 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ShipperCode", WebFunctions.getPropertyValue(custproppath, "cash_customerId_TG"));
			map.put("ShipperName", WebFunctions.getPropertyValue(custproppath, "cash_customerName_TG"));
			map.put("ShipperPostCode", WebFunctions.getPropertyValue(custproppath, "cash_postCode_TG"));
			map.put("ShipperStreetName", WebFunctions.getPropertyValue(custproppath, "cash_streetName_TG"));
			map.put("ShipperCityName", WebFunctions.getPropertyValue(custproppath, "cash_cityName_TG"));
			map.put("ShipperCountryId", WebFunctions.getPropertyValue(custproppath, "cash_countryId_TG"));
			map.put("ShipperCountryName", WebFunctions.getPropertyValue(custproppath, "cash_countryName_TG"));
			map.put("ShipperCountrySubDiv", WebFunctions.getPropertyValue(custproppath, "cash_countrySubdivision_TG"));
			map.put("ShipperPhoneNo", WebFunctions.getPropertyValue(custproppath, "cash_telephoneNo_TG"));
			map.put("ShipperEmail", WebFunctions.getPropertyValue(custproppath, "cash_email_TG"));
			...
			map.put("AgentCode", WebFunctions.getPropertyValue(custproppath, "cash_customerId_TG"));
			map.put("CassCode", WebFunctions.getPropertyValue(custproppath, "cashCustomer_CASSCode_TG"));
			map.put("IATACode", WebFunctions.getPropertyValue(custproppath, "cashCustomer_IATACode_TG"));
			...
			CSH007.selectPaymentMode("TRANSFERT");
			CSH007.enterRemarks("val~Bank Transfer");
			CSH007.clickAdd();
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyFSU = cust.data("prop~CarrierNumericCodeAMS") + " - " + cust.data("AWBNo");
			int verfColsFSU[] = { 9 };
            ...
            MSG005.selectStatus("Sent");
            MSG005.clickList();
            String pmKeyRCS=cust.data("prop~CarrierNumericCodeAMS")+" - "+cust.data("AWBNo");
            int verfColsRCS[]={9};
