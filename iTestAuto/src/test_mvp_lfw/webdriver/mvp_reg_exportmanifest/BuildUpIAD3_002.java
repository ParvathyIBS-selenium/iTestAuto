...
/**
 * Manually Add and unassigns a ULD from the flight
**/
public class BuildUpIAD3_002 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR344.saveAndClose();
			OPR344.clickShipemntFromPlannedSection("prop~AWBNo");
			...
			OPR063.listFlightDetails("prop~flight_code", "FlightNo", "StartDate");
			...
			cust.searchScreen("OPR344", "Export manifest");
			OPR344.listFlight(	"prop~flight_code", "FlightNo","StartDate");
			OPR344.offloadULDAfterBuildupComplete("UldNum");

			OPR344.clickLyingList();
			OPR344.applyFilter("prop~CarrierNumericCode","prop~AWBNo");
			OPR344.clickLyingList();
			OPR344.verifyShipmentInLyingList("prop~AWBNo");
			OPR344.clickLyingList();
			OPR344.verifyULDShipmentInLyingList("UldNum");
			cust.closeTab("OPR344", "Export manifest");
