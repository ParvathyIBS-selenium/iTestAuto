...
/**
 * Build up of an Intact ULD with MAWB+HAWB for which an FBL has been received
 **/
public class BuildUpIAD1_006 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR344.clickEditULDdetails("UldNum");
			OPR344.clickMoreUldDetails();
			OPR344.captureBreakdownInstruction("1");
			OPR344.clickEditULDdetails("UldNum");
			OPR344.addAWBDetails("prop~CarrierNumericCode", "AWBNo", true);
			...
			MSG005.clickList();
			String pmKeyUWS = cust.data("prop~flight_code") + " - " + cust.data("prop~flightNo") + " - "
