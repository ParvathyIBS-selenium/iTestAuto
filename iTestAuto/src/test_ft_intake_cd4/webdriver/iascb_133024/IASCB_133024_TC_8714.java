...
/**  TC_05_Verify user is able to create allocation for Pallets- build-up location is specified(PMC) **/
...
public class IASCB_133024_TC_8714 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			ADD004.selectBPLocation("BDNlocation");
			ADD004.verifyHA(cust.data("HA"));
			ADD004.clickSaveAllocation();
			ADD004.verifyEmptyAllocation("val~1 PMC","Route");
			ADD004.verifyBuildUpLocationAllocated("BDNlocation");
			ADD004.verifyHandlingAreaAllocated(cust.data("HA"));
			ADD004.selectEditbutton();
			ADD004.verifyHAAndBUPAllocatedInUpdatePOPUp("HA","BDNlocation");
