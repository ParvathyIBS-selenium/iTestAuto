...
/**     TC_01_ Verify the actual Weight is received for ULD when user click on Get weight scale button-HHT  **/
...
public class IASCB_204301_TC_12910 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws Exception {
		...
		try {
			...
			//Verifying Error when Actual Weight is not captured on BuildUp Complete
			buhht.clickBuildUpCompleteWithoutWeightCapture();
			buhht.clickSaveCaptureChecksheet();   
			buhht.clickTopUpNoOption();
			buhht.selectContourAndSave("Contour");
			cust.verifyErrorInHHT("Actual Weight is mandatory for ULD");
			
			//Getting Actual Weight
			buhht.clickMoreOptions();
			...
			//Retrieving Actual Weight from UpdateEquipmentCharacteristics via Get Scale Button
			...
			//Verifying BuildUp is Completed after Capturing Actual Weight
			buhht.clickBuildUpCompleteWithoutWeightCapture();
			buhht.clickOnSave();  
			buhht.clickTopUpNoOption();
			libr.quitApp();	
