...
/***TC_01_Verify payment advice generated for an AWB along with AWB summary , charge details and Payment details for cash customer**/
public class IASCB_181724_TC_12864 extends BaseSetup  {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ConsigneeCode", WebFunctions.getPropertyValue(custproppath, "cashCustomerId_FR3"));
			map.put("ConsigneeName", WebFunctions.getPropertyValue(custproppath, "cashCustomerName_FR3"));
			map.put("ConsigneePostCode", WebFunctions.getPropertyValue(custproppath, "cashCustomerpostCode_FR3"));
			map.put("ConsigneeStreetName", WebFunctions.getPropertyValue(custproppath, "cashCustomerstreetName_FR3"));
			map.put("ConsigneeCityName", WebFunctions.getPropertyValue(custproppath, "cashCustomercityName_FR3"));
			map.put("ConsigneeCountryId", WebFunctions.getPropertyValue(custproppath, "cashCustomercountryId_FR3"));
			map.put("ConsigneeCountryName", WebFunctions.getPropertyValue(custproppath, "cashCustomercountryName_FR3"));
			map.put("ConsigneeCountrySubDiv",WebFunctions.getPropertyValue(custproppath, "cashCustomercountrySubdivision_FR3"));
			map.put("ConsigneePhoneNo", WebFunctions.getPropertyValue(custproppath, "cashCustomertelephoneNo_FR3"));
			map.put("ConsigneeEmail", WebFunctions.getPropertyValue(custproppath, "cashCustomertelephoneNo_FR3"));
			...
			OPR367.enterBdnDetailsIfnotPopulated(1, Location, Pieces, Weight);
			...
			OPR293.generateDeliveryIDWithOthercharges("chargecode","val~charges Paid","CASH",true);
			OPR293.verifyDNStatus("Paid");
			OPR293.verifyDeliverID();
			String DNInfo=OPR293.retrieveDeliveryDocumentationDetails("prop~AWBNo", "12").split("\\[")[0];
			...
			CSH007.listWithAWB("prop~CarrierNumericCode", "AWBNo");
