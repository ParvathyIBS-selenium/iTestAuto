...
//TC_06_Verify if AWB is executed once the LAT value is updated




public class IASCB_202482_TC_12857 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String newBookingDate =cust.createDateFormat("dd/MMM/YYYY",3, "DAY", "");
			map.put("NewBookDate", newBookingDate);
			String endDate = cust.createDateFormat("dd/MMM/YYYY",7, "DAY", "");
			...
			//To verify LAT is not stamped in status check pop up since booking is not done from AFLS
			OPR026.verfyLATIsNotStamped();
			OPR026.removeCustomsBlock();
			//Verifying the warning message displayed on clicking the as-is- execute button
			OPR026.clickAsIsExecuteAndVerifyWarning("Booking is not available for the AWB. Do you want to continue?");
			...
			OPR026.listAWB("AWBNo", "CarrierNumericCode");
			//Verifying the warning message displayed on clicking the as-is- execute button
			OPR026.clickAsIsExecuteAndVerifyWarningNotDisplayed("Booking is not available for the AWB. Do you want to continue?");
			//To verify LAT is stamped in status check popup
			OPR026.verfyLATStamped();
			OPR026.LATUpdatedInShipmentStatus("LATData","LATDate");
			cust.closeTab("OPR026", "Capture AWB");
			libr.quitBrowser();
