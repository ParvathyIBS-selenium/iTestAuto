...
public class Acceptance_IAD2_003 extends BaseSetup{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ShipperName", WebFunctions.getPropertyValue(custproppath, "cash_customerName_TN"));
			map.put("ShipperPostCode", WebFunctions.getPropertyValue(custproppath, "cash_postCode_TN"));
			map.put("ShipperStreetName", WebFunctions.getPropertyValue(custproppath, "cash_streetName_TN"));
			map.put("ShipperCityName", WebFunctions.getPropertyValue(custproppath, "cash_cityName_TN"));
			map.put("ShipperCountryId", WebFunctions.getPropertyValue(custproppath, "cash_countryId_TN"));
			map.put("ShipperCountryName", WebFunctions.getPropertyValue(custproppath, "cash_countryName_TN"));
			map.put("ShipperCountrySubDiv", WebFunctions.getPropertyValue(custproppath, "cash_countrySubdivision_TN"));
			map.put("ShipperPhoneNo", WebFunctions.getPropertyValue(custproppath, "cash_telephoneNo_TN"));
			map.put("ShipperEmail", WebFunctions.getPropertyValue(custproppath, "cash_email_TN"));
			...
			map.put("AgentName", WebFunctions.getPropertyValue(custproppath, "cash_customerName_TN"));
			map.put("CassCode", WebFunctions.getPropertyValue(custproppath, "cashCustomer_CASSCode_TN"));
			map.put("IATACode", WebFunctions.getPropertyValue(custproppath, "cashCustomer_IATACode_TN"));
