 ...
 **/
public class Acceptance_IAD2_003_Credit extends BaseSetup{
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ShipperName", WebFunctions.getPropertyValue(custproppath, "credit_CustomerName_TN"));
			map.put("ShipperPostCode", WebFunctions.getPropertyValue(custproppath, "credit_postCode_TN"));
			map.put("ShipperStreetName", WebFunctions.getPropertyValue(custproppath, "credit_streetName_TN"));
			map.put("ShipperCityName", WebFunctions.getPropertyValue(custproppath, "credit_cityName_TN"));
			map.put("ShipperCountryId", WebFunctions.getPropertyValue(custproppath, "credit_countryId_TN"));
			map.put("ShipperCountryName", WebFunctions.getPropertyValue(custproppath, "credit_countryName_TN"));
			map.put("ShipperCountrySubDiv", WebFunctions.getPropertyValue(custproppath, "credit_countrySubdivision_TN"));
			map.put("ShipperPhoneNo", WebFunctions.getPropertyValue(custproppath, "credit_telephoneNo_TN"));
			map.put("ShipperEmail", WebFunctions.getPropertyValue(custproppath, "credit_email_TN"));
			...
			map.put("AgentName", WebFunctions.getPropertyValue(custproppath, "credit_CustomerName_TN"));
			map.put("CassCode", WebFunctions.getPropertyValue(custproppath, "credit_CASSCode_TN"));
			map.put("IATACode", WebFunctions.getPropertyValue(custproppath, "credit_IATACode_TN"));
