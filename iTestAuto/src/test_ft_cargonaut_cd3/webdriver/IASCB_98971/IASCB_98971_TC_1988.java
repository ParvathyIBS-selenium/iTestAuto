...
/** TC_05_Compliance checks and AWB blocked based on RTI status - Not OK, ECS Not Ok. **/
/** Condition -  ECS NOK and RTI NOK **/
...
public class IASCB_98971_TC_1988 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			TGC015.clickCHIconAndVerifyTooltip("TokenID","RTI Status","MRN Missing/NOK, please update MRN");		           
			...
			OPR026.checkStatus("val~RTI-ECS");
			cust.closeTab("OPR026", "Capture AWB");
			libr.quitBrowser();
