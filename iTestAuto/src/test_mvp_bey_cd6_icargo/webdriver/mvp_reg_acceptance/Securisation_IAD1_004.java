...
/**
 * Screening of unsecured shipments (NHR) with pass result
 **/
public class Securisation_IAD1_004 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("AgentCountryId", WebFunctions.getPropertyValue(custproppath, "cash_countryId_LB"));
			...
			OPR339.listAWB("AWBNo", "CarrierNumericCode", "OPR339 - Security & Sceening");
			//verification of SCC
			String[] scc={"SHR",cust.data("SCC").split(",")[0]};
