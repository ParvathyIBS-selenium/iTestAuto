...
/**
 * Screening of unsecured shipments with fail result
 **/
public class Securisation_IAD1_002 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
	        ...
	        map.put("RegulatedAgent", WebFunctions.getPropertyValue(custproppath, "regulated_Agent_Carrier_Code_RED"));
            ...
            String resultsFail[]={"Fail","Pass"};
            OPR339.captureDoubleScreeningDetails(ScreeningMethod,Pieces,Weight,resultsFail);
            OPR339.addAgentDetails("AgentType","AgentCountryId","RegulatedAgent","Expiry");
			OPR339.clickPrint();
			...
			cust.printAndVerifyReport("val~Consignment Security Declaration","OPR339",
					...
					cust.data("CarrierNumericCode")+"-"+cust.data("prop~AWBNo"),
			...
			cust.searchScreen("OPR339", "Security and Screening");
			OPR339.listAWB("AWBNo", "CarrierNumericCode", "OPR339 - Security & Sceening");
            String resultsPass[]={"Pass","Pass"};
            OPR339.captureDoubleScreeningDetails(ScreeningMethod,Pieces,Weight,resultsPass);
			OPR339.saveSecurityDetails();
			cust.closeTab("OPR339", "Security & Sceening");
			...
			OPR339.listAWB("AWBNo", "CarrierNumericCode", "OPR339 - Security & Sceening");
			//verification of SCC
			String[] scc2={"SHR",cust.data("SCC").split(",")[0]};
