...
public class PhysicalDelivery_IAD1_001 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Verifying SPX is stamped and NSC/NHR is not
			String[]sccPresent={cust.data("SCC"),cust.data("val~SPX")};
			String[]sccNotPresent={cust.data("val~NSC"),cust.data("val~NHR")};
			...
			OPR293.generateDeliveryIDWithOthercharges("val~DJ","Remarks","CASH",true);
