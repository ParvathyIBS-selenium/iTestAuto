package cgopush;
/**  CDG_Verify SMS is sent to the truck drivers mobile no from iCargo during visit declaration-RFS outbound Truck  **/
...
public class Cgopush_TC_8777 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws IOException {
		...
		try {
			...
			/****** Loading XFBL for flight Flight ***/
			...
			ldRfssst.addFlightDetails("prop~flight_code", "FlightNo","CurrentDate");
			...
			Cgomon.clickSearch();
			Cgomon.verifySMSisTriggered("MobileNumber", "SMS_ICARGO_TRUCKDRIVER","PagerNumber","pls go to "+cust.data("ServicePoint"));
			Cgomon.verifySMSDetailsWithTokenNumber(cust.data("MobileNumber"), cust.data("TokenId"), "pls go to "+cust.data("ServicePoint"));
			libr.quitBrowser();
