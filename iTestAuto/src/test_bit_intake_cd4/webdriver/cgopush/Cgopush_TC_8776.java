package cgopush;
/**  AMS_Verify SMS is sent to the truck drivers mobile no when token assigned to counter during visit declaration-RFS outbound Truck **/
...
public class Cgopush_TC_8776 extends BaseSetup {
