 ...
 **/
public class Acceptance_IAD6_001_Transhipment extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR339.OkButtonAfterScreeningSaveWithoutCheckingCheckboxes();
			...
			/*******Verify FSU-RCT message is triggered in MSG005******/
			cust.searchScreen("MSG005", "MSG005 - List Messages");
			MSG005.enterMsgType("XFSU");
