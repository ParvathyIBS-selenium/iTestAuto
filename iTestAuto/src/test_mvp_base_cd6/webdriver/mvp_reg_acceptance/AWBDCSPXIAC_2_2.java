 ...
 * 
 * 
Data capture of a paper AWB for secured AWB(SPX)with on valid IAC
 certificate (CCSF is empty or wrong). An xFWB customer has been received.
 */

public class AWBDCSPXIAC_2_2 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//provide invalid CCSF certificate 
			...
			OPR026.asIsExecuteWithInvalidCertificate("CCSF Number specified is invalid. Do you want to continue");
