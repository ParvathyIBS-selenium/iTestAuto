...
/** TC_07_Verify error message displayed when the actual weight of the barrow (Kart no)  is not given in build up screen - HHT **/
...
public class IASCB_204301_TC_12867 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Create Cart
			String uldNo=cust.create_cart_number("UldType", "carrierCode");
		
			map.put("UldNum", uldNo);
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			buhht.selectBarrowYes();
