package iascb_104298;

/** TC_02_Check MRN  Capture AWB screen with As is Execute action**/
...
public class IASCB_104298_TC_8995 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws IOException {
		...
		try {
			...
			/**** XFWB Message loading without MRN Details ****/
			...
			OPR026.clickCheckStatus();
			OPR026.checkSectionStatus("val~Compliance","IN ERROR");
			cust.closeTab("OPR026", "Capture AWB");		
			
			String mrn=vcc.generateMrnNumber();
			map.put("MRN",mrn);
			map.put("Customsvalue", mrn);
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			...
			String mrns[]={"MRN"};
			String source[]={"val~ECS"};
			String infoId[]={"InfoId"};
			String customsInfoId[]={"customsAuthority"};			
