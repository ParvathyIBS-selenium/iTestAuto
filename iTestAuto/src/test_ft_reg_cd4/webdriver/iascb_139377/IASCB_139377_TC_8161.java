...
/**
 * 
 *  TC_01_Verify French customs authority details in OPR026 under customs information section in Additional Information tab for ECS
 *
 *
 */

public class IASCB_139377_TC_8161 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cust.searchScreen("MSG005", "MSG005 - List Messages");// Create XFWB message
			...
			OPR026.custonInfoTable("val~0","customsAuthority","parameter","CustomsValue");		
			OPR026.saveAWB();
			...
			"<Content>"+cust.data("CustomsValue")+"</Content>"+
					...
					"\n"+"<CountryID>"+cust.data("RACountryId")+"</CountryID>"+
					"\n"+"</IncludedCustomsNote>");
