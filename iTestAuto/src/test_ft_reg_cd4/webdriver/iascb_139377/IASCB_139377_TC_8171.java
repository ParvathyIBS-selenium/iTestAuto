...
/**
 * 1871:To verify whether TSD value is auto populated in Customs Information Section for French Customs when the parameter TSD is selected from the drop down
 **/


public class IASCB_139377_TC_8171 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String messageLine=cust.removeCustomsInfo(cust.parameters.get("messageLine"));
			cust.parameters.put("messageLine", messageLine);
			...
			dpsst.clickProceed();
			dpsst.enterDetailsBondedSideWithAgentAutopopulated("StartDate", "Origin","AgCode","Agentname");
			dpsst.clickProceed();
			...
			String TSDvalue=SHR097.retrieveTSDvalue("Agentname");
			...
			OPR026.verifyTSDvalue("val~0","customsAuthority","parameter","TSDvalue");
			OPR026.saveAWB();
			...
			String CustomsValue=cust.data("parameter")+"-"+TSDvalue;
			map.put("CustomsValue", CustomsValue);
			MSG005.clickCheckBox("pmkey");
			MSG005.clickView();
			List <String> msgContents=new ArrayList<String>();
			msgContents.add("val~<IncludedCustomsNote>"+"\n"+
					"<Content>"+cust.data("CustomsValue")+"</Content>");
