...
/*** TC_15_Verify Allocation created with BULK_multiple HAs are spec in allocation**/
...
public class IASCB_133024_TC_8724 extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			ADD004.selectAllocationType("BULK");
			ADD004.selectHA(cust.data("HA").split(",")[0]);
			ADD004.selectHA(cust.data("HA").split(",")[1]);
			ADD004.clickSaveAllocation();
			ADD004.verifyEmptyAllocation("val~BULK","Route");
			ADD004.verifyMultipleHAAllocated(cust.data("HA").split(",")[0]+"+1");
			ADD004.selectEditbutton();
			map.put("HandlingArea",cust.data("HA").split(",")[0]+", "+cust.data("HA").split(",")[1]);
			ADD004.verifyHAAndBUPAllocatedInUpdatePOPUp("HandlingArea","val~Select");
