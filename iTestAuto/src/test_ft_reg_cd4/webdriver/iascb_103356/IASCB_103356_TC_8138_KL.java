...
public class IASCB_103356_TC_8138_KL extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR030.verifyPlannedFlight(cust.data("FullFlightNo"), cust.data("StartDate")+cust.data("val~00:00")+"(E)");
			cust.closeTab("OPR030", "Export Shipment Listing");
			...
			OPR030.verifyPlannedFlight(cust.data("FullFlightNo"), cust.data("StartDate")+cust.data("ATD")+"(A)");
			cust.closeTab("OPR030", "Export Shipment Listing");
			libr.quitBrowser();
