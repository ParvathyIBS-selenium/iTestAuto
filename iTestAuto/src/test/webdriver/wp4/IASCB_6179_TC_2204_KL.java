...
/**Change in triggering FSU-RCF and FSU-NFD References**/
...
public class IASCB_6179_TC_2204_KL extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
	        ...
	        MSG005.verifyMessageDetails(verfColsFSUDIS, actVerfValues, pmKeyXFSU,"val~XFSU-DIS",false);
	        libr.waitForSync(1);
