package wp4;
/** Breakdown status filter in Breakdown List HHT screen for transfer Shipments  **/
...
public class IASCB_96729_TC_2306 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String shipments[] = { libr.data("FullAWBNo") + ";" + cust.data("Pieces") + ";" + cust.data("Weight")
			...
			MSG005.loadFromFile("All", "ALL", "MQ-SERIES", "", "Origin", "", "XFWB_Transit_MSG_withScreening", true);
			...
			// Create XFFM message
			cust.createXFFMMessage("XFFM", shipments, sccs, routing, uld);
			...
			bdlsthht.selectBDInstruction("val~Thru unit");
