...
/* TC_02_Error when retrieving actual weight of ULD from weight scale. */
...
public class IASCB_50790_TC_2256  extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			uldsighthht.verifyError("Unable to get scale weight");
            libr.quitApp();
