...
/**
 * 
 *  TC_03_Verify error when selected token is invalid and already 
 *
 */

public class IASCB_4751_TC_2432 extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			sstDP.getServicePointName("Counter");
			libr.quitApp();
			...
			serpointhht.verifyTokenNoIsDisplayedundercounter();
			...
			serpointhht.enterServicePoint("Counter");
			...
			//Verify token status
			int[] col = {39};
			String[] expValue= {"Call Forwarded"};
			TGC010.verifyVisitDeclarationDetails(col,expValue,cust.data("TokenID"));
			cust.closeTab("TGC010", "Visit Declaration Enquiry");
			libr.quitBrowser();


			//verify error message at counter
			serpointhht.invokeServicePointAllocationScreen();
			serpointhht.clickCounter();
			serpointhht.enterToken("TokenID");
			serpointhht.clickselectServicePointDropdown("Counter");
			serpointhht.callForward();
			//verify error message
			serpointhht.verifyErrorMessage("val~Token is already callforwarded");
			cust.clickBack("Service Point Allocation");	


			//verify error message at dock
			serpointhht.invokeServicePointAllocationScreen();
			serpointhht.enterToken("Invalidtoken");
			serpointhht.clickselectServicePointDropdown();
			serpointhht.callForward();
			//verify error message
			serpointhht.verifyErrorMessage("val~The selected Token/Declaration ID is already call forwarded/invalid");
			cust.clickBack("Service Point Allocation");
			libr.quitApp();
