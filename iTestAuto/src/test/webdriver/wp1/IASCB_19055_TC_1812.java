...
/**
 * 1812: TC_05_Verify expiry date validation CDG with pickup dropoff codes.
 *  
 * 
 **/


public class IASCB_19055_TC_1812 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			sstDP.clickProceed();
			sstDP.enterIDExpiryDate("past","16");
			sstDP.verifyIDExpiryErrorMessage();
			sstDP.clickBack("Enter your Details");
			sstDP.clickProceed();
			sstDP.enterIDExpiryDate("future","16");
			sstDP.enterDriverDetails();
