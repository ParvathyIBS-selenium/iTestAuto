...
/**
 * 
 *  1888 - TC_04_Verify for adding  the ULD which is already assigned to another flight
 *
 *
 */

public class IASCB_23278_TC_1888_AF extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/*** Verifying the error on adding a uld assigned to other flight**/

			sstDP.invokeDropOffPickUpShipmentsSSTScreen();
			sstDP.clickAddULD();
			sstDP.enterULDDetails("UldNum");
			cust.waitForSync(2);
			sstDP.verifyerrormessageWhileAddingUld("FullFlightNo","StartDate");

			/*** Verifying new uld which is not assigned to any of the flight can be added**/
			...
			sstDP.enterULDDetails("UldNum1");
			sstDP.verifyULD("UldNum1");
