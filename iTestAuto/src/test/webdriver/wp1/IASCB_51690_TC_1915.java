...
/**
 * 
 *  1915 - The status of the Token should be changed to Documentation is in progress on marking from create visit declaration screen
 *
 *
 */

public class IASCB_51690_TC_1915 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Verify token status
			String[] expValue1= {"Documentation in progress"};
