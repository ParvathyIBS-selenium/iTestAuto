...
@Test
public class IASCB_19104_TC_1860_AF extends BaseSetup
{
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			int[] verfCols={4};
			String[] actVerfValues ={cust.data("prop~CarrierNumericCode")+cust.data("AWBNo")+"001"}; 	
			OPR335.verifySUSequence(verfCols, actVerfValues,pmyKey);
			String[] actVerfValues2 ={cust.data("prop~CarrierNumericCode")+cust.data("AWBNo")+"002"}; 	
