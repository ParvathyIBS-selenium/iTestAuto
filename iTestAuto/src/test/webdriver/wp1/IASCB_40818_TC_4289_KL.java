...
public class IASCB_40818_TC_4289_KL extends BaseSetup
{
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cust.printAndVerifyReport("val~Consignment Security Declaration","OPR339",cust.data("val~SPX"),cust.data("ScreeningMethodPassCode"));
			cust.closeTab("OPR339", "Security & Screening");
			...
			cust.searchScreen("OPR339", "Security and Screening");
			OPR339.listAWBNo("AWBNo2", "CarrierNumericCode", "OPR339 - Security & Screening");
			OPR339.clickPrintForVerification();
			cust.printAndVerifyReport("val~Consignment Security Declaration","OPR339",cust.data("val~NSC"),cust.data("ScreeningMethodFailCode"));
			cust.closeTab("OPR339", "Security & Screening");
		}
		catch(Exception e)
		{
