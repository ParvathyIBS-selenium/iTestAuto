...
public class IASCB_57960_TC_1964_KL extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR341.selectSubModuleName("Reporting at Dock");
			...
			OPR341.verifyIrregularityDetailsValue(verfCols,actVerfValues,cust.data("AWBNo"));
			OPR341.verifyIrregularityDetailsValue(verfCols1,actVerfValues1,cust.data("AWBNo"));
			OPR341.verifyIrregularityDetailsValue(verfCols3,actVerfValues3,cust.data("AWBNo"));
			OPR341.Print();

			cust.printAndVerifyReport("val~List Irregularity","OPR341",
					cust.data("CarrierNumericCode"), cust.data("AWBNo"), cust.data("Iregularitycode"),
