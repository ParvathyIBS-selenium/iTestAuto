...
/**
 * 
 * TC_05_ Verify incoming XFWB is received with OCI line having invalid RA details and secure SCC (SPX or SHR)
 *
 *
 */

public class IASCB_87313_TC_4342 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String supplCustoms[]={"RegulatedAgent","screenmethod","UserName","SDtime","Expiry"};
			String source[]={"val~FWB","val~FWB","val~FWB","val~FWB","val~FWB"};
			String infoId[]={"val~ISS","val~ ","val~ ","val~ ","val~ "};
			String customsInfoId[]={"val~RA","val~SM","val~SN","val~SD","val~ED"};	
			...
			cust.searchScreen("OPR026", "Capture AWB");
			OPR026.listAWB("AWBNo", "CarrierNumericCode");
			OPR026.verifySecurityStatus("IN ERROR", "AWB Not Secure");
			cust.closeTab("OPR026", "Capture AWB");
			...
			//Verify Scc contain NSC
			String[] sccNSC = {"NSC"};
			OPR339.verifyScc(sccNSC);
			//Verify eCSD flag
			OPR339.verifyeCSDiconNotDisplayed();
