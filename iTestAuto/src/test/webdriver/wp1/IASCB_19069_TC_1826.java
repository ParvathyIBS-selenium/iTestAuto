...
/**
 *  1826 - TC_05_Verify enter your details section in  public side . without QDO
 *  
 * 
 *  
 **/
...
public class IASCB_19069_TC_1826 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cust.loginSSTWithDepartment(sst[0], sst[1],"Public","Export");
			...
			map.put("expText", "*");
			sstDP.verifyMandatoryFields("val~First Name","expText");
			sstDP.verifyMandatoryFields("val~Last Name","expText");
			sstDP.verifyFieldIsPresent("val~Date of Birth");
			sstDP.verifyMandatoryFields("val~ID Type", "expText");
			sstDP.verifyIDTypeValueNotDefaulted("val~--Select--");
			sstDP.verifyMandatoryFields("val~ID No.", "expText");
			sstDP.verifyMandatoryFields("val~ID Expiry Date", "expText");
			sstDP.verifyFieldIsPresent("val~Mobile No.");
			sstDP.verifyFieldIsPresent("val~Email ID");
			sstDP.verifyOptionalFields("val~Trucking Company Name");
			sstDP.verifyMandatoryFields("val~Vehicle No.", "expText");
			sstDP.verifyTrailerNoField();
			sstDP.verifyInfoBonded();
			sstDP.enterDriverDetailsWithScroll("StartDate");
			sstDP.enterTrailerNo();
			sstDP.clickProceed();
			sstDP.selectVehicletypeOption("val~Poussins (CDG)");
			sstDP.clickProceed();
			libr.waitForSync(2);
			...
			TGC013.clickList();
			TGC013.verifyDepartment(cust.data("val~ID Details"),cust.data("ID No"));
