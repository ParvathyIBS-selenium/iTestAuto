...
/** Manually release the Customs block for Build-up transaction block  **/
...
public class IASCB_52576_TC_4292_KL extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           String[] cgocxml = libr.getApplicationParams("cgocxml");
			...
			OPR344.verifyErrorMsg("val~Red or Orange CSN - Do not assign - Shipment is currently analyzed");
			cust.closeTab("OPR344", "Export Manifest");			
			
			/*****OPR023 - AWB Clearance *******/            
            //Manually Release Customs Block
            cust.searchScreen("OPR023", "AWB Clearance");
            OPR023.listAWB("CarrierNumericCode","AWBNo");
            int[] verfCols1={8};
            String[] actVerfValues1={"Blocked"};
            OPR023.verifyBlockDetails(verfCols1, actVerfValues1, cust.data("BlockType"));
            OPR023.selectCheckboxandReleaseBlock("BlockType","Remarks");          
            OPR023.verifyBlockReleased(cust.data("BlockType"),"AWBNo");
