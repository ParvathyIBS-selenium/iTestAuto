...
/**TC_02_Choosing columns to be displayed. - Unselect**/
...
public class IASCB_57969_TC_1969  extends BaseSetup
...

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String currentdate = cust.createDateFormatWithTimeZone("dd-MMM-YYYY", 0, "DAY", "");
			...
			/**verify column is not  displayed in service point overview screen when the respective column is not  selected in column choser**/

			cust.searchScreen("TGC015", "Servicepointoverview");
			libr.waitForSync(3);
			TGC015.selectWarehouse("servicetype");
			TGC015.removeColumnSelection("column");
			TGC015.listToken("currentdate");
			TGC015.verifyColumnDisplayed("Tokenid",false);
			libr.quitBrowser();
			...
			/**verify column is not  displayed in service point overview  after logout login**/
			cust.searchScreen("TGC015", "Servicepointoverview");
			libr.waitForSync(3);
			TGC015.selectWarehouse("servicetype");
			TGC015.listToken("currentdate");
