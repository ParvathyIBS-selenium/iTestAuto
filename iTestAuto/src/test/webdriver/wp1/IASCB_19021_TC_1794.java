...
/**
 *  1796 - TC_02_Check the display of tokens based on airside filter.
 **/


public class IASCB_19021_TC_1794 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			sstDP.clickProceed();
			libr.waitForSync(5);
			sstDP.verifyTokenGeneration("AirToken");
			...
			TGC010.enterToken("AirToken");
			TGC010.selectSource("KioskLocation");
			TGC010.clickList();
			TGC010.verifyTokenDisplayed("AirToken", true);
