package wp1;
/**TC_06_Capture multiple SCCs against single SU during breakdown.-Split shipment
 **/
...
public class IASCB_94244_TC_1983 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String pcs[] = {libr.data("Pieces3"),libr.data("Pieces2"),libr.data("Pieces2"),};
			OPR026.splitShipmentWithSCC(libr.data("splitSCC"), pcs);
...
//			bdhht.enterAWBValue("prop~FullAWB");
//			bdhht.selectAwb("FullAWBNo");
//			bdhht.verifySCC(libr.data("SCC").split(",")[1]);
//			bdhht.verifySCC(libr.data("SCC").split(",")[3] +" + 1");
//			bdhht.verifySCC(libr.data("SCC").split(",")[0]);
...
//
//
//			/***Verify the details in breakdown screen***/
//			driver = libr.relaunchBrowser("chrome");
//
//			driver.get(iCargo[0]);
//			Thread.sleep(2000);
...
//			String[] locDetails={cust.data("BDNlocation")+"("+cust.data("Pieces3")+"/"+cust.data("Weight3")+".0)"+","+"\n"+cust.data("BDNlocation")+"("+cust.data("Pieces2")+"/"+cust.data("Weight2")+".0),"+"\n"+cust.data("BDNlocation")+"("+cust.data("Pieces2")+"/"+cust.data("Weight2")+".0)"};
