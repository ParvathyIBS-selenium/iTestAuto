...
/**
 *  1823 - TC_02_Verify enter your details section in airside without QDO
 *  
 * 
 **/


public class IASCB_19069_TC_1823 extends BaseSetup {
	...
	//		cust.loginSST(sst[0], sst[1],"Bonded");
			...
			map.put("expText", "*");
			sstDP.verifyOptionalFields("val~First Name");
			sstDP.verifyOptionalFields("val~Last Name");
			...
			sstDP.enterDriverDetailsForBondedSide("StartDate", "Destination");
			sstDP.clickProceed();
