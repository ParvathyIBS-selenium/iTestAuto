...
//ULD Acceptance  must be performed shipment be a BUP(intact))
public class IASCB_19134_IASCB_23235_TC_1884 extends BaseSetup {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			sstDP.enterULDDetails("UldNum");
			sstDP.addShipmentInUld("CarrierNumericCode", "prop~AWBNo");
			sstDP.clickDone();
			sstDP.clickProceed();
			sstDP.enterDriverDetails("StartDate");
			sstDP.clickProceed();
			...
			cust.waitForSync(3);
			uldsighthht.verifyBUPErrorMessage();
			libr.quitApp();
			...
			gahht.enterUldAcceptanceDetailWithPieces("awbNumber","Pieces");
