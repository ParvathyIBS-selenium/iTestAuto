package wp10;
/**Verify Pallet filter in ULD Sighting application **/
...
public class IASCB_19393_TC_2796 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			uldsighthht.clickPallet();
			uldsighthht.clickDoneInFilter();
			uldsighthht.clickApply();
			//verifying PMC ulds displayed after applying filter
			uldsighthht.verifyContainerTypeUld("val~PMC");
			libr.quitApp();
