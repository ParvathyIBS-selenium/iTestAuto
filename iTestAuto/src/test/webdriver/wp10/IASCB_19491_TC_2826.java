...
/**
 * 
 * TC_02_Verify user is able to list based on flight number in Adhoc task creation android screen
 *
 *
 */

public class IASCB_19491_TC_2826 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR335.verifyAWBDetails("Pieces", "Weight", "Volume");
			//Creating ULD number
			String uldNo1=OPR335.create_uld_number("UldType1", "carrierCode");
			map.put("UldNum1", uldNo1);
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			libr.waitForSync(6);
			OPR335.uldShipmentDetails("Pieces","Weight", "Location", "UldNum1","Contour");
			OPR335.addULDDetails();
			OPR335.allPartsRecieved();
			OPR335.saveAcceptance();
			OPR335.verificationOfRFCStatus();
