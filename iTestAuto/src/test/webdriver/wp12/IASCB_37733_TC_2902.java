...
/** TC_01_Verify positive temperature sign during temperature capture **/



public class IASCB_37733_TC_2902 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String xfwbdate = cust.createDateFormat("yyyy-MM-dd", 0, "DAY", "");
			...
			OPR335.looseShipmentDetails("Location1", "Pieces", "Weight");
			...
			OPR310.listAWB("prop~CarrierNumericCode", "AWBNo");
			OPR310.selectCheckbox("FullAWBNo");
			OPR310.clickPerformActivityButton();
			//verifying unit value displayed
			OPR311.verifyUnitValue("°C");
			//verifying temperature dropdown values
			OPR311.verifyTemperatureDropDownValues();
			OPR311.selectTemperatureSign("val~+");
			OPR311.enterTemperatureValue("TemperatureValue");
			OPR311.clickSave();
			OPR311.clickCloseFromOPR311();
			//verifying updated temperature value
			String pmKey= cust.data("FullAWBNo");
			int verfCols [] = {17};
			String[] actVerfValues= { "+"+ cust.data("TemperatureValue")+"°C" };
			OPR310.verifyWorkDetails(verfCols, actVerfValues, pmKey);
