...
/** TC_05_Verify shipment is  blocked when workflow activity captured is not within limits. **/



public class IASCB_31549_TC_2746 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
		   ...
		   cust.createFlight("FullFlightNumber");
			...
			OPR344.verifyErrorcheck("val~Temparature Check Failed");
