...
/** Split shipment indicator across the ULD s for ULD & Bulk shipments **/

public class IASCB_9255_TC_2523 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Allocating the shipment to ULD
			...
			//Allocating the shipment to BULK
			ADD004.clickAllocate();
			...
			map.put("SplitPcs1", cust.data("SplitPieces1")+ " "+ "Pcs");
			map.put("SplitPcs2", cust.data("SplitPieces2")+ " "+ "Pcs");
			...
			expbuildup.selectTaskCreated("FlightNum","SplitPcs1");
			...
			expbuildup.enterAWBorULDDetails("AWBNum1");
			expbuildup.verifytaskCreated("FlightNum");
			expbuildup.selectTaskCreated("FlightNum","SplitPcs2");
			expbuildup.markTaskInProgress();
			//verifying split symbol in awb splitted in ULD2
			expbuildup.verifySplitIndicator("FullAWBNo");
			expbuildup.clickUldType("val~BLK");
