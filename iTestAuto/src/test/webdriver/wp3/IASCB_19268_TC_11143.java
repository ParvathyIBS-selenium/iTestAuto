...
/** TC_08_Verify Tall Rigid loadibility status of ULD when rigid ratio in built up volume equal to 50 percent and  contour height is above 244 cm_Copy_1***/


public class IASCB_19268_TC_11143 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Verify loadability status getting displayed as tall rigid in cafeed
			int[] col = {20};
