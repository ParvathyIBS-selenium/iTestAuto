...
@Test
public class IASCB_9195_TC_2518 extends BaseSetup
{
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
    		...
    		String STD=cust.timeCalculation(currtimeCDG, "dd-MMM-yyyy HH:mm","MINUTE",150);
	...
	//		gahht.selectHandlingAreaAndClickDone();
			...
			String[] Loc={cust.data("Location").split(",")[0],cust.data("Location").split(",")[1]};
			map.put("Location",Loc[0]);
			...
			map.put("SCC1", scc[0]);
			gahht.verifySCC("awbNumber1","SCC1"); 
			...
			map.put("Location",Loc[1]);
			gahht.enterValue("awbNumber");
			gahht.verifyStatedPiecesWeight("Pieces", "Weight");
			gahht.verifyFlightDetails("carrierCode", "prop~flightNo");
			map.put("SCC2", scc[1]);
			gahht.verifySCC("awbNumber2","SCC2"); 
