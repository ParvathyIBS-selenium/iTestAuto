package wp3;
/** Verify behaviour when open time is beyound the current station time for the flight  **/
...
public class IASCB_8802_TC_2056 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			WHS059.verifyEmptyCloseTime();
			WHS059.verifyEmptyOpenTime();
			...
			//verifying Opentime got saved
			WHS059.clickEditIcon();
			WHS059.enterFlightDetails("carrierCode","FlightNo","StartDate");
			WHS059.clickList();	
			WHS059.verifyOpenTimeSaved("currdate", "openTime");
