...
/**TC_08_Flight_shipment_group level instruction in tablet at origin for ULD & Bulk shipments.**/

public class IASCB_8810_TC_2083 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			expbuildup.verifygrouplevelinstrsuction("AWBNo1","group level instructions-uld");
			...
			expbuildup.verifyShipmentlevelinstrsuction("AWBNo1","shipmentlevelinstructions-uld");
			expbuildup.clickBack();
			expbuildup.verifygrouplevelinstrsuction("AWBNo2","group level instructions-bulk");
			expbuildup.selectTaskCreatedaftersearching("FlightNo");
			expbuildup.markTaskInProgress(); 
			cust.waitForSync(5);
			expbuildup.verifyflightlevelinstrsuction("FlightNo","flightlevelinstructions");
			expbuildup.verifyShipmentlevelinstrsuction("AWBNo2","shipmentlevelinstructions-bulk");
