...
/** Big Reference number must be captured.for OAL shipment **/

public class IASCB_35933_TC_2662_KL extends BaseSetup {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		/***  updating bigreference number- OPR335 -Goods Acceptance   **/
			
			cust.searchScreen("OPR335", "Goods Acceptance");
			cust.listAWB("AWBNo", "CarrierNumericCode", "Goods Acceptance");
			String BigreferenceNo1=cust.create_randomAlphaNumericcharacters("BIG",6);
			map.put("BigreferenceNo1", BigreferenceNo1);
			OPR335.enterBigReferenceNumber("BigreferenceNo1");
			OPR335.saveAcceptance();
			cust.closeTab("OPR335", "Goods Acceptance");
			
			
			/** Verifying updated bigreference value in OPR335 -Goods Acceptance***/
			
			cust.searchScreen("OPR335", "Goods Acceptance");
			cust.listAWB("AWBNo", "CarrierNumericCode", "Goods Acceptance");
			OPR335.verifyBigReferenceNumber("BigreferenceNo1");
			cust.closeTab("OPR335", "Goods Acceptance");
