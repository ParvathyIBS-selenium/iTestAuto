...
/**
 *  TC_02_Verify removal of satchel handover.
 *  
 * 
 */
...
public class IASCB_9360_TC_2570 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ConsigneeCountryName",
					WebFunctions.getPropertyValue(custproppath, "creditCustomercountryName_ES"));
