...
/** Verify FUM xFUM message triggers during ULD unassignment from exportbuild up apk.  **/

public class IASCB_100490_TC_2697 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
	       ...
	       libr.quitBrowser();
			...
			expbuildup.enterUldNumAndLoc("Location", "UldNum");
			expbuildup.clickBuildUpComplete();
			expbuildup.clickDoneAndVerifyShipmentAdded();		
			expbuildup.markCompleted();
			expbuildup.clickLoadedTab();
			expbuildup.UnassignULD("UldNum","val~Damaged");
			libr.quitApp();
			
				

			
			/** CHECKING XFUM TRIGGERED  **/
