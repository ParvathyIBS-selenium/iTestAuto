...
public class IASCB_8819_TC_2088_KL extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR029.listHAWB("AWBNo", "CarrierNumericCode");
		   ...
		   buhht.updateFlightDetailsWithOutPopUp("carrierCode", "prop~flightNo","nextDay");
			map.put("BuildupLoc", WebFunctions.getPropertyValue(toproppath, "BufferLocation_AMS"));
			...
			OPR344.verifyHAWBpresent("1 HAWB",cust.data("AWBNo"));
			OPR344.verifyPiecesWeight(cust.data("Pieces")+"/"+cust.data("Pieces")+" Pcs",cust.data("Weight")+" /"+cust.data("Weight")+" kg",cust.data("AWBNo"));
