...
/** TC_12_Verify FUM xFUM message triggers during build-up of INTACT ULD from scanner.  **/

public class IASCB_100490_TC_2706_AF extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/** Verifying flight number and  Carrier Code is present**/
			
			msgContentsPresent.add("val~<UsedLogisticsTransportMeans>"+"\n"+"<ID>"+cust.data("prop~flight_code")+"</ID>"+"\n"+"</UsedLogisticsTransportMeans>");
			msgContentsPresent.add("val~<MainCarriageLogisticsTransportMovement>"+"\n"+"<ID>"+cust.data("FlightNo")+"</ID>");
