package wp7;
/** TC_07_Verify that departed flights are not displayed based on filter **/
...
public class IASCB_19222_TC_2732_KL extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String endDate = cust.createDateFormat("dd-MMM-YYYY", 1, "DAY", "");
			map.put("EndDate", endDate);
			map.put("SSMStartDate", cust.createDateFormat("ddMMM", 0, "DAY", ""));
			map.put("SSMEndDate", cust.createDateFormat("ddMMM",5, "DAY", ""));
			...
			ADD007.EnterFlightDetailsWithTime("carrierCode", "FlightNo", "StartDate", "EndDate");
			ADD007.verifyExcludeDepartedFlightCheckbox();
			ADD007.clickContinuousCheckbox();
			ADD007.verifyContinousChkBoxChkd();
			ADD007.clickList();
			ADD007.verifyFlightDatesArePresent("Day",2);
			...
			ADD007.clickEditIcon();
			ADD007.clickClear();
			ADD007.EnterFlightDetailsWithTime("carrierCode", "FlightNo", "StartDate", "EndDate");
			ADD007.clickExcludeDepartedFlightCheckbox();
			ADD007.clickList();
			ADD007.verifyFlightNotPresent("StartDate");
			cust.closeTab("ADD007", "Export Planning Progress");
