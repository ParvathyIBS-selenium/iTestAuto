...
public class IASCB_19222_TC_2732 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String endDate = cust.createDateFormat("dd-MMM-YYYY", 3, "DAY", "");
			...
			ADD007.EnterFlightDetailsWithTime("carrierCode", "FlightNo", "StartDate", "nextDate");
