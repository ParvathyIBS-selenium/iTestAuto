...
/***** changes in import planning progress screen*****/

public class IASCB_19229_TC_2930 extends BaseSetup {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/**Import planning progress**/
			cust.searchScreen("ADD008", "ImportPlanningProgress");
			ADD008.EnterFlightDetails("carrierCode","prop~flightNo","StartDate","EndDate");
			ADD008.clickArrow();
			ADD008.selectPlanStatus("Pending");
			ADD008.clickList();
			ADD008.verifyPlanStatus("val~Pending");
			cust.closeTab("ADD008","importPlanningProgress");
           ...
           /**XFFM Message Loading **/
			...
			/** relist Import planning progress**/
			cust.searchScreen("ADD008", "ImportPlanningProgress");
			ADD008.EnterFlightDetails("carrierCode","prop~flightNo","StartDate","EndDate");
			ADD008.clickArrow();
			ADD008.selectPlanStatus("In-Progress");
			ADD008.clickList();
			ADD008.verifyPlanStatus("val~In-Progress");
			cust.closeTab("ADD008","importPlanningProgress");
			...
			ADD008.EnterFlightDetails("carrierCode","prop~flightNo","StartDate","EndDate");
			ADD008.clickArrow();
			ADD008.selectPlanStatus("Completed");
			ADD008.clickList();
			ADD008.verifyPlanStatus("val~Completed");
			cust.closeTab("ADD008","importPlanningProgress");
