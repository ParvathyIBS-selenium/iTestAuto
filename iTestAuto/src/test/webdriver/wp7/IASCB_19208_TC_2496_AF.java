...
/**
 *  Verify the provision to view accepted pieces information in Export shipment listing
 */


public class IASCB_19208_TC_2496_AF extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//verifying Accepted pcs/wgt/vol of the shipment 

			int verfCols [] = {16};
			String[] actVerfValues = { cust.data("Pieces")+" / "+cust.data("Weight")+" / "+cust.data("Volume") };
