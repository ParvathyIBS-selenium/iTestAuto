...
/** Charge code logic when AWB is created from OPR026 with PP payment type with credit customer **/
...
public class IASCB_77028_TC_2786 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR026.listAWB("AWBNo", "CarrierNumericCode");
			OPR026.asIsExecute();
			//Verifying ChargeCode as PX after Execution
			OPR026.clickChargesAcc();
			...
			/**Check whether Outgoing XFWB has PX**/
			msgContents.add("val~<TransportPaymentMethodCode>" + cust.data("ChargeCode") +"</TransportPaymentMethodCode>");
			...
			/**Verify XFWB message is triggered to Pelican */
