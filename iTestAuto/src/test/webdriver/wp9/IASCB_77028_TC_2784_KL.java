...
/**
 * 
 * TC_05_ Charge code logic when incoming xFWB have payment type as PP , charge
 * code other than PP or PX and FOP is credit
 *
 *
 */

public class IASCB_77028_TC_2784_KL extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR026.listAWB("AWBNo", "CarrierNumericCode");
			OPR026.clickChargesAcc();
			OPR026.verifyChargeCode("val~PX");
			cust.closeTab("OPR026", "Capture AWB");
			...
			/** Payment method **/
			msgContents.add("val~<TransportPaymentMethodCode>" + cust.data("val~PX") + "</TransportPaymentMethodCode>");
