...
/**
 * 
 *  TC_06_ Charge code logic when  incoming xFWB have  payment type as CC , charge code other than PP or PX and FOP is credit
 *
 *
 */

public class IASCB_77028_TC_2785_AF extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Change Payment type from PP to CC
			cust.modifyMessageMap("<TransportPaymentMethodCode>PP</TransportPaymentMethodCode>","<TransportPaymentMethodCode>"+cust.data("PaymentType")+"</TransportPaymentMethodCode>");
			...
			OPR026.selectChargeCode("ChargeCode");
			OPR026.saveAWB();
