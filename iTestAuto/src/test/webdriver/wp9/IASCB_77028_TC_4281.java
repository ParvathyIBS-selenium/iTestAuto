...
/**
 * 
 *   TC_09_Charge code logic when AWB is created from OPR026 wth PP payment type with cash customer
 *
 *
 */

public class IASCB_77028_TC_4281 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ShipperCountrySubDiv",
					WebFunctions.getPropertyValue(custproppath, "cashCustomercountrySubdivision_FR1"));
