...
writeExtent("Pass", "Selected Storage Position as "+data("storagePOS")+" in Goods Acceptance hht screen");
	...
	/**@author A-10328
	* Description - Click Pending button
	* @throws IOException
	*/
	public void  clickPendingStatus() throws IOException

	{

	clickActionInHHT("gahht_btn_pending;xpath",proppathhht,"Pending",screenName);
	waitForSync(5);
	}
	...
	/**
	 ...
	 public void clickSaveCaptureChecksheet() throws InterruptedException, IOException
	  ...
	  /**
		 ...
		 */
		public void enterUldAcceptanceDetail(String awb)
		{
			try
			{
				...
				waitForSync(2);
				checkAllPartsReceivedForUldAcceptance();
				waitForSync(2);
...
/**
	 ...
	 * Description : Enter ULD acceptance details
	 */
	public void enterUldAcceptanceDetail(String awb,String pcs)
	{
		try
		{
			...
			enterValueInHHT("gahht_inbx_awbNumber;accessibilityId",proppathhht,data(awb),"Awb No",screenName);
			waitForSync(2);
			//entering of pieces and weight to be added
			clickActionInHHT("gahht_btn_Add;xpath",proppathhht,"Add New AWB",screenName);
