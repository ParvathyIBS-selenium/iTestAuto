	...
	public void compareAndAddtheMissingSplitInfo() {
		...
		try {
			...
			if (Expsccs.contains("BUP")) {
				...
				waitForSync(3);
				keyPress("TAB");
				enterValueInTextbox(sheetName, "inbx_ULDweight;xpath", data("val~100"), "Weight", screenName);
...
/**
	...
	public void uldShipmentDetails(String Pieces, String Weight, String Location, String ULDNumber, String Contour)
		...
		waitForSync(3);
		enterValueInTextbox(sheetName, "inbx_ULDweight;xpath", data(Weight), "Weight", screenName);
		waitForSync(3);
		keyPress("TAB");
		clickULDWarningPopUp();
		waitForSync(1);
