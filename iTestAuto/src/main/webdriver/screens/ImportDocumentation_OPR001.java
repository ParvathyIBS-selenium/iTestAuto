 ...
 */
	...
	public void updateClearingAgentDetails(String ConsigneeCode) throws Exception 
	{
		...
		clickWebElement(sheetName, "btn_clearingAgentSavedetails;id", "Save Button", screenName);
	 ...
	 try
		{
			...
			String dynXpath="("+xpath+")["+rowCount+"]//td[26]//img"+"|"+"("+xpath+")["+rowCount+"]//td[27]//img"+"|"+"("+xpath+")["+rowCount+"]//td[28]//img";
