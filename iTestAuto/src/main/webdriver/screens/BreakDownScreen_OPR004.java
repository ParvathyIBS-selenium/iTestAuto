...
public void verifySUNumberDisplayed(String awbNo) throws InterruptedException, AWTException, IOException {
	...
	/**
	 * @Description : Enter breakdown location in popup
	 * @author A-9844
	 * @throws Exception
	 */
	public void enterBreakdownLocationInPopup(String Station) throws Exception {
		...
		case "AMS":
			 location= getPropertyValue(toproppath, "Breakdown_Location_AMS");
			 
		case "IAD":
			 location= getPropertyValue(toproppath, "Location_IAD");	
		...
		enterValueInTextboxByJS(sheetName,"inbx_Location;name",location , "breakdown location", screenName);
