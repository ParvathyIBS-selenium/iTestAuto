...
/**
 * Capture physical delivery of Intact unit
 **/
public class PhysicalDelivery_IAD1_002 extends BaseSetup {
	...
	@DataProvider(name = "PhysicalDelivery_IAD1_002")
	...
	@Test(dataProvider = "PhysicalDelivery_IAD1_002")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR293.generateDeliveryIDWithOthercharges("val~CD","Remarks","CREDIT",true,true);		
