...
public class PhysicalDelivery_1719 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("OriginAirport", WebFunctions.getPropertyValue(custproppath, "IAH"));
	       ...
	       //Relaunch browser
			...
			cust.printAndVerifyReport("val~DELIVERY SLIP", "OPR038",cust.data("Origin"),cust.data("FullAWBNo"),cust.data("Pieces")+"/"+cust.data("Weight"),cust.data("SCC"),cust.data("ShipmentDesc"),cust.data("ClearingAgent"),cust.data("Destination"),cust.data("Pieces"),cust.data("Weight2"),cust.data("ConsigneeName"),DNdetails);
