...
/**
 * Capture delivery of shipments blocked for customs
 **/
public class PhysicalDelivery_IAD3_001 extends BaseSetup {
	...
	@DataProvider(name = "PhysicalDelivery_IAD3_001")
	...
	@Test(dataProvider = "PhysicalDelivery_IAD3_001")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ConsigneeCode", WebFunctions.getPropertyValue(custproppath, "credit_CustomerId_BF"));
			map.put("ConsigneeName", WebFunctions.getPropertyValue(custproppath, "credit_CustomerName_BF"));
			map.put("ConsigneePostCode", WebFunctions.getPropertyValue(custproppath, "credit_postCode_BF"));
			map.put("ConsigneeStreetName", WebFunctions.getPropertyValue(custproppath, "credit_streetName_BF"));
			map.put("ConsigneeCityName", WebFunctions.getPropertyValue(custproppath, "credit_cityName_BF"));
			map.put("ConsigneeCountryId", WebFunctions.getPropertyValue(custproppath, "credit_countryId_BF"));
			map.put("ConsigneeCountryName", WebFunctions.getPropertyValue(custproppath, "credit_countryName_BF"));
			map.put("ConsigneeCountrySubDiv", WebFunctions.getPropertyValue(custproppath, "credit_countrySubdivision_BF"));
			map.put("ConsigneePhoneNo", WebFunctions.getPropertyValue(custproppath, "credit_telephoneNo_BF"));
			map.put("ConsigneeEmail", WebFunctions.getPropertyValue(custproppath, "credit_email_BF"));
			...
			map.put("DestinationAirport", WebFunctions.getPropertyValue(custproppath, "OUA"));
			...
			/*** MESSAGE - loading XFBL and XFWB needs to be load from CGOCXML ****/
			...
			String shipment1[]={libr.data("FullAWBNo")+";"+libr.data("Pieces")+";"+libr.data("Weight")+";"+libr.data("Volume")+";"+libr.data("ShipmentDesc")};
			...
			// Login to "CGOCXML" and load XCSN message
			//Create XCSN message
			...
			OPR293.generateDeliveryID3("Remarks", "CREDIT");
            ...
            OPR064.clickSave("val~Shipment delivery blocked due to Customs");
