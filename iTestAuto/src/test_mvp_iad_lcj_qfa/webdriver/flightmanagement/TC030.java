...
/**'Verify the user is able to add new leg HAM-BRU in existing Flight SVO-HAM using SSM**/
public class TC030 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws InterruptedException {
		...
		try {
			...
			customfunctions.searchScreen("FLT005", "Maintain Flight Schedule");
			...
			customfunctions.searchScreen("MSG005", "List Messages");
			...
			/** MSG005 -SSM RPL Message loading **/
			...
			MSG005.loadFromFile("All", "ALL", "JMS", "", "Origin", "", "SSM_RPL");
			...
			MSG005.clickList();
			libr.waitForSync(3);
			map.put("pmkey", "RPL"+" - "+customfunctions.data("CarrierCode")+" - "+customfunctions.data("FlightNo")+" - "+customfunctions.data("SSMStartDate").toUpperCase()
					+" - "+customfunctions.data("SSMEndDate").toUpperCase()+" - "+"1234567");
			MSG005.clickCheckBox("pmkey");
			MSG005.clickprocess();
			customfunctions.closeTab("MSG005", "List Message");
			...
			//verify leg1
			String pmKey1 = customfunctions.data("Leg1");
			int verfCols1 [] = { 4,6,8};
			if(customfunctions.checkDSTExists(startDate,"Europe/Berlin"))
			{
				String[] actVerfValues1 = { customfunctions.data("DepartureTime"),customfunctions.data("ArrivalTime"),customfunctions.data("AircraftType") };
				FLT005.verifyLegDetails( verfCols1, actVerfValues1,pmKey1);
			}

			else
			{
				String[] actVerfValues1 = { customfunctions.data("DepartureTime"),customfunctions.data("ArrivalTime_WithoutDST"),customfunctions.data("AircraftType") };
				FLT005.verifyLegDetails( verfCols1, actVerfValues1,pmKey1);
			}
			
			//verify leg2
			String pmKey2 = customfunctions.data("Leg2");
			int verfCols2 [] = { 4,6,8};
			if(customfunctions.checkDSTExists(startDate,"Europe/Berlin"))
			{
				String[] actVerfValues2 = { customfunctions.data("DepartureTime2"),customfunctions.data("ArrivalTime2"),customfunctions.data("AircraftType") };
				FLT005.verifyLegDetails( verfCols2, actVerfValues2,pmKey2);
			}

			else
			{
				String[] actVerfValues2 = { customfunctions.data("DepartureTime2_WithoutDST"),customfunctions.data("ArrivalTime2_WithoutDST"),customfunctions.data("AircraftType") };
				FLT005.verifyLegDetails( verfCols2, actVerfValues2,pmKey2);
			}
			customfunctions.closeTab("FLT005", "FLT005 - Maintain Flight Schedule");
			...
			customfunctions.searchScreen("FLT004", "List Flight Schedule");
