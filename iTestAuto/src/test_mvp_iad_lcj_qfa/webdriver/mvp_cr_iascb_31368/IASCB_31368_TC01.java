...
/**Damage Code verification for Unknown or Other damage category to create Auto Block set up**/

// Enable Security data reviewed Check box not checked
//used BRK damge code instead of OTH as it is not configured

public class IASCB_31368_TC01 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
	        ...
	        int[] cols1={4};
	        String[] values1={"Damage code : "+cust.data("DmgCode")};
