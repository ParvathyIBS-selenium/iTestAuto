...
/**Verify Auto Block Should n't Released for Damage Discrepancy AWB when screening save is marked as Passed twice for Partial Pieces**/


public class IASCB_31368_TC14 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
            ...
            /*****OPR023 - AWB Clearance *******/            
            //Verify that block is not released
            cust.searchScreen("OPR023", "AWB Clearance");
            OPR023.listAWB("prop~CarrierNumericCode","prop~AWBNo");
            OPR023.verifyBlock(cust.data("BlockType"),cust.data("FullAWBNo"));
            OPR023.verifySCCs("val~NSC");
            OPR023.closeTab("OPR023", "AWB Clearance");
