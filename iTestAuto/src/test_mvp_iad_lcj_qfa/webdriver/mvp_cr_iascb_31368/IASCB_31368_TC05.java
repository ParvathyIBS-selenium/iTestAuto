...
/**Verify Auto Block should be created for Damage Discrepancy Shipment which contains multiple Damage Code if any one of the Code is matched with Auto Block Set up Configuration**/

// Enable Security data reviewed Check box not checked

public class IASCB_31368_TC05 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//add damage details
			String[] DmgCode={cust.data("DmgCode").split(",")[0],cust.data("DmgCode").split(",")[1]};
			String[] Pieces={cust.data("Pieces2").split(",")[0],cust.data("Pieces2").split(",")[1]};
			String[] DamageDetails={cust.data("DamageDetails"),cust.data("DamageDetails")};
