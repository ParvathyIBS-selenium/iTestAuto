...
public class SST03 extends BaseSetup {
	...
	public TokenShipmentListingHHT TSLHHT;
	...
	public void setup() {
		...
		TSLHHT=new TokenShipmentListingHHT(driver, excelreadwrite, xls_Read);
	}
	...
	public void getTestSuite(Map<Object, Object> map) throws InterruptedException {
		...
		try {
			...
			map.put("TokenId", "0107");
			
			//Rules Mising for auto navigation to Acceptance Screen
			
			/** Token Shipment Listing HHT **/
			TSLHHT.invokeTokenShipmentListingScreen();
			TSLHHT.enterToken("TokenId");
			map.put("awbNumber", customfunctions.data("prop~stationCode")+customfunctions.data("prop~AWBNo"));
			TSLHHT.enterAwbNumber("awbNumber");
