...
/**
 * Test Case Name : Auto-populate SCI field based on EU region
 * TC_01_SCI field should be shown as  select  by default from drop down for user from
 *  Capture AWB Screen OPR026 for EU ports
 **/

public class IASCB_93262_TC01 extends BaseSetup {
	...
	@DataProvider(name = "IASCB_93262_TC01")
	...
	@Test(dataProvider = "IASCB_93262_TC01")
