 ...
 *TC_09_SCI details should not be validate which is received through XFWB message for Non EU Ports
 *
 **/

public class IASCB_93262_TC09 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("SCIUpdated", "T1");
			OPR026.selectSCI("SCIUpdated");
