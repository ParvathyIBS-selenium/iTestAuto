 ...
 * TC_03 SCI field should be auto populated as  Select  in Capture AWB Screen OPR026,if the 
 *  Special Customs Information(SCI) 
 * details are not received through XFWB message for EU Ports
 **/

public class IASCB_93262_TC03 extends BaseSetup {
	...
	@DataProvider(name = "IASCB_93262_TC03")
	...
	@Test(dataProvider = "IASCB_93262_TC03")
