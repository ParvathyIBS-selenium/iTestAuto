...
public class FoundShipment_698 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
		    ...
		    excelRead.writeDataInExcel(map, path1, sheetName, testName);
			OPR367.addNewULDInfo("UldNum1", "prop~CarrierNumericCode", "prop~AWBNo", "Pieces", "Weight", "Origin", "Destination", "Pieces", "Weight",2);
			OPR367.SaveDetails();
			map.put("pmyKey", cust.data("UldNum1"));
			OPR367.clickCheckBox("pmyKey");
			...
			map.put("FSN",fsn);
			OPR037.capturePiecesAndWeight("Pieces", "Weight");
			OPR037.captureRemarks("val~found shipment", "val~found shipment");
			OPR037.clickAddLoc();
			OPR037.captureLocationDetails("Pieces", "Weight","BreakdownLoc");
			OPR037.save("OPR037");
