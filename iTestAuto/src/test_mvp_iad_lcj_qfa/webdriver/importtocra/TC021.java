...
/**
 * Verifying the High/Low value of the AWB 
 **/
...
public class TC021 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws InterruptedException {
		...
		try {
			...
			map.put("Currency", WebFunctions.getPropertyValue(custproppath, "agent_2_currency"));
			...
			CRA193.List();
			int verfCols[] = { 18 };
			String actVerfValues[] = {"High/Low value AWB"};
			CRA193.verifyExceptionRemarks("val~HIGHLOWVALAWB",verfCols,actVerfValues);
			...
			CRA212.captureAWB("prop~CarrierNumericCode", "prop~AWBNo");
			CRA212.listDetails();
			CRA212.verifyErrorMessages("High/Low value AWB");
			CRA212.updateMarketRate(customfunctions.data("IATARate"));
			CRA212.enterRemarks("High/Low value AWB issue resolved");
			CRA212.clickSave();
			customfunctions.closeTab("CRA212", "Rate Audit Detailed");
			...
			CRA193.enterAWB("prop~CarrierNumericCode", "prop~AWBNo");
			CRA193.List();
			CRA193.checkIfExceptionResolved("CRA193-List Rate Audit Exceptions",false,4, "HIGHLOWVALAWB","No Data Found");
			customfunctions.closeTab("CRA193", "List Rate Audit Exceptions");
