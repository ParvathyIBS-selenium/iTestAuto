...
/**
 * Test case name : Verify that flight finalization is the 2nd trigger point of sending AWB details to CRA.. 
 * **/
...
public class TC002 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws InterruptedException {
		...
		try {
			...
			customfunctions.searchScreen("MSG005", "MSG005 - List Messages");
			MSG005.loadFromFile("All", "ALL", "JMS", "", "Origin", "", "FFM_1LOOSE");
			customfunctions.closeTab("MSG005", "MSG005 - List Messages");
			...
			customfunctions.searchScreen("MSG005", "MSG005 - List Messages");
			customfunctions.createTextMessage("MessageExcelAndSheetMVTATD", "MessageParamMVTATD");
			...
			MSG005.clickList();
			libr.waitForSync(6);
			map.put("pmkey", customfunctions.data("carrierCode")+" - "+customfunctions.data("FlightNo")+" - "+customfunctions.data("Day")+" - "+customfunctions.data("Origin"));
			MSG005.clickCheckBox("pmkey");
			MSG005.clickprocess();
			customfunctions.closeTab("MSG005", "List Message");
			
			//verify flight finalized
			...
			//verifying flight departure date and time
			customfunctions.searchScreen("FLT006", "Mark Flight Movements");
            FLT006.listFlight("carrierCode","FlightNo", "StartDate");
            FLT006.verifyFlightMovementDepartureDetails(customfunctions.data("ATD_Local2"),customfunctions.data("StartDate"));
            customfunctions.closeTab("FLT006", "Mark Flight Movements");
