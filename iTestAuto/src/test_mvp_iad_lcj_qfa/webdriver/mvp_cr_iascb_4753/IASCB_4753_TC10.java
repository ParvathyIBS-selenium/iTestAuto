...
/**
 * Verify Print Delivery POD is triggered to Patriach System from iCargo Android device
 */

//Capture signature in the delivery HHT screen
public class IASCB_4753_TC10 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/***MESSAGE - Creating and loading XFBL  **/
			...
			/***MESSAGE - Creating and loading XFWB **/
			
			cust.createXMLMessage("MessageExcelAndSheetXFWB", "MessageParamXFWB");
			Cgocxml.sendMessageCgoCXML("ICARGO");


			/*** MESSAGE - creating and loading XFFM ****/
			...
			/*** MESSAGE - creating and loading MVT messages ****/
			...
			deliveryhht.clickNext();
			checksheetHHT.clickChecksheetTemplate("DLV144");
			checksheetHHT.captureChecksheet();
			checksheetHHT.clickSave();
