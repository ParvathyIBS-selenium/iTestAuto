...
/** 
Verify AWB level check sheet is triggered to Patriach System from iCargo for Dangerous Shipment  for (X)FWB Processed AWB from Capture AWB Screen
 **/



public class IASCB_4753_TC04 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Verify scc templates
			String[] templates={"IAD DGR OPR026","AWB 144"};
			OPR026.verifyCheckSheetTemplate(templates);
