...
/** 
 * Verify AWB level check sheet is triggered to Patriach System from iCargo for Special Shipment AWB while Capturing Goods Acceptance
 **/



public class IASCB_4753_TC05 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			MandatoryComponents.add(cust.data("val~GEN"));
			...
			OPR335.save("OPR335");
			OPR335.verifyChecksheetAlertAndAccept("1. Acceptance check sheet not complete");
			OPR335.captureChecksheetWithMultiFormat(true);
			OPR335.verifyAcceptanceFinalized("finalised",true);
