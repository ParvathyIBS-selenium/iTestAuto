package mvp_reg_delivery_sanity;
...
/**
 *Delivery of loose shipments to the same customer without additionnal charges
**/
public class DeliveryDocumentation_IAD1_001 extends BaseSetup {
	...
	public void setup() {
		...
		cafeedscreen=new Cafeed(driver, excelreadwrite, xls_Read);
