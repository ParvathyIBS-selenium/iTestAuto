...
/**Data capture of paper AWB for an account customer for local export of loose shipment which consignee is in China**/

public class AWBDCCDG6_009 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ConsigneeCode", cust.getPropertyValue(custproppath, "customerId_CN"));
