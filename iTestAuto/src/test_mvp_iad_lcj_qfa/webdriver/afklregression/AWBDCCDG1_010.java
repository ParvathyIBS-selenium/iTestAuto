...
/**
 * 
 * Data capture of AWB for an account customer for local export of ULD shipment which consignee is not in China
 *
 */

public class AWBDCCDG1_010 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ConsigneeName", cust.getPropertyValue(custproppath, "creditCustomerName_DE"));
			map.put("ConsigneePostCode", cust.getPropertyValue(custproppath, "creditCustomerpostCode_DE"));
			map.put("ConsigneeStreetName", cust.getPropertyValue(custproppath, "creditCustomerstreetName_DE"));
			map.put("ConsigneeCityName", cust.getPropertyValue(custproppath, "creditCustomercityName_DE"));
			map.put("ConsigneeCountryId", cust.getPropertyValue(custproppath, "creditCustomercountryId_DE"));
			map.put("ConsigneeCountryName", cust.getPropertyValue(custproppath, "creditCustomercountryName_DE"));
			map.put("ConsigneeCountrySubDiv", cust.getPropertyValue(custproppath, "creditCustomercountrySubdivision_DE"));
			map.put("ConsigneePhoneNo", cust.getPropertyValue(custproppath, "creditCustomertelephoneNo_DE"));
			map.put("ConsigneeEmail", cust.getPropertyValue(custproppath, "creditCustomeremail_DE"));
			...
			String[] ULDNum={cust.data("UldNum")};
			String[] ULDWeight={cust.data("Weight")};
			String[] SlacPieces={cust.data("Pieces")};
			OPR026.enterRatingULDDetails(1, 1,ULDNum, ULDWeight);
			OPR026.asIsExecute();	
			...
			msgContents.add("val~<IncludedMasterConsignmentItem>"+"\n"+"<SequenceNumeric>1</SequenceNumeric>"+
					...
					"\n"+"<PackageQuantity>"+cust.data("Pieces")+"</PackageQuantity>"+
			...
			/** Pelican EML is Scripting is Pending **/
