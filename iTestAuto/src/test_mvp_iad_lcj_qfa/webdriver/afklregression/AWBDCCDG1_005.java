...
/**
 * 
 * Data capture of AWB for a cash customer registered in VC Client for local export of loose shipment 
 * which consignee is not in China
 *
 */

public class AWBDCCDG1_005 extends BaseSetup {
