...
/**
 * 
 * Verify in Capture AWB that information are correctly filled for AWB which destination is China, with an account customer. Origin station is using Pélican & iCargo (example : IAD)
 * Verify that system throw appropriate alert if some information are missing or/and incorrect.
 *
 */

public class AWBDCCDG1_011 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("DestinationAirport", cust.getPropertyValue(custproppath, "CAN"));
