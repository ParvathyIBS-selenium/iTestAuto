...
//Data capture of paper CNSL AWB for an account customer for local export of loose shipment which consignee is not in China
public class AWBDCCDG7_009 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ConsigneeCode", cust.getPropertyValue(custproppath, "creditCustomerId_DE"));
