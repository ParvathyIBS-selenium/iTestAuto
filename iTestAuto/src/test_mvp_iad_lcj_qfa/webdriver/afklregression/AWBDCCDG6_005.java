...
public class AWBDCCDG6_005 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ConsigneePhoneNo", cust.getPropertyValue(custproppath, "vcc_cashCustomeremail_NL"));
			...
			map.put("DestinationAirport", cust.getPropertyValue(custproppath, "PVG"));
			...
			//Verify Name, IATA Code, CASS code is populated in Agent details tab
			OPR026.verifyValueIsDisplayedInAgentTab();
