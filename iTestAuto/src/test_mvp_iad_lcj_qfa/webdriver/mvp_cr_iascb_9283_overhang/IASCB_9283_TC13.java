...
/**Select ULD/Overhang Category for the Pallet ULD from Capture Overhang/Indent details screen**/
public class IASCB_9283_TC13 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			buhht.clickMoreOptions();
			buhht.clickCaptureOverhangIndent();
			//verification of Overhang category
			buhht.verifyOverhangCategory();
			buhht.clickMoreOptions();
			buhht.clickCaptureOverhangIndent();
			//selecting uld category
			buhht.selectUldCategory(cust.data("uldCategory"));
			buhht.clickMoreOptions();
