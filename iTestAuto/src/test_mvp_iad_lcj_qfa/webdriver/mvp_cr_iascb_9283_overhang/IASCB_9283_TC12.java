...
/** 
 * Assign the Lying list shipment into ULD and Capture the Overhang Intend details from Build up Screen
 */
public class IASCB_9283_TC12 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Checking AWB is fresh or Not--AWB 
			...
			buhht.clickSaveCaptureChecksheet();
			buhht.enterShipmentDetails("Pieces", "Weight");
			buhht.clickYesOnBookingConfirmationInAnotherFlight();
			buhht.verifyBuildUpDetailsIfSaved();
			...
			OPR063.verifyULDLoadingInstuctorPopUp("prop~flightNo2", "UldNum","Contour","Front","Rear","Left","Right");
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyXFFM=cust.data("prop~flight_code")+" - "+cust.data("prop~flightNo2")+" - "+cust.data("Day")+" - "+cust.data("Month").toUpperCase()
					+" - "+cust.data("Origin");
