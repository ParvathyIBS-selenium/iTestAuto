...
public class IASCB_9283_TC03 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			System.out.println("awbno is"+ cust.data("awbNumber1"));
			...
			System.out.println("awbno is"+ cust.data("awbNumber2"));
			...
			String pmkey = Excel.getCellValue(path1,sheetName, "IASCB_9283_TC03", "UldNum");
			//move to uld checkbox
			String xpart1 = xls_Read.getCellValue("Generic_Elements",
					"table_selectEle;xpath") + pmkey +"')]";
			String xpart2 = xls_Read.getCellValue("ImportManifest_OPR367", "chk_selectShipment;xpath");
			String xpath = xpart1 + xpart2;
			libr.moveScrollBar(driver.findElement(By.xpath(xpath)));
