...
/**Capture Overhang/Indent details for Pallet with Multiple Shipments**/
public class IASCB_9283_TC02 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String shipment[]={libr.data("prop~FullAWBNo2")+";"+libr.data("Pieces")+";"+libr.data("Weight")+";"+libr.data("Volume")+";"+libr.data("ShipmentDesc")
			,libr.data("prop~FullAWBNo")+";"+libr.data("Pieces1")+";"+libr.data("Weight1")+";"+libr.data("Volume1")+";"+libr.data("ShipmentDesc")};
