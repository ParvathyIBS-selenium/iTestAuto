...
/** 
 * Update Pieces up details from the Loading Instruction screen for Overhang Indent details
 */
public class IASCB_9283_TC10 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			buhht.clickMoreOptions();
			buhht.clickCaptureOverhangIndent();
			buhht.capturePiecesUpDetails("PiecesFront","PiecesRear","PiecesLeft","PiecesRight");
			buhht.clickMoreOptions();
			...
			OPR063.selectULD(cust.data("UldNum"));
			OPR063.clickULDLoadingInstuctor();
			OPR063.capturePiecesUpDetails("val~10","val~12","val~15","val~18");
			OPR063.ULDLoadingInstructionOK();
			OPR063.clickSave();
			OPR063.selectULD(cust.data("UldNum"));
			OPR063.clickULDLoadingInstuctor();
			OPR063.verifyPiecesUpDetails("val~10","val~12","val~15","val~18");
			OPR063.ULDLoadingInstructionOK();
