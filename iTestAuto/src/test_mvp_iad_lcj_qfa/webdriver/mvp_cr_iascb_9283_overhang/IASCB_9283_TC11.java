...
/*Test case : Update the Overhang/Indent details of the ULD which is marked as Top up from Build up Screen*/

public class IASCB_9283_TC11 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Checking AWB is fresh or Not--AWB3
			...
			cust.setPropertyValue("FullAWBNo", cust.data("CarrierNumericCode")+"-"+cust.data("prop~AWBNo3"), proppath);
			...
			/***** OPR026 - Execute AWB****/
			cust.searchScreen("OPR026","Capture AWB");
			OPR026.listAWB("prop~AWBNo3", "CarrierNumericCode");
			...
			String pmKeyXFWB2=cust.data("prop~CarrierNumericCode")+" - "+cust.data("prop~AWBNo2")+" - "+cust.data("Origin")+" - "+cust.data("Destination");
			String pmKeyXFWB3=cust.data("prop~CarrierNumericCode")+" - "+cust.data("prop~AWBNo3")+" - "+cust.data("Origin")+" - "+cust.data("Destination");
			int verfColsXFWB[]={9};
			...
			MSG005.verifyMessageDetails(verfColsXFWB, actVerfValuesXFWB, pmKeyXFWB3,"val~XFWB",true);
			libr.waitForSync(1); 
			...
			map.put("awbNumber3", cust.data("CarrierNumericCode")+cust.data("prop~AWBNo3"));
			gahht.enterValue("awbNumber3");
			gahht.clickSaveCaptureChecksheet();
			gahht.selectSCCValue("SCC");
			...
			buhht.enterValue("UldNum");
			buhht.enterAWBDetailsWithoutPcsWgt("awbNumber3");
			buhht.clickSaveCaptureChecksheet();
			...
			buhht.clickMoreOptions();
			buhht.clickCaptureOverhangIndent();
			buhht.captureOverhangIndentDetails("Front1","Rear1","Left1","Right1");
			buhht.clickMoreOptions();
			...
			String pmKeyRCS3=cust.data("CarrierNumericCode")+" - "+cust.data("prop~AWBNo3");
			int verfColsRCS[]={9};
			...
			MSG005.verifyMessageDetails(verfColsRCS, actVerfValuesRCS, pmKeyRCS3,"val~XFSU-RCS",false);
			libr.waitForSync(1);
			...
			String pmKeyPRE3=cust.data("CarrierNumericCode")+" - "+cust.data("prop~AWBNo3");
			int verfColsPRE[]={9};
			...
			MSG005.verifyMessageDetails(verfColsPRE, actVerfValuesPRE, pmKeyPRE3,"val~XFSU-PRE",false);
			libr.waitForSync(2); 
			MSG005.closeTab("MSG005", "MSG005 - List Messages");
			...
			OPR063.verifyULDLoadingInstuctorPopUp("prop~flightNo", "UldNum","Contour","Front1","Rear1","Left1","Right1");
