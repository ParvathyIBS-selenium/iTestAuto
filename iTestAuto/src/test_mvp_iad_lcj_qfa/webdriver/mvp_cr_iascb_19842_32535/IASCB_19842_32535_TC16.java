...
/**
 * Consignee to be charged for the import incurred charges at Delivery ID generation when consignee 
 * is credit customer with less balance [Cash payment] [BTP is same as consignee]
 * 
[Agent (URN A) is a cash with a Bill to (URN C) with no import credit ]
 *
 */
public class IASCB_19842_32535_TC16 extends BaseSetup {
	...
	@DataProvider(name = "DeliveryDocumentation_IAD1_001")
	...
	@Test(dataProvider = "DeliveryDocumentation_IAD1_001")
	public void getTestSuite(Map<Object, Object> map) throws Exception {
		...
		try {
			...
			map.put("ConsigneeCode", WebFunctions.getPropertyValue(custproppath, "creditCustomerId_US4"));
			map.put("ConsigneeName", WebFunctions.getPropertyValue(custproppath, "creditCustomerName_US4"));
			map.put("ConsigneePostCode", WebFunctions.getPropertyValue(custproppath, "creditCustomerpostCode_US4"));
			map.put("ConsigneeStreetName", WebFunctions.getPropertyValue(custproppath, "creditCustomerstreetName_US4"));
			map.put("ConsigneeCityName", WebFunctions.getPropertyValue(custproppath, "creditCustomercityName_US4"));
			map.put("ConsigneeCountryId", WebFunctions.getPropertyValue(custproppath, "creditCustomercountryId_US4"));
			map.put("ConsigneeCountryName", WebFunctions.getPropertyValue(custproppath, "creditCustomercountryName_US4"));
			map.put("ConsigneeCountrySubDiv", WebFunctions.getPropertyValue(custproppath, "creditCustomercountrySubdivision_US4"));
			map.put("ConsigneePhoneNo", WebFunctions.getPropertyValue(custproppath, "creditCustomertelephoneNo_US4"));
			map.put("ConsigneeEmail", WebFunctions.getPropertyValue(custproppath, "creditCustomeremail_US4"));
			map.put("ConsigneeBTP", WebFunctions.getPropertyValue(custproppath, "creditCustomer_BTP_US4"));
			...
			OPR293.acceptAlerts();
			OPR293.enterChargeDetails("Remarks", false);
			OPR293.enterPaymentDetails("CASH", "Remarks");
			OPR293.clickAcceptPayment();
			...
			CSH007.listWithAWB("prop~CarrierNumericCode","prop~AWBNo");
			CSH007.verifyBTPid(cust.data("ConsigneeBTP"));
			cust.closeTab("CSH007", "Generate Payment Advice: CSH007");
