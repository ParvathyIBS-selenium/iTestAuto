...
/**
 *Import credit limit validation for bill to party during  Delivery Note issue from delivery documentation  
 *transaction with new system parameter code set for Import AWBs
 *
 *[Agent (URN A) with no import credit with no Bill to ].[ BTP should be URN A ]
**/
public class IASCB_19842_32535_TC12 extends BaseSetup {
