...
public class Securisation_IAD1_003 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("RegulatedAgentCode", WebFunctions.getPropertyValue(custproppath, "regulatedAgentId_PL"));
			...
			cust.printAndVerifyReport("val~Consignment Security Declaration","OPR339",cust.data("prop~FullAWBNo"),
					cust.data("AgentCountryId")+"/RA"+"/"+cust.data("RegulatedAgentCode"),"Security Status"+"\n"+
