...
public class DL008 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
          ...
          //Process the message
           ...
           OPR026.saveAWB();   
           OPR026.listAWB("prop~AWBNo", "prop~CarrierNumericCode");
           OPR026.uploadFileInOPR026("val~Others","val~Test","FBL_1");          
           OPR026.asIsExecute();
           ...
           //verify FSU-DIS message with message content as "FDAW"
           cust.searchScreen("MSG005", "MSG005 - List Messages");
