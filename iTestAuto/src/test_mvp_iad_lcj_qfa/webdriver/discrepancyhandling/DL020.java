...
public class DL020 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
          ...
          //Process the message
	       ...
	       //Close flight and verify discrepancy warning message
           cust.searchScreen("OPR367", "Import Manifest");
           OPR367.listFlight("prop~flight_code","prop~flightNo", "StartDate");
           OPR367.clickCloseFlight();
           String expMessage="1 AWB(s) , "+cust.data("prop~CarrierNumericCode")+"-"+cust.data("prop~AWBNo")+".";
           OPR367.verifyWarningMessageAfterCloseFlight("Confirmed Discrepancies");
           OPR367.verifyWarningMessageAfterCloseFlight(expMessage);
