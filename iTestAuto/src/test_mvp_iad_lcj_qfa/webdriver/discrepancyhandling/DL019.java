...
public class DL019 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           //Partial breakdown for AWB1 and AWB2 and verify warning message
           cust.searchScreen("OPR367", "Import Manifest");
           OPR367.listFlight("prop~flight_code","prop~flightNo", "StartDate");
           OPR367.maximizeAllDetails();
           String pmkey = Excel.getCellValue(path1,sheetName, "DL019", "UldNum");
           OPR367.clickCheckBox_ULD(pmkey);
           OPR367.clickBreakdownButton();
           OPR367.enterLocationPcsAndWgt("prop~AWBNo", "Location", "Pieces2", "Weight2");
           OPR367.enterLocationPcsAndWgt("prop~AWBNo2", "Location", "Pieces2", "Weight2");
           OPR367.clickBreakdownComplete();
           OPR367.verifyWarningMessage("Discrepancies");
           OPR367.verifyWarningMessageWith2AWBsAfterBreakdownComplete();
