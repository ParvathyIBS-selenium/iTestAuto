...
public class DL012 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
          ...
          //Process the message
           ...
           //Breakdown with pieces and weight less than stated pieces and weight
           cust.searchScreen("OPR367", "Import Manifest");
           OPR367.listFlight("prop~flight_code","prop~flightNo", "StartDate");
           OPR367.maximizeAllDetails();
           String pmkey = Excel.getCellValue(path1,sheetName, "DL012", "UldNum");
           ...
           /*****OPR047 - List Flight Discrepancy******/
           //verify UNCM discrepancy code
           cust.searchScreen("OPR047", "List Flight Discrepancy");
           String flightdate2 = cust.createDateFormat("dd-MMM-yyyy", 0, "DAY", "FlightDate");
           map.put("StartDate", flightdate2);
           OPR047.listByFlight("prop~flight_code", "prop~flightNo", "StartDate");
           int[] verfCols={6};
           String[] actVerfValues={"UNCM"};
           OPR047.verifyDiscrepancydetails(verfCols, actVerfValues);
           OPR047.closeTab("OPR047", "List Flight Discrepancy");
 
           /*****OPR367 - Import Manifest*******/
           //Close flight
           cust.searchScreen("OPR367", "Import Manifest");
           OPR367.listFlight("prop~flight_code","prop~flightNo", "StartDate");
           OPR367.closeFlight_withOkbutton();  
           OPR367.closeTab("OPR367", "Import Manifest");
           
           /*****OPR047 - List Flight Discrepancy******/
           //verify MSCA discrepancy code
           cust.searchScreen("OPR047", "List Flight Discrepancy");
           OPR047.listByFlight("prop~flight_code", "prop~flightNo", "StartDate");
           int[] verfCols3={6};
           String[] actVerfValues3={"MSCA"};
           OPR047.verifyDiscrepancydetails(verfCols3, actVerfValues3);
           OPR047.closeTab("OPR047", "List Flight Discrepancy");
           
           /*******OPR050 - List Discrepancies Screen*****/
           //verify Discrepancy code FDAW 
           ...
           //Click Categorize and select category
           OPR050.selectAWB("prop~AWBNo");
           OPR050.clickCategorize();
           OPR050.selectCategoryAndSave("val~H");
           //Verify Category
           int[] verfCols2={11};
           String[] actVerfValues2={"High"};
           OPR050.verifyDiscrepancydetails(verfCols2, actVerfValues2);
           //Click print and verify
           OPR050.verifyPrint();
           OPR050.closeTab("OPR050", "List Discrepancies");
           
           /*******Verify FSU-DIS message in MSG005******/
           //verify FSU-DIS message with message content as "MSCA"
           cust.searchScreen("MSG005", "MSG005 - List Messages");	
           ...
           MSG005.clickMsg();
           MSG005.clickViewButton();
           String messageContent=MSG005.getMessageContent();
           MSG005.verifyMessageContent(messageContent);
           libr.waitForSync(6); 
