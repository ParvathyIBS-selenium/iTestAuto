...
public class DL015 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			SHR048.listParameter("operations.shipment.eawbsccswithoutpouch");
			String SCCs = SHR048.getParameterValue();
			map.put("SCCValues", SCCs);
          ...
          //Process the message
           ...
           /**** OPR026 - Capture AWB****/
           //Agent code used must be eawb certified
           cust.searchScreen("OPR026","Capture AWB");
           ...
           OPR026.enterShipmentDetails("Pieces", "Weight","Volume","val~9475", "ShipmentDesc");
