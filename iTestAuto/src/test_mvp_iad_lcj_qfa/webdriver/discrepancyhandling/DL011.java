...
public class DL011 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
          ...
          //Process the message
           ...
           //Capture damage and perform full breakdown
           cust.searchScreen("OPR367", "Import Manifest");
           OPR367.listFlight("prop~flight_code","prop~flightNo", "StartDate");
           OPR367.maximizeAllDetails();
           String pmkey = Excel.getCellValue(path1,sheetName, "DL011", "UldNum");
           OPR367.clickCheckBox_ULD(pmkey);
           OPR367.clickBreakdownButton();
           OPR004.enterBdnDetailsCaptureDamageFromOPR367("Location", "Pieces2", "Weight2", "BAND", "val~1");
