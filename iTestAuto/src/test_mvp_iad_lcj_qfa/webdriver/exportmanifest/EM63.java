...
public class EM63 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws Exception {
		...
		try {
			...
			SHR048.listParameter(customfunctions.data("Parameter"));
			String paramVal=SHR048.getParameterValue();
			map.put("paramVal", paramVal);
			SHR048.enterParametrValue(customfunctions.data("ParameterValue"));
			SHR048.saveDetails();
		   ...
		   /** Flight Creation 1**/
			...
			OPR026.enterBookingDetailsSingleLeg("Origin", "Destination", "prop~flightNumber2", "flightStartdate", "Pieces", "Weight", "Volume");
			OPR026.asIsExecute();
			OPR026.close("OPR026");
			...
			customfunctions.listFlight("OPR015", flightCode, customfunctions.data("prop~flightNo2"), customfunctions.data("flightStartdate"), "Generic_Elements");
			...
			buhht.clickYesOnBookingConfirmationInAnotherFlight("val~do not have a booking on this flight");
			buhht.verifyHHTSaveDetails("BuildUpHHT");
		}	
		catch(Exception e)
		{
