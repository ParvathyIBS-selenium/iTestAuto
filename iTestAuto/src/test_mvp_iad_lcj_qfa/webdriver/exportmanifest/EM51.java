...
public class EM51 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			buhht.enterUNIDDetailsWithoutsave("val~1");
			buhht.verifyNotRFCErrorMessageDetails("BuildUpHHT");
