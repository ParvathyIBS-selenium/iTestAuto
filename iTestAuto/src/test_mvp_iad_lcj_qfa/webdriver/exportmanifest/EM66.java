...
public class EM66 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws Exception {
		...
		try {
           ...
           /** Create the message FBL for AWB 2 **/
			...
			OPR015.clickAssignAWB();
			OPR015.clickYesButton();
			String uldNum1=customfunctions.create_uld_number("UldType", "CarrierCode");
			map.put("UldNum1", uldNum1);
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			OPR015.clickMorePanel();
			OPR015.enterPositionDetails("UldNum1","Contour","Entered Position Details");
			OPR015.clickSaveButton();
			customfunctions.closeTab("OPR015", "Flight Load Plan");
			...
			map.put("awbNumber", customfunctions.data("prop~stationCode")+customfunctions.data("AWBNo"));
