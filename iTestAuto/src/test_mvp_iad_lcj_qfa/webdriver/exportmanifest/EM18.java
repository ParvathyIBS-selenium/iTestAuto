...
//The testcase is failed , since progress bar shows always 0%
public class EM18 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws Exception {
		...
		try {
			...
			//2nd leg
			FLT005.clickCheckbox("chk_MUC-JFK;xpath");
			FLT005.clickUpdateCapacity();
			FLT005.enterLegCapacityDetails("ATD2_Local", "ATA2_Local", "AircraftType", "Configuration_name");
			FLT005.legCapacityOkButton();
			FLT005.save();
           ...
           /******* FBL message loading to be reoplaced by CAP018 once the screen is available*****/
            ...
            libr.waitForSync(1);
            cust.setPropertyValue("FullAWBNo3", cust.data("prop~stationCode")+"-"+cust.data("prop~AWBNo"), proppath);
         ...
         //Create the message FBL
			...
			//Capture AWB Details
			cust.searchScreen("OPR026","Capture AWB");
			OPR026.listAWB("prop~AWBNo3", "prop~CarrierNumericCode");
			OPR026.updateOrigin("Origin");
			OPR026.updateDestination("Destination");
			OPR026.enterRouting("Destination","prop~flight_code");       
			OPR026.selectSCI("SCI");
			...
			OPR335.looseShipmentDetails("Location", "OffloadPcs","OffloadWt");
			...
			//Manifest
			OPR344.verifyProgressBarStatus("Manifest","val~0%");
			//Build Up
			OPR344.verifyProgressBarStatus("BuildUp","val~0%");
			//Executed
			OPR344.verifyProgressBarStatus("Executed","val~0%");
			//Joining
			OPR344.verifyProgressBarStatus("Joining","val~0%");
			//Transit
			OPR344.verifyProgressBarStatus("Transit","val~0%");
