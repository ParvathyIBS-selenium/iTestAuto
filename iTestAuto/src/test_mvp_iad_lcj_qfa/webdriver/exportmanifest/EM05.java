...
public class EM05 extends BaseSetup {
	...
	@DataProvider(name = "EM05")
	public Object[][] createData2() throws Exception {
		Object[][] retObjArr1 = excelRead.getMapArray(path1, sheetName, testName);
		return retObjArr1;
	}

	@Test(dataProvider = "EM05")
	public void getTestSuite(Map<Object, Object> map) throws Exception {
		...
		try {
			...
			cust.searchScreen("FLT005", "FLT005 - Maintain Flight Schedule");
			FLT005.listNewFlight("CarrierCode","FlightNo2", startDate, endDate,"FullFlightNumber2");
           ...
           /******* FBL message loading to be reoplaced by CAP018 once the screen is available*****//*
			...
			OPR336.listFlight("prop~flight_code", "FlightNo2", "StartDate", "Manifest");
			
			//Verify flight details
			
			OPR336.verifyFlightDetails("FlightNo2");
