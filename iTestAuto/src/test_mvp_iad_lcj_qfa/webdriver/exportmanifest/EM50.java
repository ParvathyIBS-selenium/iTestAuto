...
public class EM50 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
            ...
            OPR335.clickSave();
            customfunctions.handleAlert("Accept", "OPR335");
			customfunctions.switchToDefaultAndContentFrame("OPR335");
			...
			buhht.verifyBlockExistErrorMessageDetails("BuildUpHHT");
