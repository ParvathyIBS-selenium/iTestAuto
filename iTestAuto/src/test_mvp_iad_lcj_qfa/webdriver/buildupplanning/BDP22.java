...
public class BDP22 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			// creating flight number - flight 1
			...
			map.put("FBLNextDate", cust.createDateFormat("ddMMM", 1, "DAY", ""));
			map.put("Day", cust.createDateFormat("dd", 0, "DAY", ""));
			map.put("NextDay", cust.createDateFormat("dd", 1, "DAY", ""));
			map.put("NextDayMonth", nextDate.split("-")[1].toString().toUpperCase());
			...
			FLT005.enterFlightDetails("Leg1", "scheduleType", "FCTL", "Office", "flightType");
			...
			// creating flight number - flight 2
			...
			FLT005.enterFlightDetails("Leg2", "scheduleType", "FCTL", "Office", "flightType");
			...
			map.put("pmkey", cust.data("prop~flight_code")+" - "+cust.data("prop~flightNo2")+" - "+cust.data("NextDay")+" - "+cust.data("NextDayMonth").toUpperCase()
					+" - "+cust.data("Transit"));
			MSG005.clickCheckBox("pmkey");
			MSG005.clickprocess();
			cust.closeTab("MSG005", "List Message");
			...
			OPR026.enterBookingDetailsSecondRow("Transit", "Destination", "FullFlightNo2", "NextDate", "Pieces", "Weight", "Volume");
			OPR026.saveAWB();
			OPR026.listAWB("prop~AWBNo", "prop~CarrierNumericCode");
			OPR026.asIsExecute();
		...
		/***** OPR026 - Execute AWB 2****/
			...
			OPR026.provideShipperCode("shipperCode");
			OPR026.provideConsigneeCode("consigneeCode");
			OPR026.enterShipmentDetails("Pieces", "Weight2","Volume","CommodityCode", "ShipmentDesc");
			OPR026.clickChargesAcc();
			OPR026.provideRatingDetails("rateClass","IATARate","IATAcharge","netCharge");
			OPR026.clickBookingDetails();
			OPR026.enterBookingDetailsSingleLeg("Origin", "Transit", "FullFlightNo", "StartDate", "Pieces", "Weight2", "Volume");
			OPR026.enterBookingDetailsSecondRow("Transit", "Destination", "FullFlightNo2", "NextDate", "Pieces", "Weight2", "Volume");
			OPR026.saveAWB();
			OPR026.listAWB("prop~AWBNo2", "prop~CarrierNumericCode");
			OPR026.asIsExecute();
			cust.closeTab("OPR026", "Capture AWB");
		...
		/** OPR355 - Goods Acceptance for AWB 1**/
			...
			/** OPR355 - Goods Acceptance for AWB 2**/

			cust.searchScreen("OPR335", "Goods Acceptance");
			cust.listAWB("AWBNo2", "prop~CarrierNumericCode", "Goods Acceptance");
			libr.waitForSync(6);
			OPR335.looseShipmentDetails("Location", "Pieces","Weight2");
			OPR335.addLooseShipment();
			OPR335.allPartsRecieved();
			OPR335.saveAcceptance();
			cust.closeTab("OPR335", "Goods Acceptance");
		...
		/*** HHT - Build Up****/
			...
			buhht.enterShipmentDetails("awbNumber2","Pieces", "Weight2");
			buhht.verifyBuildUpDetailsIfSaved();
			libr.quitApp();
			...
			buhht.captureConsumablesWithOutSave("Consumable");
			...
			buhht.clickMoreOptions();
			buhht.clickBuildUpCompleteBtn();
			buhht.captureConsumables("Consumable");
			libr.quitApp();
		...
		/***** LOGIN TO ICARGO*****/
			...
			cust.searchScreen("ADD004", "Buildup Planning");
			add004.listFlight("carrierCode","FlightNo","StartDate");
			add004.verifyAWBWithinULDInAllocated("prop~AWBNo","val~1 AKE");
			add004.verifyStatus("val~BUILDUP COMPLETED");
			add004.verifyAWBWithinULDInAllocated("prop~AWBNo2","val~1 AKE");
			add004.verifyStatus("val~BUILDUP COMPLETED");
			cust.closeTab("ADD004", "Buildup Planning");
