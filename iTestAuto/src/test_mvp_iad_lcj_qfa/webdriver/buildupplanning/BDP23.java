...
public class BDP23 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR026.listAWB("prop~AWBNo2", "prop~CarrierNumericCode");
			OPR026.clickBookingDetails();
			OPR026.enterBookingDetailsSingleLeg("Origin", "Destination", "FullFlightNo", "StartDate", "Pieces", "Weight2", "Volume");
			OPR026.asIsExecute();
			cust.closeTab("OPR026", "Capture AWB");
		/**** FLIGHT LOAD PLAN**/
		...
		/*** HHT - Build Up****/
			...
			add004.verifyAWBWithinULDInAllocated("prop~AWBNo2","UldNum");
			add004.verifyStatus("val~BUILDUP COMPLETED");
			cust.closeTab("ADD004", "Buildup Planning");
