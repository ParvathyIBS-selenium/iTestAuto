...
public class GA29 extends BaseSetup {
            ...
            /*********MSG005-loading FBL*********/
	          ...
	          //Process the message
	           ...
	           customfunctions.closeTab("MSG005", "List Message");
    			...
    			//Enter dimensional details for partial pieces
    			gahht.enterDimensionDetails("Pieces2", "Weight2","val~1,val~1,val~1");
    			//Enter dimensional details for remaining pieces
    			gahht.enterDimensionDetails("Pieces2", "Weight2","val~1,val~1,val~1");    			
    			//Verify dimensional pieces thats displayed in 2 lines
    			gahht.verifyDimensionDetails("Pieces2", "Weight2","Pieces2", "Weight2","val~1,val~1,val~1");
    			libr.quitApp();
