...
public class GA37 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws IOException {
		...
		try {
			...
			// Switch Role
			customfunctions.switchRole("Origin", "Transit", "RoleGroup");
            ...
            /*********MSG005-loading FBL*********/
	          ...
	          //Process the message
	           ...
	           /**** OPR339 - Security & Screening****/
    			...
    			gahht.entertransShipmentDetails("prop~flight_code", "prop~flightNo", "currentDay");
