...
public class GA47 extends BaseSetup {
            ...
            /*********MSG005-loading FBL*********/
	          ...
	          //Process the message
	           ...
	           customfunctions.closeTab("MSG005", "List Message");
                ...
                //Verify able to save goods acceptance details without Big Ref No
				OPR335.looseShipmentDetails("Location", "Pieces","Weight");
                OPR335.addLooseShipment();
                OPR335.allPartsRecieved();
                OPR335.saveAcceptance();
                //Verify the Big Ref No field by entering 25 characters
                map.put("refNo",customfunctions.createRandomAlphabets(25));
                OPR335.enterBigRefNoField("refNo");
                OPR335.verifyBigRefNoField(25);
                OPR335.saveAcceptance();
                //Verify the Big Ref No field by entering 26 characters
                map.put("refNo",customfunctions.createRandomAlphabets(26));
                OPR335.enterBigRefNoField("refNo");
                OPR335.verifyBigRefNoField(26);
                OPR335.saveAcceptance();
