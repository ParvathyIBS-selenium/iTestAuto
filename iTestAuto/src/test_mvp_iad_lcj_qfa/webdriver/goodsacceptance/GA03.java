...
public class GA03 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws InterruptedException {
		...
		/*	*//*******Pre-Condition***********//*
	       ...
	       //Checking AWB is fresh or Not
			...
			//Verify warehouse location and ULD number
	        customfunctions.searchScreen("WHS011", "WHS011 - Warehouse Shipment Enquiry");
	        WHS011.enterAWBdetails();
            WHS011.clickList();
           int[] col = {4,5};
            String uld = (String) map.get("UldNum");
            String[] values={customfunctions.data("Location"),uld};
