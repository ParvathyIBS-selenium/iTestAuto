...
public class IntegratedTestCase extends BaseSetup {
	...
	@DataProvider(name = "IntegratedTestCase")
	...
	@Test(dataProvider = "IntegratedTestCase")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Clicks on Accept button and perform goods acceptance
		    ...
		    String awbNo1 = customfunctions.data("prop~AWBNo");
            ...
            /** Checking Message FSU Triggered **/
			customfunctions.searchScreen("MSG005", "MSG005 - List Messages");
			MSG005.clickClearButton();
			...
			MSG005.clickCheckBox("pmkey");
			MSG005.verifyMessageTriggered("pmkey", "FSU");        
		    ...
		    String awbNo2 = customfunctions.data("prop~AWBNo");
            ...
            OPR335.looseShipmentDetails("Location", "lessPcs","lessWt");
            OPR335.addLooseShipment();
            OPR335.looseShipmentDetails("Location2", "lessPcs","lessWt");
            OPR335.addLooseShipment();
            OPR335.allPartsRecieved();
            OPR335.save("Goods Acceptance");
            OPR335.clickYesButton();
		    ...
		    String awbNo3 = customfunctions.data("prop~AWBNo");
		    ...
		    String awbNo4 = customfunctions.data("prop~AWBNo");
			...
			customfunctions.closeTab("OPR026", "Capture AWB");
		     ...
		     //Create the message RCS
			    customfunctions.createTextMessage("MessageExcelAndSheet2", "MessageParam2");
		        customfunctions.searchScreen("MSG005", "MSG005 - List Messages");
		        MSG005.loadFromFile("All","ALL", "MQ-SERIES","", "Origin", "", "FSU_RCS1");
			  ...
			  //Process the message
			    ...
			    MSG005.clickList();
			    libr.waitForSync(6);     
			    map.put("pmkey", customfunctions.data("CarrierNumericCode")+" - "+customfunctions.data("AWBNo"));
			    MSG005.clickCheckBox("pmkey");
			    MSG005.clickprocess();
			    customfunctions.closeTab("MSG005", "List Message");
			    ...
			    String awbNo5 = customfunctions.data("prop~AWBNo");
	            ...
	            /*************************************Case 7***************************************/
	        			    ...
	        			    String awbNo6 = customfunctions.data("prop~AWBNo");
	        			    map.put("AWBNo6",awbNo6);
	        				...
	        				libr.waitForSync(6);
	        				OPR335.uldShipmentDetails("lessPcs","lessWt", "Location", "UldNum2","");
	        	            OPR335.addULDDetails();
	        	            OPR335.allPartsRecieved();
	        	            OPR335.saveAcceptance();
	        	            customfunctions.closeTab("OPR335", "Goods Acceptance");
	        			    ...
	        			    String awbNo7 = customfunctions.data("prop~AWBNo");
	        			    map.put("AWBNo7",awbNo7);
	        	            ...
	        	            OPR335.addLooseShipment();
	        				libr.waitForSync(6);
	        				OPR335.uldShipmentDetails("lessPcs","lessWt", "Location", "UldNum3","");
	        	            OPR335.addULDDetails();
	        	            OPR335.allPartsRecieved();
	        	            OPR335.saveAcceptance();
	        	            customfunctions.closeTab("OPR335", "Goods Acceptance");
	        			    ...
	        			    String awbNo8 = customfunctions.data("prop~AWBNo");
	        			    map.put("AWBNo8",awbNo8);
	        			    ...
	        			    String awbNo9 = customfunctions.data("prop~AWBNo");
	        			    map.put("AWBNo9",awbNo9);
	        				...
	        				customfunctions.listAWB("AWBNo", "prop~CarrierNumericCode", "Goods Acceptance");
	        				OPR335.clickLooseAccptTab();
	        	            OPR335.looseShipmentDetails("Location", "morePcs","moreWt");
	        	            OPR335.addLooseShipment();
	        	            OPR335.allPartsRecieved();
	        	            OPR335.save("Goods Acceptance");
	        	            OPR335.clickYesButton();
