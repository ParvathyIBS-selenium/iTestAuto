...
public class GA04 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws InterruptedException, IOException {
		...
		try {
	       ...
	       //Checking AWB is fresh or Not
			...
			/*** HHT - ACCEPTANCE****/
			//Partial ULD acceptance
			gahht.invokeAcceptanceScreen();
			map.put("uldNum", customfunctions.create_uld_number("UldType", "carrierCode"));
			...
			/*** HHT - ACCEPTANCE****/
			gahht.invokeAcceptanceScreen();
			map.put("awbNumber", customfunctions.data("CarrierNumericCode")+customfunctions.data("prop~AWBNo"));
			gahht.enterValue("awbNumber");
			//Perform loose acceptance for remaining pieces with different location
			gahht.enterLooseAcceptanceDetails("Pieces2", "Weight2", "val~02");   		
	        ...
	        WHS011.clickList();
	        int[] verfCols={4};
	        String[] actVerfValues={"01"};
	        WHS011.verifyWarehouseDetailsWithPmKey(verfCols, actVerfValues,"uldNum");
	        int[] verfCols1={4};
	        String[] actVerfValues1={"02"};
	        WHS011.verifyWarehouseDetailsWithPmKey(verfCols1, actVerfValues1,"val~DEFAULT");
            ...
            MSG005.clickList();
            MSG005.verifyMessageTriggered("AWBNo", "FSU-FOH");
            libr.waitForSync(6); 
            ...
            MSG005.selectStatus("Sent");
            MSG005.clickList();
            MSG005.verifyMessageTriggered("AWBNo", "FSU-RCS");
            libr.waitForSync(6); 
            MSG005.closeTab("MSG005", "MSG005 - List Messages");
