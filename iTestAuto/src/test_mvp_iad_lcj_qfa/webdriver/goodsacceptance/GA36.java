...
public class GA36 extends BaseSetup {
            ...
            /*********MSG005-loading FBL*********/
	          ...
	          //Process the message
	           ...
	           customfunctions.closeTab("MSG005", "List Message");
    			...
    			//Enter dimensional details
    			gahht.enterDimensionDetails("Pieces", "Weight","Length,Width,Height");
    			...
    			OPR335.verifyDimensionDetails(customfunctions.data("Length,Width,Height"));
