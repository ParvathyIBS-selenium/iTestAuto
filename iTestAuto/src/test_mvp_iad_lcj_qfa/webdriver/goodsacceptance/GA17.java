...
public class GA17 extends BaseSetup {
		...
		try {
			...
			customfunctions.switchRole("Origin", "Origin", "RoleGroup");
			 ...
			 /**** FLT003 - Create flight****/
			    ...
			    String flightdate1 = customfunctions.createDateFormat("ddMMMyy", 0, "DAY", "FlightDate");
			    map.put("FlightNo", flightNo);
			    map.put("StartDate", flightdate1);
			    map.put("flightStartDate", customfunctions.createDateFormat("dd-MMM-yyyy", 0, "DAY", ""));
            ...
            /**** MSG005 - List Messages****/
	          //Create the message FWB
		        customfunctions.createTextMessage("MessageExcelAndSheet2", "MessageParam2");
	            customfunctions.searchScreen("MSG005", "MSG005 - List Messages");
		        MSG005.loadFromFile("Airline","prop~flight_code", "JMS","", "Origin", "", "FWB_11");
	            ...
	            //Process the message
		         ...
		         MSG005.clickList();
		         libr.waitForSync(6);     
		         map.put("pmkey", customfunctions.data("CarrierNumericCode")+" - "+customfunctions.data("AWBNo")+" - "+customfunctions.data("Origin")+" - "+customfunctions.data("Destination"));
		         MSG005.clickCheckBox("pmkey");
		         MSG005.clickprocess();
		         customfunctions.closeTab("MSG005", "List Message");
             ...
             OPR335.verifyAWBDetails("Weight", "Volume");
