...
public class GA19 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws InterruptedException {
		...
		/*	*//*******Pre-Condition***********//*
            ...
            /*********MSG005-loading FBL*********/
	           ...
	           MSG005.loadFromFile("All","ALL", "MQ-SERIES","", "Origin", "", "FBL_1");
            ...
            /**** OPR339 - Security & Screening****/
	           ...
	           /* customfunctions.searchScreen("MSG005", "MSG005 - List Messages");
				...
				customfunctions.searchScreen("OPR341", "List Irregularity");
				customfunctions.listAWB("AWBNo", "CarrierNumericCode", "List Irregularity");  
	            int cols[] = {3};
	            String[] values={"Temporary storage only"};
				OPR341.verifyIrregularityDetailsValue(cols, values, "TMPS");
				customfunctions.closeTab("OPR341", "List Irregularity");
