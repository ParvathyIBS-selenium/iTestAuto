...
//Export credit limit validation during "AWB As-is execution" transaction with new system parameter code set for export AWBs
public class IASCB_32535_TC01 extends BaseSetup {
