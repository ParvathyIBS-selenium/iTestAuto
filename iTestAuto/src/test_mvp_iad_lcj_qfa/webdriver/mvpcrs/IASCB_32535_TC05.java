...
//Export credit limit validation during "Shipper return note" transaction with new system parameter code set for export AWBs
public class IASCB_32535_TC05 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Fill SRN details,pieces summary and click save
            cust.searchScreen("OPR040","Shipper Return Note");
            OPR040.enterAWBdetails("prop~CarrierNumericCode","prop~AWBNo");
            OPR040.clickList();
            OPR040.enterStaffIdAndValidUntil("val~1234", issuedDate);
