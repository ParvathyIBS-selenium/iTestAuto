...
/**Combination of Special Shipments SCC(SPX) and General cargo SCC for Found Cargo Discrepancy Shipments**/
public class IASCB_31348_TC06 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
            ...
            String pmkey = Excel.getCellValue(path1,sheetName, "IASCB_31348_TC06", "UldNum");
            ...
            //verify FSU-DIS message with message content as "FDCA"
            cust.searchScreen("MSG005", "MSG005 - List Messages");
