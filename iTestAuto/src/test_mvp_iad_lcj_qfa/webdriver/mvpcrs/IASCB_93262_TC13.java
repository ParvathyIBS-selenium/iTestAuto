...
public class IASCB_93262_TC13 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
            ...
            String pmkey = Excel.getCellValue(path1,sheetName, "IASCB_93262_TC13", "UldNum");
            OPR367.clickCheckBox_ULD(pmkey);
            OPR367.clickandListAddNewULD("UldNum", "CarrierNumericCode", "prop~AWBNo");
            //Verification of SCI step only pending
