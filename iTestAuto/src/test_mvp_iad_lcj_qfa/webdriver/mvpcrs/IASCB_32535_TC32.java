...
//Import Credit limit validation when threshold level is crossed while override is checked in Customer credit master screen
public class IASCB_32535_TC32 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws Exception {
		...
		try {
			...
			//Store import guarantee details and credit balance details in map
           ...
           //Manifest and Finalize the flight
            ...
            //Enter breakdown pieces and weight equal to stated pieces and weight
            cust.searchScreen("OPR367", "Import Manifest");
            OPR367.listFlight("prop~flight_code","prop~flightNo", "StartDate");
            OPR367.maximizeAllDetails();
            String pmkey = Excel.getCellValue(path1,sheetName, "IASCB_32535_TC32", "UldNum");
			...
			/**** SHR110 - Customer Credit Master****/
			//Verify import guarantee details and credit balance details are unchanged
            cust.searchScreen("SHR110","Customer Credit Master");
            SHR110.listCustomerCode("AgentCode");
            SHR110.verifyBalanceAvailable("BalanceAmount");
            SHR110.verifyGuaranteeAmount("ImportGuaranteeAmount");
            cust.closeTab("SHR110","Customer Credit Master");
