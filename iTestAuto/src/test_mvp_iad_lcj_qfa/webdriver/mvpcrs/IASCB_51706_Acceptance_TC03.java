...
public class IASCB_51706_Acceptance_TC03 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String pcsinfo[]={libr.data("SplitPcs").split(",")[0],libr.data("SplitPcs").split(",")[1],libr.data("SplitPcs").split(",")[2]};
			String locs[]={libr.data("Location2").split(",")[0],libr.data("Location2").split(",")[1],libr.data("Location2").split(",")[2]};
			OPR335.editShipmentLocation(pcsinfo[0],sccs[0],locs[0]);
			OPR335.editShipmentLocation(pcsinfo[1],sccs[2],locs[1]);
			OPR335.editShipmentLocation(pcsinfo[2],sccs[3],locs[2]);
