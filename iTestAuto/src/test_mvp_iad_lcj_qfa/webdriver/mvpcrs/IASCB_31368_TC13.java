...
public class IASCB_31368_TC13 extends BaseSetup {
	...
	/** Capture Screening save as Passed twice and Verify block is getting released for Damage discrepancy  **/
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
            ...
            cust.searchScreen("OPR339", "Security and Screening");
            OPR339.listAWB("AWBNo", "CarrierNumericCode", "OPR339 - Security & Sceening");
            OPR339.enterScreeningDetails("val~X-ray equipment","Pieces","Weight","val~Pass"); 
