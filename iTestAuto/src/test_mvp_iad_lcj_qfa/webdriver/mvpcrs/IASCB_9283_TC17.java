...
/**Capture Contour Code for ULD with Split Function from Build up**/
public class IASCB_9283_TC17 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String uldNum=cust.create_uld_number("UldType3", "carrierCode");
			...
			OPR063.clickULDLoadingInstuctor();
			OPR063.verifyULDLoadingInstuctorWithContourDetails("FlightNo", "UldNum1","Contour1");
			OPR063.ULDLoadingInstructionOK();
			cust.closeTab("OPR063", "Dead load statement");
