...
/**Verify transhipment AWB will be Blocked for Security and Screening while Creating the Found Cargo Discrepancy**/
...
public class IASCB_31348_TC10 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			MSG005.loadFromFile("Airline","prop~flight_code", "JMS", "", "Origin", "", "ASM_MultiSeg");
            ...
            //Capture security details by entering SCC as 'SHR'
	        ...
	        /***** OPR026 - Execute AWB****/			
			//Enter details in Booking details tab and execute the AWB
			cust.searchScreen("OPR026","Capture AWB");
			...
			OPR026.enterBookingDetailsSecondRow("Transit", "Destination", "FullFlightNo", "StartDate", "Pieces", "Weight", "Volume");
			OPR026.asIsExecute();
			...
			buhht.updateFlightDetailsWithOutPopUp("prop~flight_code", "prop~flightNo","currentDay","Transit");
            ...
            OPR367.verifyShipmentPresentOrNot(true, "prop~AWBNo");  
            OPR367.closeTab("OPR367", "Import Manifest");
            
            //Launch and Login to HHT
			libr.launchApp("hht-app-release");
            cust.loginHHT(hht[0], hht[1]);
			
			/*** HHT - Capture Irregularity****/
            //Create FDCA discrepancy with more pieces and weight
            cihht.invokeCaptureIrregularityScreen();
            cihht.selectTransaction("Breakdown");
            map.put("awbNumber", cust.data("prop~stationCode")+cust.data("prop~AWBNo"));
            cihht.enterAwbNumber("awbNumber");
            cihht.selectDeviationCode(cust.data("Irregularity"));
            cihht.enterPiecesAndRemarks("Pieces2","Remarks");
            cihht.clickSave();
            ...
            //Verify shipment details with irregularity code
            ...
            //Verify the block details are not present
