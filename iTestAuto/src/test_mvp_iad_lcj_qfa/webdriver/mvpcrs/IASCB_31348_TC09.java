...
/**Split Shipment of AWB will be Blocked for Security and Screening while Creating the Found Cargo Discrepancy**/
...
public class IASCB_31348_TC09 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
            ...
            //Capture security details by entering SCC as 'SCO'
			...
			/*** HHT - ACCEPTANCE****/
			//Perform ULD acceptance with partial pieces
			gahht.invokeAcceptanceScreen();
			map.put("uldNum1", cust.create_uld_number("UldType", "carrierCode"));
			...
			//Perform ULD acceptance with remaining pieces			
			map.put("uldNum2", cust.create_uld_number("UldType", "carrierCode"));			
			gahht.enterValue("uldNum2");
			System.out.println(cust.data("uldNum2"));
			gahht.enterUldAcceptanceDetails("Location", "awbNumber", "Pieces2");
            ...
            //Perform breakdown pieces for ULD1
            ...
            //Enter breakdown pieces and weight more than remaining pieces and weight
            cust.searchScreen("OPR367", "Import Manifest");
            OPR367.listFlight("prop~flight_code","prop~flightNo", "StartDate");
            OPR367.maximizeAllDetails();            
            OPR367.clickCheckBox_ULD(cust.data("uldNum2"));            
            OPR367.clickBreakDownandBreakdownComplete("Location", "Pieces3","Weight3");
            ...
            //Verify the irregularity details
