...
/**Stamping of SPX after Releasing the Block for Auto Blocked Shipments due to Found Cargo Discrepancy for General Cargo**/
 
public class IASCB_31348_TC07 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
            ...
            String pmkey = Excel.getCellValue(path1,sheetName, "IASCB_31348_TC29", "UldNum");
			...
			sechht.enterScreeningDetails("Pieces2");
			sechht.enterScreeningStatus("Pass");
			sechht.saveScreeningDetails();
			sechht.enterValue("awbNumber");
						
            /*****OPR023 - AWB Clearance *******/            
            //Verify AWB details are displayed with release details
            cust.searchScreen("OPR023", "AWB Clearance");
            OPR023.listAWB("prop~CarrierNumericCode","prop~AWBNo");
            int[] verfCols2={4,8};
            String[] actVerfValues2={cust.data("BlockType"),"val~Release"};
            OPR023.verifyBlockDetails(verfCols2, actVerfValues2, cust.data("BlockType"));
            OPR023.closeTab("OPR023", "AWB Clearance");
            
            /**********OPR293-Delivery Documentation**********/			
			//Verify that user is able to deliver as the AWB is Released
			cust.searchScreen("OPR293", "Delivery Documentation");
			cust.listAWB("AWBNo", "prop~CarrierNumericCode", "Delivery Documentation");				
