package mvp_reg_importmanifest_sanity;
...
public class ImportManifestIAD1_002 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String uld[] = { cust.data("UldType")+";"+ cust.data("ULDNo")+";"+cust.data("carrierCode"),cust.data("UldType")+";"+ cust.data("ULDNo")+";"+cust.data("carrierCode")};
