...
public class CSH16 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws Exception {
	    ...
	    /**** OPR026 - Capture AWB****/
          ...
          /**** OPR339 - Security & Screening****/
			...
			customfunctions.searchScreen("CSH009","Payment advice enquiry screen");
			CSH009.listAWB("CarrierNumericCode", "prop~AWBNo");
		 	CSH009.clickPaymentAdvice("PaymentAdviceNo");
		 	CSH009.clickCancelPaymentAdvice();
		 	CSH009.regeneratepaymentAdvice();
		 	CSH007.enterPayment("val~2000");
			CSH007.enterRemarks("val~Cash Payment");
			CSH007.clickAdd();
			CSH007.clickFinalizePayment();
		 	customfunctions.closeTab("CSH009", "Payment advice enquiry screen");
		 	
		 	
		 	//Payment advice enquiry screen***/
			customfunctions.searchScreen("CSH009","Payment advice enquiry screen");
			String pmKey=customfunctions.data("CarrierNumericCode")+" "+customfunctions.data("prop~AWBNo");
		 	int[] verfCols={5};
