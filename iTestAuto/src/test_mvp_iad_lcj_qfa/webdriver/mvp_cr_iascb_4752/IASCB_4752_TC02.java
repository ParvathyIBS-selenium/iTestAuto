...
/** 
 * No email notification popup when configuration for a selective damage code exists but damage is captured for ULD shipment is a different damage code from android screen
 */
public class IASCB_4752_TC02 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			dchht.clickSaveWithoutEmailNotificationPopUp();
			libr.quitApp();
