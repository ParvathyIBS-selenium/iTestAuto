...
//Damage capture for import side AWB from android screen with EMAIL configuration
//verification of notification in email is pending

public class IASCB_4752_TC07 extends BaseSetup{
	...
	@DataProvider(name = "IASCB_4752_TC07")
	...
	@Test(dataProvider = "IASCB_4752_TC07")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           String uld[] = { cust.data("UldType")+";"+ cust.data("ULDNo")+";"+cust.data("carrierCode")};
			...
			String pmkey = Excel.getCellValue(path1,sheetName, "IASCB_4752_TC06", "val~AKE47502AF");
