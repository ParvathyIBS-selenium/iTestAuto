...
/** 
 * Damage Capture for Found Shipment
 */

public class IASCB_4752_TC08 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String pmkey = Excel.getCellValue(path1,sheetName, "IASCB_4752_TC08", "UldNum");
			//manually edited the breakdown instruction to breakdown
