...
public class IM003 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           /** Process the message **/
			...
			map.put("ULD3", uldNo3);
			OPR367.clickOptionForULD("UldNum");
			OPR367.CorrectUldNum("ULD3");
            OPR367.SaveDetails();
			...
			customfunctions.searchScreen("OPR367", "Import Manifest");
            OPR367.listFlight("prop~flight_code","prop~flightNo", "flightStartdate");
            OPR367.enterShipmentDetailsInSearchBox("ULD3");
		   ...
		   customfunctions.searchScreen("OPR047", "List Flight Discrepancy");
           OPR047.listByFlight("prop~flight_code","prop~flightNo", "flightStartdate");
           int[] verfCols={6};
