...
public class IM015 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           /** Create the message FBL for AWB 2 **/
            ...
            String pmkey = Excel.getCellValue(path1,sheetName, "IM015", "UldNum");
            ...
            OPR367.listFlight("prop~flight_code","prop~flightNo", "flightStartdate");
            OPR367.maximizeAllDetails();
            OPR367.clickCheckBox_ULD("BULK");
            OPR367.clickBreakDownandBreakdownComplete("Location","Pieces", "Weight");
            OPR367.closeFromOPR004();
			OPR367.closeTab("OPR367", "Import Manifest");
			
			
			//verifying Breakdown Successful
            ...
            //Verifying Breakdown time
            customfunctions.searchScreen("OPR005","Breakdown Enquiry");
            OPR005.listFlight("prop~AWBNo","flightStartdate", "flightStartdate");
            map.put("startdatepmkey",customfunctions.data("Day")+"-"+customfunctions.data("Month")+"-"+customfunctions.createDateFormat("YYYY", 0, "DAY", ""));
            map.put("enddatepmkey", customfunctions.data("Day")+"-"+customfunctions.data("Month")+"-"+customfunctions.createDateFormat("YYYY", 0, "DAY", ""));
            map.put("userpmkey", customfunctions.data("prop~iCargoUN"));
            OPR005.verifyRecordExist("startdatepmkey","enddatepmkey","userpmkey");
            OPR005.closeTab("OPR005","Breakdown Enquiry");
            customfunctions.searchScreen("OPR005","Breakdown Enquiry");
            OPR005.listFlight("AWBNo2","flightStartdate", "flightStartdate");
            OPR005.verifyRecordExist("startdatepmkey","enddatepmkey","userpmkey");
            OPR005.closeTab("OPR005","Breakdown Enquiry");
		}	
		catch(Exception e)
