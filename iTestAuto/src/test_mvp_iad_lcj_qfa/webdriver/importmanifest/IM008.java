...
public class IM008 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           customfunctions.searchScreen("OPR023", "AWB Clearance");
            OPR023.listAWB("prop~CarrierNumericCode", "prop~AWBNo");
            OPR023.clickBlock();
            OPR023.enterBlockDetails("val~Customs", "val~Test Automation");
            OPR367.closeTab("OPR023", "AWB Clearance");
            
            /**VERIFYING BLOCK IMAGE**/
            
            customfunctions.searchScreen("OPR367", "Import Manifest");
			OPR367.listFlight("prop~flight_code","prop~flightNo", "flightStartdate");
			String pmkey1 = Excel.getCellValue(path1,sheetName, "IM008", "UldNum");
	        OPR367.clickCheckBox_ULD(pmkey1);
			OPR367.clickBreakDownandBreakdownComplete("Location","Pieces", "Weight");
			OPR367.closeFromOPR004();
			OPR367.verifyBlockImage();
			OPR367.closeTab("OPR367", "Import Manifest");
			
			/** Release Block AWB clearance screen **/
			
			customfunctions.searchScreen("OPR023", "AWB Clearance");
            OPR023.listAWB("prop~CarrierNumericCode", "prop~AWBNo");
            OPR023.releasBlockDetails("val~Test Automation");
            OPR367.closeTab("OPR023", "AWB Clearance");
			...
			customfunctions.searchScreen("OPR367", "Import Manifest");
			OPR367.listFlight("prop~flight_code","prop~flightNo", "flightStartdate");
            String pmkey = Excel.getCellValue(path1,sheetName, "IM008", "UldNum");
            OPR367.clickCheckBox_ULD(pmkey);
            OPR367.verifyBlockImageNotDisplayed();
			OPR367.closeTab("OPR367", "Import Manifest");
			customfunctions.searchScreen("OPR367", "Import Manifest");
            OPR367.listFlight("prop~flight_code","prop~flightNo", "flightStartdate");
