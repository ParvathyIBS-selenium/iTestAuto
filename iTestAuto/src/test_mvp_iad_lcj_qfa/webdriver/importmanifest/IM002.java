...
public class IM002 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           /**OPR001**/
			...
			customfunctions.searchScreen("OPR001", "Import Documentation: OPR001");
			OPR001.listDetails(customfunctions.data("prop~flightNo"), customfunctions.data("flightStartdate"));
			OPR001.verifyShipmentDisplayed(customfunctions.data("prop~FullAWBNo"));
			OPR001.clickAWBDocumentReceived(customfunctions.data("prop~AWBNo"));
			OPR001.clickImportManifest();
			OPR367.maximizeAllDetails();
            String pmkey = Excel.getCellValue(path1,sheetName, "IM002", "UldNum");
            ...
            MSG005.clickList();
            MSG005.verifyMessageTriggered("prop~AWBNo", "FSU");
            libr.waitForSync(6);
