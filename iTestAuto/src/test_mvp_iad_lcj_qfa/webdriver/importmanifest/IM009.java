...
public class IM009 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           /** Process the message **/
			...
			/******Verifying Modified  ULD 	Details **********/
			...
			/** Import Manifest Capture manifested pieces is greater than stated pieces**/
			...
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			libr.waitForSync(6);
			OPR367.addNewULDDetails("ULD2", "prop~CarrierNumericCode", "prop~AWBNo","Pieces","Weight" , "Origin", "Destination", "RcvdPcs","RcvdWt");
			OPR367.handleGeneralAlert("Manifested pieces greater than Stated");
			OPR367.closeTab("OPR367", "Import Manifest");
			
			
			/** Import Manifest Capture manifested pieces is equal to stated pieces**/
            
			customfunctions.searchScreen("OPR367", "Import Manifest");
            OPR367.listFlight("prop~flight_code","prop~flightNo", "flightStartdate");
			libr.waitForSync(6);
			OPR367.addNewULD("ULD2", "prop~CarrierNumericCode", "prop~AWBNo","RcvdPcs","Weight" , "Origin", "Destination", "RcvdPcs","RcvdWt");
			OPR367.SaveDetails();
			OPR367.closeTab("OPR367", "Import Manifest");
