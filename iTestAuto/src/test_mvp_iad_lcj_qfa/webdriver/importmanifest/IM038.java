...
public class IM038 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			FLT003.listNewFlight("FlightNo", "StartDate", "FlightNo");
	        ...
	        /** Creating Flight 2**/
	        cust.createFlight("FullFlightNumber");
			String FullFlightNo2 = cust.getPropertyValue(proppath, "flightNumber");
			map.put("FullFlightNo2", FullFlightNo2);
			map.put("FlightNo2", FullFlightNo2.substring(2));
			System.out.println(FullFlightNo2);
	        excelRead.writeDataInExcel(map, path1, sheetName, testName);
	        
	        /** Flight Creation 2  FLT003**/
			cust.setPropertyValue("flightNumber", cust.data("prop~flight_code")+cust.data("FlightNo2"), proppath);
			cust.searchScreen("FLT003","Maintain Operational Flight");
			FLT003.listNewFlight("FlightNo2", "StartDate", "FlightNo");
			FLT003.enterFlightDetails("Route2", "scheduleType", "Transit", "FCTL", "flightType");
			FLT003.enterLegCapacityDetails("departureTime","arrivalTime", "aircraftType","Configuration_name");
			FLT003.save("FLT003");
			FLT003.close("FLT003");
	        ...
	        /** Creating Flight 3**/
	        cust.createFlight("FullFlightNumber");
			String FullFlightNo3 = cust.getPropertyValue(proppath, "flightNumber");
			map.put("FullFlightNo3", FullFlightNo3);
			map.put("FlightNo3", FullFlightNo3.substring(2));
			System.out.println(FullFlightNo3);
	        excelRead.writeDataInExcel(map, path1, sheetName, testName);
	        
	        /** Flight Creation 3  FLT003**/
			cust.setPropertyValue("flightNumber", cust.data("prop~flight_code")+cust.data("FlightNo3"), proppath);
			cust.searchScreen("FLT003","Maintain Operational Flight");
			FLT003.listNewFlight("FlightNo3", "StartDate", "FlightNo");
			FLT003.enterFlightDetails("Route2", "scheduleType", "Transit", "FCTL", "flightType");
			FLT003.enterLegCapacityDetails("departureTime","arrivalTime", "aircraftType","Configuration_name");
			FLT003.save("FLT003");
			FLT003.close("FLT003");
            ...
            String uldNum3=OPR344.create_uld_number("UldType", "carrierCode");
			...
			cust.searchScreen("MSG005", "MSG005 - List Messages");
			MSG005.loadFromFile("Airline","prop~flight_code", "JMS", "", "Origin", "", "FFM_WithDifferentRouting");
			...
			libr.waitForSync(6);
			map.put("pmkey", cust.data("prop~flight_code")+" - "+cust.data("FlightNo")+" - "+cust.data("Day")+" - "+cust.data("Month").toUpperCase()
					+" - "+cust.data("Origin")+" - "+cust.data("Transit"));
			MSG005.clickCheckBox("pmkey");
			MSG005.clickprocess();
			cust.closeTab("MSG005", "List Message");
            ...
            //Create the message FFFM
			cust.createTextMessage("MessageExcelAndSheetFFM", "MessageParamFFM1");
			cust.searchScreen("MSG005", "MSG005 - List Messages");
			MSG005.loadFromFile("Airline","prop~flight_code", "JMS", "", "Origin", "", "FFM_WithDifferentRouting");
			...
			MSG005.clickList();
			libr.waitForSync(6);
			map.put("pmkey", cust.data("prop~flight_code")+" - "+cust.data("FlightNo2")+" - "+cust.data("Day")+" - "+cust.data("Month").toUpperCase()
					+" - "+cust.data("Transit")+" - "+cust.data("Destination"));
			System.out.println(map.get("pmkey").toString());
			MSG005.clickCheckBox("pmkey");
            ...
            //Create the message FFFM
			cust.createTextMessage("MessageExcelAndSheetFFM", "MessageParamFFM2");
			cust.searchScreen("MSG005", "MSG005 - List Messages");
			MSG005.loadFromFile("Airline","prop~flight_code", "JMS", "", "Origin", "", "FFM_WithDifferentRouting");
			...
			MSG005.clickList();
			libr.waitForSync(6);
			map.put("pmkey", cust.data("prop~flight_code")+" - "+cust.data("FlightNo3")+" - "+cust.data("Day")+" - "+cust.data("Month").toUpperCase()
					+" - "+cust.data("Transit")+" - "+cust.data("Destination"));
			MSG005.clickCheckBox("pmkey");
			MSG005.clickprocess();
			cust.closeTab("MSG005", "List Message");
            ...
            OPR367.verifyBreakdownInstructionsTag("val~Destination ULD");
