...
public class IM124 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
	        ...
	        String pmkey1 = Excel.getCellValue(path1,sheetName, "IM124", "UldNum");
            ...
            cust.searchScreen("OPR367", "Import Manifest");
            OPR367.listFlight("carrierCode","FlightNo","StartDate");
	        String pmkey2 = Excel.getCellValue(path1,sheetName, "IM124", "ULD2");
			...
			/**OPR001- Import documenation AND breakdown complete**/
	        ...
	        /**Import documentaion -FSU-NFD **/
			
			cust.searchScreen("OPR001", "Import Documentation: OPR001");
			OPR001.listDetails(cust.data("prop~flightNo"),cust.data("StartDate"));
			
			//sending FSU-NFD message
			OPR001.clickAWBNumberCheckBox(cust.data("prop~AWBNo"));
			OPR001.clickNotify();
			OPR001.clickFSUNFD();
			OPR001.closeTab("OPR001", "ImportDocumentation_OPR001");
			...
			*//*******Verify FSU-NFD message in MSG005******//*
