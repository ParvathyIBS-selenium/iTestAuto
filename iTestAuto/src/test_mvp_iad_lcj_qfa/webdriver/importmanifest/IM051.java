...
public class IM051 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			libr.waitForSync(1);
			map.put("FullAWBNo1", cust.data("prop~stationCode")+"-"+cust.data("prop~AWBNo"));
			...
			OPR335.listAWB("AWBNo", "prop~CarrierNumericCode"); 
			...
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			libr.waitForSync(6);
			OPR344.addNewULDWithAWB("UldNum","0","prop~CarrierNumericCode","AWBNo1","Pieces","Weight");
			cust.closeTab("OPR344", "Export Manifest");
			cust.searchScreen("OPR344", "Export manifest");
            OPR344.listFlight("prop~flight_code", "FlightNo","StartDate");
			OPR344.addNewULDWithAWBDFetails("ULD2","0","prop~CarrierNumericCode","AWBNo2","Pieces","Weight");
			cust.closeTab("OPR344", "Export Manifest");
			cust.searchScreen("OPR344", "Export manifest");
            OPR344.listFlight("prop~flight_code", "FlightNo","StartDate");
