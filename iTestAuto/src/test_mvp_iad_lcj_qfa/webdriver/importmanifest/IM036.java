...
public class IM036 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR026.provideShipperCode("AgentCode");
			OPR026.provideConsigneeCode("AgentCode");
			...
			OPR026.provideConsigneeCode("shipperCode");
			...
			cust.searchScreen("MSG005", "MSG005 - List Messages");
			MSG005.loadFromFile("Airline","prop~flight_code", "JMS", "", "Origin", "", "FFM_14");
