...
public class IM021 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			customfunctions.setPropertyValue("flightNumber", customfunctions.data("prop~flight_code")+customfunctions.data("FlightNo"), proppath);
			...
			OPR335.listAWB(customfunctions.data("AWBNo"), "prop~CarrierNumericCode"); 
			...
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			libr.waitForSync(6);
			OPR344.addNewULDWithAWB("UldNum","0","prop~CarrierNumericCode","prop~AWBNo","pcs1","wgt1");
			customfunctions.closeTab("OPR344", "Export Manifest");
			customfunctions.searchScreen("OPR344", "Export manifest");
            OPR344.listFlight("prop~flight_code", "FlightNo","StartDate");
			OPR344.addNewULDWithAWBDFetails("ULD2","0","prop~CarrierNumericCode","prop~AWBNo","pcs2","wgt2");
			OPR344.EnterTransactionPcsForSplitAWB("pcs2");
			OPR344.ClickCloseaddNewULDWithAWB();
			customfunctions.closeTab("OPR344", "Export Manifest");
			customfunctions.searchScreen("OPR344", "Export manifest");
	        OPR344.listFlight("prop~flight_code", "FlightNo","StartDate");
			OPR344.addNewULDWithAWB("val~Bulk","0","prop~CarrierNumericCode","prop~AWBNo","pcs3","wgt3");
			OPR344.relist();
            ...
            OPR367.listFlight("prop~flight_code","FlightNo", "flightStartdate");
            map.put("pmkey","BULK");
            OPR367.clickCheckBox("pmkey");
            OPR367.clickBreakDownandBreakdownComplete("Location","pcs1","wgt1");
            OPR367.ClickYesAlert();
            OPR367.closeFromOPR004();
			OPR367.closeTab("OPR367", "Import Manifest");
			
			/**Checking Message Contans P3(pcs1)K30(wgt1)**/
            ...
            MSG005.clickView();
            libr.waitForSync(6);
            MSG005.verifyMessageContent("val~P3K30");
            MSG005.closeTab("MSG005", "MSG005 - List Messages");*/
			
			
			
			
			/** BreakDown For uld no 1**/
			
			
			customfunctions.searchScreen("OPR367", "Import Manifest");
            OPR367.listFlight("prop~flight_code","prop~flightNo", "flightStartdate");
            String pmkey = Excel.getCellValue(path1,sheetName, "IM021", "UldNum");
            OPR367.clickCheckBox_ULD(pmkey);
            OPR367.clickBreakDownandBreakdownComplete("Location","pcs2","wgt2");
            OPR367.ClickYesAlert();
            OPR367.closeFromOPR004();
			OPR367.closeTab("OPR367", "Import Manifest");
			
			/**Checking Message Contans P2(pcs1)K20(wgt1)**/
            ...
            MSG005.clickView();
            libr.waitForSync(6);
            MSG005.verifyMessageContent("val~P2K20");
            MSG005.closeTab("MSG005", "MSG005 - List Messages");*/
            
            
            /** BreakDown For uld no 2**/
			
			
			customfunctions.searchScreen("OPR367", "Import Manifest");
            OPR367.listFlight("prop~flight_code","prop~flightNo", "flightStartdate");
            String pmkey1 = Excel.getCellValue(path1,sheetName, "IM021", "ULD2");
            OPR367.clickCheckBox_ULD(pmkey1);
            OPR367.clickBreakDownandBreakdownComplete("Location","pcs3","wgt3");
            OPR367.ClickYesAlert();
            OPR367.closeFromOPR004();
			OPR367.closeTab("OPR367", "Import Manifest");
			
			/**Checking Message Contans P5(pcs1)K50(wgt1)**/
            ...
            MSG005.clickView();
            libr.waitForSync(6);
            MSG005.verifyMessageContent("val~P5K50");
            MSG005.closeTab("MSG005", "MSG005 - List Messages");*/
