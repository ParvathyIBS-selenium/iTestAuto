...
public class IM081 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           customfunctions.searchScreen("OPR344", "Export manifest");
			...
			OPR337.listFlightBasedOnNilFlightCheckbox("prop~flight_code", "FlightNo","flightStartdate",true);
			int verfColmn[]={1};  
			map.put("FlightNum", customfunctions.data("FlightNo"));
			String[] actVerfValue={customfunctions.data("FlightNum")};
			OPR337.verifyFlightDetails(flightNo, verfColmn, actVerfValue);
