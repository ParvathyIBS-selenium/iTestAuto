...
public class IM049 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Writing the AWB3 in property file
			...
			cust.createTextMessage("MessageExcelAndSheet", "MessageParam1");
			MSG005.loadFromFile("Airline","prop~flight_code", "JMS", "", "Origin", "", "FBL_5");
			...
			//Create the message FBL for AWB3
			...
			OPR026.enterShipmentDetails("Pieces", "Weight","Volume","val~RADIOACTIV", "ShipmentDesc");
			...
			OPR026.provideShipperCode("shipperCode");
			OPR026.provideConsigneeCode("consigneeCode");
			OPR026.enterShipmentDetails("Pieces", "Weight","Volume","val~VACC", "ShipmentDesc");
			OPR026.clickChargesAcc();
			OPR026.provideRatingDetails("rateClass","IATARate","IATAcharge","netCharge");
			OPR026.saveAWB();	
			OPR026.listAWB("prop~AWBNo3", "prop~CarrierNumericCode");
            ...
            //Loose acceptance for AWB3
			cust.searchScreen("OPR335", "Goods Acceptance");
			OPR335.listAWB(cust.data("prop~AWBNo3"), "prop~CarrierNumericCode"); 
            OPR335.looseShipmentDetails("Location", "Pieces","Weight");
            OPR335.addLooseShipment();
            OPR335.allPartsRecieved();
            OPR335.saveAcceptance();
            ...
            OPR367.verifySCCsInULD("UldNum", "CommodityCode");
