...
public class IM044 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
            ...
            /** Adding Special Note and Fwd Suggestion and verifying**/
            ...
            OPR367.clickCheckBox("pmkey");
           	OPR367.verifyForwardSuggestionVal("val~+ Add");
            OPR367.addForwardSuggestionLink();
            OPR367.addZoneBDN();
            OPR367.selectZONE("val~99DUMMY Zone");
            OPR367.SaveDetails();
			OPR367.closeTab("OPR367", "Import Manifest");
            ...
            OPR367.verifyForwardSuggestionValAfterAdd("val~99");
            OPR367.closeTab("OPR367", "Import Manifest");
            
            
            
            /** Editing Special Note and Fwd Suggestion and verifying**/
            
			cust.searchScreen("OPR367", "Import Manifest");
            OPR367.listFlight("prop~flight_code","prop~flightNo", "StartDate");
            OPR367.clickEditSpecialNote();
            OPR367.clickSpecialNoteRadioButtonFromList("val~Ramp Delivery");
            OPR367.SaveDetails();
			OPR367.closeTab("OPR367", "Import Manifest");
			...
			cust.searchScreen("OPR367", "Import Manifest");
            OPR367.listFlight("prop~flight_code","prop~flightNo", "StartDate");
            OPR367.clickEditFWDSuggestion();
            OPR367.addZoneBDN();
            OPR367.updateZONE("Location");
            OPR367.SaveDetails();
			OPR367.closeTab("OPR367", "Import Manifest");
			...
			cust.searchScreen("OPR367", "Import Manifest");
            OPR367.listFlight("prop~flight_code","prop~flightNo", "StartDate");
            OPR367.verifySpecialNoteAfterAdd("val~Ramp Delivery");
            OPR367.verifyForwardSuggestionValAfterAdd("Location");
            OPR367.closeTab("OPR367", "Import Manifest");
		}	
		catch(Exception e)
		{
