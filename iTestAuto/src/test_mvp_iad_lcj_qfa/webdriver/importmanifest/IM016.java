...
public class IM016 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           /** Process the message **/
			...
			System.out.println(customfunctions.data("UldNum"));
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			libr.waitForSync(6);
			...
			System.out.println(customfunctions.data("UldNum1"));
			libr.waitForSync(6);
			OPR344.addNewULDWithAWB("UldNum1","0","prop~CarrierNumericCode","AWBNo1","Pieces","Weight");
			OPR344.closeTab("OPR344", "Export manifest");
			...
			System.out.println(customfunctions.data("UldNum2"));
			libr.waitForSync(6);
			OPR344.addNewULDWithAWB("UldNum2","0","prop~CarrierNumericCode","AWBNo3","Pieces","Weight");
			OPR344.closeTab("OPR344", "Export manifest");
            ...
            OPR367.clickCheckBox_ULD(customfunctions.data("UldNum"));
	        OPR367.clickBreakdownButton();
	        OPR367.selectIntactCheckbox();
			...
			customfunctions.searchScreen("OPR367", "Import Manifest");
            OPR367.listFlight("carrierCode","FlightNo","StartDate");
            OPR367.clickCheckBox_ULD(customfunctions.data("UldNum1"));
	        OPR367.clickBreakdownButton();
			...
			OPR367.clickCheckBox_ULD(customfunctions.data("UldNum2"));
