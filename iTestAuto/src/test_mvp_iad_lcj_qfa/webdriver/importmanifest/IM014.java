...
import screens.ImportFlightEnquiry_OPR008;
...
public class IM014 extends BaseSetup {
	...
	public ImportFlightEnquiry_OPR008 OPR008;
	...
	public void setup() {
		...
		OPR008=new ImportFlightEnquiry_OPR008(driver, excelreadwrite, xls_Read);
	}
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           /** Process the message **/
			...
			/***Import Flight enquiry****/ 
			customfunctions.searchScreen("OPR008", "Import Flight Enquiry");
			OPR008.listFlight("prop~flight_code", "FlightNo","flightStartdate");
			OPR008.verifyBULKShipmentSummary();
			OPR008.verifyULDShipmentSummary();
			String pmKey="Manifest";
			map.put("pmKey", pmKey);
			int verfColmn[]={1};   
			String[] actVerfValue={"Manifest"};
			OPR008.verifyFlightDetails(verfColmn, actVerfValue,pmKey);
			customfunctions.closeTab("OPR008","Import Flight Enquiry");
		}	
		catch(Exception e)
		{
