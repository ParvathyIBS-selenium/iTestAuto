...
public class IM048 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           /** Process the message **/
            ...
            OPR367.verifySCCsForShipment("UldNum", "SCC1");
            OPR367.verifySCCsForShipment("UldNum", "SCC2");
            OPR367.verifySCCsForShipment("UldNum", "SCC3");
			...
			//Checking AWB 4 is fresh or Not
			
			customfunctions.searchScreen("OPR026","Capture AWB");
			OPR026.checkAWBExists_OPR026("Capture Awb", "OPR026");
			String AWBNo4 = WebFunctions.getPropertyValue(proppath,"AWBNo");
			map.put("AWBNo4", AWBNo4);
			System.out.println(customfunctions.data("AWBNo4"));

			libr.waitForSync(1);
			
			
            //Writing the full AWB No to property file
			customfunctions.setPropertyValue("FullAWBNo4", customfunctions.data("prop~stationCode")+"-"+customfunctions.data("prop~AWBNo"), proppath);
			customfunctions.setPropertyValue("FullAWBNo", customfunctions.data("prop~stationCode")+"-"+customfunctions.data("prop~AWBNo"), proppath);   
			...
			/**** OPR339 - Security & Screening  for AWB4****/
			...
			/** Capture AWB Details AWB4**/
			customfunctions.searchScreen("OPR026","Capture AWB");
			OPR026.listAWB("AWBNo4", "prop~CarrierNumericCode");
			OPR026.updateOrigin("Origin");
			OPR026.updateDestination("Destination");
			OPR026.enterRouting("Destination","carrierCode");	
			OPR026.selectSCI("SCI");
			...
			OPR026.provideShipperCode("shipperCode");
			OPR026.provideConsigneeCode("consigneeCode");
			OPR026.enterShipmentDetails("Pieces", "Weight","Volume","CommodityCode3", "ShipmentDesc3");
			OPR026.clickChargesAcc();
			OPR026.provideRatingDetails("rateClass","IATARate","IATAcharge","netCharge");
			OPR026.clickBookingDetails();
			OPR026.enterBookingDetailsSingleLeg("Origin", "Destination", "prop~flightNumber", "StartDate", "Pieces", "Weight", "Volume");
           ...
           /*******MSG005 - List Messages*******/
            ...
            //Create the message FFM
            customfunctions.createTextMessage("MessageExcelAndSheet1", "MessageParamFFM1");
            customfunctions.searchScreen("MSG005", "MSG005 - List Messages");
			MSG005.loadFromFile("Airline","prop~flight_code", "JMS", "", "Origin", "", "FFM_1ULD4SHIPMENTS");
			...
			customfunctions.searchScreen("OPR367", "Import Manifest");
            OPR367.listFlight("prop~flight_code","prop~flightNo", "StartDate");
            OPR367.verifySCCsForShipment("UldNum", "SCC4");
			OPR367.closeTab("OPR367", "Import Manifest");
