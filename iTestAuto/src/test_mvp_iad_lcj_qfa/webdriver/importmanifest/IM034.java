...
public class IM034 extends BaseSetup {
	
	/********** IM_041 is also clubbed*****/
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
            ...
            map.put("pmkey","UldNum");
            OPR367.clickCheckBox("pmkey");
            OPR367.verifyClearingAgentName("val~FAST FORWARD FREIGHT VOF");
			OPR367.closeTab("OPR367", "Import Manifest");
