...
public class IM019 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           /** Process the message **/
            ...
            OPR344.listFlight("carrierCode", "FlightNo","StartDate");
			libr.waitForSync(6);
			OPR344.addAWBtoExistingULD("UldNum","prop~CarrierNumericCode","AWBNo1","Pieces","Weight");
			OPR344.closeTab("OPR344", "Export manifest");
			
			customfunctions.searchScreen("OPR344", "Export manifest");
            OPR344.listFlight("carrierCode", "FlightNo","StartDate");
			libr.waitForSync(6);
			OPR344.addAWBtoExistingULD("UldNum","prop~CarrierNumericCode","AWBNo3","Pieces","Weight");
			OPR344.closeTab("OPR344", "Export manifest");
			...
			//Breakdown to different warehouse locations
			...
			OPR367.enterBreakdownInDifferentLoc(3,"01,0111,0112");
