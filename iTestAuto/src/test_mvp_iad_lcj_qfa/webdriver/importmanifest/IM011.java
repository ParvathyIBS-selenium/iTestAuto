...
public class IM011 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           /** Create the message FBL for AWB 2 **/
            ...
            /** Import Manifest :Modifying shipment details **/
            ...
            OPR367.clickModify();
            OPR367.modifyDetails("RcvdPcs","RcvdWt");
            OPR367.maximizeAllDetails();
            OPR367.verifyManifestedDetails("RcvdPcs","RcvdWt", "Pieces","Weight");
            OPR367.SaveDetails();
            OPR367.closeTab("OPR367", "Import Manifest");
			...
			customfunctions.setPropertyValue("FullAWBNo", customfunctions.data("prop~stationCode")+"-"+customfunctions.data("prop~AWBNo"), proppath);
			String FullAWBNo3 = WebFunctions.getPropertyValue(proppath,"FullAWBNo");
			map.put("AWBNo3", AWBNo3);
			map.put("FullAWBNo6", FullAWBNo3);
			libr.waitForSync(1);
			...
			customfunctions.searchScreen("OPR367", "Import Manifest");
            OPR367.listFlight("prop~flight_code","prop~flightNo", "flightStartdate");
            String pmKeyULD=customfunctions.data("UldNum");
            OPR367.clickCheckBox_ULD(pmKeyULD);
            OPR367.clickModify();
            OPR367.addNewAWBtoExistingULD("prop~CarrierNumericCode","AWBNo3","RcvdPcs","RcvdWt" , "Origin", "Destination", "RcvdPcs","RcvdWt");
            OPR367.SaveDetails();
            OPR367.closeTab("OPR367", "Import Manifest");
