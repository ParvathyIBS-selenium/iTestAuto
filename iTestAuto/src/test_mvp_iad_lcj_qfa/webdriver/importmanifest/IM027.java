...
public class IM027 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
	        ...
	        customfunctions.setPropertyValue("flightNumber2", customfunctions.data("CarrierCode2")+customfunctions.data("FlightNo2"), proppath);
	        customfunctions.searchScreen("FLT005", "FLT005 - Maintain Flight Schedule");
           ...
           /** Process the message **/
            ...
            /** Create the message FFM bulk BultUp **/
            
			customfunctions.createTextMessage("MessageExcelAndSheetFFM", "MessageParam1");
			customfunctions.searchScreen("MSG005", "MSG005 - List Messages");
			MSG005.loadFromFile("Airline","prop~flight_code", "JMS","", "Origin", "", "FFM_1LOOSE");
           ...
           /** Process the message **/
            ...
            libr.waitForSync(6);      
            map.put("pmkey", customfunctions.data("prop~flight_code")+" - "+customfunctions.data("FlightNo")+" - "+customfunctions.data("Day")+" - "+customfunctions.data("Month").toUpperCase()
                              +" - 1600 - "+customfunctions.data("Origin")+" - "+customfunctions.data("Transit"));
            MSG005.clickCheckBox("pmkey");
            MSG005.clickprocess();
            libr.waitForSync(5);
