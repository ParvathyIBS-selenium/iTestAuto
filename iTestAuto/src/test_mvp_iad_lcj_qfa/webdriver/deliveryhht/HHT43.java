...
public class HHT43 extends BaseSetup {
	...
	public MarkFlightMovements_FLT006 FLTOO6;
	...
	public void setup() {
		...
		FLTOO6 = new MarkFlightMovements_FLT006(driver, excelreadwrite, xls_Read);
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Capture ATA and ATD details
			cust.searchScreen("FLT006", "Mark Flight Movements");
			FLTOO6.listFlight("prop~flightNo", "StartDate");
			FLTOO6.clickFlightMovementArrivalDetailsLink();
			FLTOO6.clickFlightMovementDepartureDetailsLink();
			FLTOO6.clickSave();
			FLTOO6.close("FLT006");
            ...
            String pmkey = Excel.getCellValue(path1,sheetName, "HHT43", "UldNum");
			...
			/** Delivery HHT **/
			//Perform delivery in HHT by listing with AWB Number
