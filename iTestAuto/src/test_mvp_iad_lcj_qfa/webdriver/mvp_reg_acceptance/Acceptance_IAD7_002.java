...
/**
 * Loose Transhipments with partial acceptance

 **/
public class Acceptance_IAD7_002 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/**** OPR335 -Goods Acceptance****/
			//trans shipments with partial acceptance
			...
			/*******Verify XFSU-FOH message not triggered in MSG005******/
