...
/**
 * 
 * Verify the capacity consumption after cancelling existing booking
 *
 */
	...
	public void getTestSuite(Map<Object, Object> map) throws InterruptedException {
		...
		try {
           ...
           /** SHR003 - Maintain Aircraft Type- Take aircraft capacity **/
			...
			customfunctions.searchScreen("CAP018", "Maintain Booking");
			CAP018.checkAWBExists_CAP018("Maintain Booking", "CAP018","AWBNo2");

			// Writing the full AWB No
			customfunctions.setPropertyValue("FullAWBNo", customfunctions.data("CarrierNumericCode") + "-" + customfunctions.data("prop~AWBNo"),proppath);
			map.put("FullAWBNo2", customfunctions.data("prop~FullAWBNo"));
			map.put("AWBNo2", customfunctions.data("prop~AWBNo2"));
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			
			/** CAP018 - Maintain Booking2**/

			customfunctions.searchScreen("CAP018", "Maintain Booking");
			CAP018.listAwb("prop~AWBNo2");
			//Enter shipment details
			CAP018.enterShipmentDetails("Origin", "Destination",  "AgentCode", "ShipmentDate");
			//Enter shipment level details
			CAP018.enterShipmentLevelDetails("CommodityCode", "Pieces", "Weight", "Volume");
			...
			String flightNo1[]={"FullFlightNo"};
			String fltDate1[]={"flightDate"};
			String pcs1[]={"Pieces"};
			String wt1[]={"Weight"};
			String vol1[]={"Volume"};
			CAP018.enterFlightLevelDetails(1, origin1, destination1, flightNo1, fltDate1, pcs1, wt1, vol1, true,"val~Confirm");
			CAP018.saveBookingDetails("Confirmed");
			...
			map.put("totalWeight", String.valueOf(Integer.parseInt(customfunctions.data("Weight"))*2));
			map.put("totalVol", String.valueOf(Integer.parseInt(customfunctions.data("Volume"))*2));
			...
			CAP147.verifyDepletionDetailsAfterFSBooking(customfunctions.data("AircraftWgt"),customfunctions.data("AircraftVol"),customfunctions.data("totalWeight"),customfunctions.data("totalVol"));
			
			customfunctions.closeTab("CAP147", "Monitor Flights");


			/** Cancel booking1 on CAP018**/

			customfunctions.searchScreen("CAP018", "Maintain Booking");
			CAP018.listAwb("prop~AWBNo");
		    CAP018.clickcancelbooking();
			CAP018.captureirregularitydetails("irregularity","irregularityremark");
			
			//verify the status as cancelled
			CAP018.verifyBkgStatus("val~Cancelled");
			customfunctions.closeTab("CAP018", "Maintain Booking");
           ...
           /** CAP147 -Monitor Flights**/ 
			...
			CAP147.listFlight("carrierCode", "FlightNo", "flightDate");
			CAP147.clickViewCapacitySummary();
			CAP147.verifyDepletionDetailsAfterFSBooking(customfunctions.data("AircraftWgt"),customfunctions.data("AircraftVol"),"0","0");
			customfunctions.closeTab("CAP147", "Monitor Flights");
		}	
		catch(Exception e)
		{
