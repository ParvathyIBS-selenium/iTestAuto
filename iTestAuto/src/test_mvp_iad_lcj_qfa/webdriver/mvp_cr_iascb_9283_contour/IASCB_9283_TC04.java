...
public class IASCB_9283_TC04 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String pmKeyXFWB1=cust.data("prop~CarrierNumericCode")+" - "+cust.data("prop~AWBNo2")+" - "+cust.data("Origin")+" - "+cust.data("Transit");
			int verfColsXFWB[]={9};
