package mvp_cr_iascb_9283_contour;
...
/**Capture ULD Contour and Overhang/Intend details for Pallet with Multiple Shipments**/
public class IASCB_9283_TC02 extends BaseSetup {
	...
	String sheetName="mvp_cr_iascb_9283_contour";
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String pmKeyXFWB1=cust.data("prop~CarrierNumericCode")+" - "+cust.data("prop~AWBNo2")+" - "+cust.data("Origin")+" - "+cust.data("Destination");
			int verfColsXFWB[]={9};
			...
			map.put("awbNumber1", cust.data("CarrierNumericCode")+cust.data("prop~AWBNo2"));
			...
			String pmKeyPRE1=cust.data("CarrierNumericCode")+" - "+cust.data("prop~AWBNo2");
			int verfColsPRE[]={9};
			...
			String pmKeyRCS1=cust.data("CarrierNumericCode")+" - "+cust.data("prop~AWBNo2");
			int verfColsRCS[]={9};
			...
			/********** CHECKING IF FSU-MAN GOT TRIGGERD****/
			cust.searchScreen("MSG005", "MSG005 - List Messages");
			MSG005.enterMsgType("XFSU");
			MSG005.selectMsgSubType("Manifest Details");
			MSG005.clickList();
			String pmKeyMAN1=cust.data("prop~CarrierNumericCode")+" - "+cust.data("prop~AWBNo");
			String pmKeyMAN2=cust.data("prop~CarrierNumericCode")+" - "+cust.data("prop~AWBNo2");
			int verfColsMAN[]={9};
			String[] actVerfValuesMAN={"Sent"};
			MSG005.verifyMessageDetails(verfColsMAN, actVerfValuesMAN, pmKeyMAN1,"val~XFSU-MAN",false);
			MSG005.verifyMessageDetails(verfColsMAN, actVerfValuesMAN, pmKeyMAN2,"val~XFSU-MAN",false);
			libr.waitForSync(2); 
			MSG005.closeTab("MSG005", "MSG005 - List Messages");
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyXFFM=cust.data("prop~flight_code")+" - "+cust.data("FlightNo")+" - "+cust.data("Day")+" - "+cust.data("Month").toUpperCase()
					+" - "+cust.data("Origin");
			System.out.println(pmKeyXFFM);
			int verfColsXFFM[]={9};
			String[] actVerfValuesXFFM={"Sent"};
			MSG005.verifyMessageDetails(verfColsXFFM, actVerfValuesXFFM, pmKeyXFFM,"val~XFFM",false);
			libr.waitForSync(1); 
			/*** VERIFY THE MESSAGE CONTENTS***/
			map.put("pmkey", pmKeyXFFM);
			MSG005.clickCheckBox("pmkey");
			MSG005.clickView();
			List <String> msgContents=new ArrayList<String>();
			/**Contour**/

			msgContents.add("val~<LoadingRemark>"+"W-"+cust.data("UldWeight")+" C-"+cust.data("Contour")+" "+"</LoadingRemark>");
			//Verify message contents
			MSG005.verifyMessageContent(msgContents,"XFFM");
			MSG005.closeView();
