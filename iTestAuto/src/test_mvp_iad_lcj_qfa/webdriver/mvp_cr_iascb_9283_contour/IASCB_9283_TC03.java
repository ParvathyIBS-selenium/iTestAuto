...
public class IASCB_9283_TC03 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			FlightNum = FlightNum.replace(cust.data("prop~flight_code"),
					cust.data("carrierCode"));
			...
			map.put("FWBDate", cust.createDateFormat("ddMMMyy", 0, "DAY", "")
					.toUpperCase());
			String flightdate1 = cust.createDateFormat("yyyy-MM-dd", 0, "DAY",
					"");
			map.put("XFWBDate", flightdate1);
			map.put("FBLDate3", cust
					.createDateFormat("ddMMMyyyy", 0, "DAY", "").toUpperCase());
			...
			/***MESSAGE - loading ASM for flight 1**/
			...
			/************ LOADING XFBL MESSAGE VIA CGOCXML***/
			//Relaunch browser
			driver=libr.relaunchBrowser("chrome");
			// Login to "CGOCXML"
			...
			OPR339.enterScreeningDetails("ScreeningMethod", "Pieces", "Weight",
					"val~Pass");
			...
			MSG005.clickList();
			String pmKeyXFWB = cust.data("prop~CarrierNumericCode") + " - "
					+ cust.data("prop~AWBNo") + " - " + cust.data("Origin")
					+ " - " + cust.data("Destination");
			int verfColsXFWB[] = { 9 };
			String[] actVerfValuesXFWB = { "Sent" };
			MSG005.verifyMessageDetails(verfColsXFWB, actVerfValuesXFWB,
					pmKeyXFWB, "val~XFWB", true);
			libr.waitForSync(1);
			...
			OPR063.verifyULDLoadingInstuctorPopUp("FlightNo", "UldNum","Contour","Front","Rear","Left","Right");
			...
			/************* DEADLOAD STATEMENT****************/
			cust.searchScreen("OPR063", "Dead load statement");
			OPR063.listFlightDetails("carrierCode","FlightNo2","StartDate");
			OPR063.selectULD(cust.data("UldNum1"));
			OPR063.enterActualWeightOfUld("UldWeight");
			OPR063.clickSave();
			OPR063.selectULD(cust.data("UldNum1"));
			OPR063.clickULDLoadingInstuctor();
			OPR063.verifyULDLoadingInstuctorPopUp("FlightNo2", "UldNum1","Contour","Front","Rear","Left","Right");
			OPR063.ULDLoadingInstructionOK();
			cust.closeTab("OPR063", "Dead load statement");
			...
			MSG005. verifyMessageDetails(verfColsFUM,actVerfValuesFUM, pmKeyFUM1,"val~xFUM",false);
			libr.waitForSync(1);
			MSG005.closeTab( "MSG005","MSG005 - List Messages");	
