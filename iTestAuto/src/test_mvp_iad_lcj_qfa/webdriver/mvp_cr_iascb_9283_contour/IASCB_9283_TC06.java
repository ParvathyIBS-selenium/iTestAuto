...
/**Verify the compatibility between the Selected Contour Code and Air craft configuration of the Flight**/
...
public class IASCB_9283_TC06 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cust.createXMLMessage("MessageExcelAndSheetXFWB",
					"MessageParamXFWB");

			String sccs[] = { cust.data("SCC").split(",")[0] };
			...
			//Assign the Incompactable ULD Contour code and verify system shouldn't allow user to save
			buhht.captureInvalidContour(cust.data("Contour"));
			cust.clickBack("Select Item");
			//Select valid contour
			...
			MSG005.clickList();
			String
			pmKeyRCS=cust.data("CarrierNumericCode")+" - "+cust.data("prop~AWBNo");
			int verfColsRCS[]={9};
			String[] actVerfValuesRCS={"Sent"};
			MSG005.verifyMessageDetails(verfColsRCS, actVerfValuesRCS,
					pmKeyRCS,"val~XFSU-RCS",false);
			libr.waitForSync(1);
