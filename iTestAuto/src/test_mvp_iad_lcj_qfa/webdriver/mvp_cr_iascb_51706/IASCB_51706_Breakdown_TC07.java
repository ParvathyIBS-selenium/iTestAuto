 ...
 * application based on (X)FFM Processed
 **/

public class IASCB_51706_Breakdown_TC07 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String pmkey = Excel.getCellValue(path1, sheetName, "IASCB_51706_Breakdown_TC07", "UldNum");
