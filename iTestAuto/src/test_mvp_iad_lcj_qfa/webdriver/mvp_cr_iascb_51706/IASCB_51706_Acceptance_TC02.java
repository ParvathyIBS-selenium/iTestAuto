...
/** Test Case Name : Capture Goods Acceptance details from web application for Split Shipment **/
...
public class IASCB_51706_Acceptance_TC02 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR335.addLooseShipmentDetails(pcs[0],sccs[0],locs[0]);
			OPR335.selectSCC(2,0);
			OPR335.addLooseShipment();
			OPR335.addLooseShipmentDetails(pcs[1],sccs[1],locs[1]);
