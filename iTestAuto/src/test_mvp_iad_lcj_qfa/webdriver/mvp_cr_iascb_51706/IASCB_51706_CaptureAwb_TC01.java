...
/**
 * Test Case Name : Verify Split Shipment button should be enabled after
 * Processing (X)FWB in Capture AWB Screen
 **/

public class IASCB_51706_CaptureAwb_TC01 extends BaseSetup {
