...
/**
 * Verify user can able to capture Partial pieces of the AWB as Split Shipment
 * from Goods Acceptance screen for Part Booking
 **/
...
public class IASCB_51706_Acceptance_TC04 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String shipment[] = { libr.data("prop~FullAWBNo") + ";" + cust.data("Pieces2") + ";" + cust.data("Weight2")
            ...
            String shipmentDetails1=cust.data("Pieces2")+";"+cust.data("Weight2")+";"+cust.data("Volume2")+";"+cust.data("ShipmentDesc2");
			...
			/********** CHECKING IF FSU-FOH GOT TRIGGERD ****/

			cust.searchScreen("MSG005", "MSG005 - List Messages");
			MSG005.enterMsgType("XFSU");
			MSG005.selectMsgSubType("Freight On Hand");
			MSG005.clickList();
			String pmKeyFOH = cust.data("prop~CarrierNumericCode") + " - " + cust.data("prop~AWBNo");
			int verfColsFOH[] = { 9 };
