...
/**
 * Verify System should validate the Split Shipment Pieces against the Stated
 * Pieces in Split Shipment Pop up
 **/
public class IASCB_51706_CaptureAwb_TC06 extends BaseSetup {
	...
	@DataProvider(name = "IASCB_51706_CaptureAwb_TC06")
	...
	@Test(dataProvider = "IASCB_51706_CaptureAwb_TC06")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			// Provide split pieces more than stated pieces and verify system
			// should show validation
			String pcs[] = { libr.data("SplitPcs2").split(",")[0], libr.data("SplitPcs2").split(",")[1] };
			OPR026.splitShipmentWithSCCWithInvalidSplitPcs(libr.data("SCC2"), pcs,
					"The total stated pieces of all split shipments should be same as stated piece of the shipment");
			// Provide split pieces equal to stated pieces and verify user is
			// able to save
			...
			String modifiedPcs[] = { libr.data("SplitPcs3").split(",")[0], libr.data("SplitPcs3").split(",")[1] };
