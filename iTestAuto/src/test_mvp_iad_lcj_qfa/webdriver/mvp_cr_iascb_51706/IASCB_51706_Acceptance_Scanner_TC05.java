...
public class IASCB_51706_Acceptance_Scanner_TC05 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR339.listAWB("prop~AWBNo", "CarrierNumericCode","OPR339 - Security & Sceening");
			...
			gahht.updateShipment(libr.data("SCC").split(",")[0]);
			gahht.updateSplitPcsandWgt(pcsinfo[0]);
			
	
			gahht.updateShipment(libr.data("SCC").split(",")[2]);
			gahht.updateSplitPcsandWgt(pcsinfo[1]);
			
			gahht.updateShipment(libr.data("SCC").split(",")[3]);
			gahht.updateSplitPcsandWgt(pcsinfo[2]);
			
			gahht.selectSplitSCCValue(libr.data("SCC").split(",")[0]+" +");
			gahht.selectSplitSCCValue(libr.data("SCC").split(",")[2]);
			gahht.selectSplitSCCValue(libr.data("SCC").split(",")[3]);
