...
public class IASCB_51706_Breakdown_Scanner_TC02 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			bdhht.selectSplitSCCValue(libr.data("SCC2").split(",")[0]);
			bdhht.selectSplitSCCValue(libr.data("SCC2").split(",")[1]);
