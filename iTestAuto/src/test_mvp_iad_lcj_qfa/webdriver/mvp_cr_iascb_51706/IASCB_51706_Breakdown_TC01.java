...
/** Test Case Name : Verify new page for Split Shipment information in iCargo web application Breakdown Screen **/

public class IASCB_51706_Breakdown_TC01 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/*** MESSAGE - loading XFFM needs to be load from CGOCXML ****/
			...
			String pmkey = Excel.getCellValue(path1,sheetName, "IASCB_51706_Breakdown_TC01", "UldNum");
            ...
            OPR004.listFlightAndULD("UldNum", "prop~flight_code", "prop~flightNo", "StartDate");
            String[] Pieces={cust.data("SplitPcs").split(",")[0],cust.data("SplitPcs").split(",")[1]};
			String[] Weight={cust.data("Weight2"),cust.data("Weight1")};
			OPR004.verifySplitShipmentInfo(2,Pieces,Weight,sccs);
			OPR367.closeTab("OPR004", "Breakdown");
