...
/**
 * Test Case Name : Capture Breakdown details for Split Shipment from iCargo web
 * application
 **/

public class IASCB_51706_Breakdown_TC02 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String pmkey = Excel.getCellValue(path1, sheetName, "IASCB_51706_Breakdown_TC02", "UldNum");
			...
			cust.switchToFrame("contentFrame", "OPR367");
			...
			MSG005.verifyMessageDetails(verfColsRCF, actVerfValuesRCF, pmKeyRCF, "val~XFSU", false);
			libr.waitForSync(1);
