...
/** Test Case Name : Verify Split Shipment information in iCargo web application Goods Acceptance Screen **/

public class IASCB_51706_Acceptance_TC01 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR335.verifySplitShipment(cust.data("SCC").split(",")[0]);
			OPR335.verifySplitShipment(cust.data("SCC").split(",")[1]);
