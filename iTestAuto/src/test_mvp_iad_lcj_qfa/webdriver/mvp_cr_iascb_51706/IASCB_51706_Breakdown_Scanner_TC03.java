...
public class IASCB_51706_Breakdown_Scanner_TC03 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String scc[] = { cust.data("SCC").split(",")[0],cust.data("SCC").split(",")[1],cust.data("SCC").split(",")[2],cust.data("SCC").split(",")[3] };
