...
/** Test Case Name : Verify System shouldn't show storage typology field for AMS(KL) Station **/

public class IASCB_51706_Acceptance_Scanner_TC08 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("AgentStreetName", WebFunctions.getPropertyValue(custproppath, "cashCustomerstreetName_NL"));
			map.put("AgentCityName", WebFunctions.getPropertyValue(custproppath, "cashCustomercityName_NL"));
			map.put("AgentCountryId", WebFunctions.getPropertyValue(custproppath, "cashCustomercountryId_NL"));
			map.put("AgentCountryName", WebFunctions.getPropertyValue(custproppath, "cashCustomercountryName_NL"));
			...
			//gahht.verifyNoStorageTypology(libr.data("SCC2").split(",")[0]);
