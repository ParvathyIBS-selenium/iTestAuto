...
/**
 * Test Case Name : Capture one or more SCC for same row in Split Shipment Pop
 * up from Capture AWB Screen
 **/

public class IASCB_51706_CaptureAwb_TC05 extends BaseSetup {
	...
	@DataProvider(name = "IASCB_51706_CaptureAwb_TC05")
	...
	@Test(dataProvider = "IASCB_51706_CaptureAwb_TC05")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR026.verifySplitShipmentWithSCC(libr.data("SCC2"), pcs);
