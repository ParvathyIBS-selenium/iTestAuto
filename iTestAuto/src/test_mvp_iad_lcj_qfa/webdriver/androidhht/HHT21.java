...
public class HHT21 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/*** HHT - Build Up List****/
			//Verify AWBNo, AWB Count, Pieces, Weight, Origin,Destination,SCC
			...
			bulhht.verifyAWB("AWBNumber");
			bulhht.verifyAWBCount("1");
			bulhht.verifyPiecesAndWeight("Pieces", "Weight");
			bulhht.verifyOriginAndDestination("AWBNumber","Origin", "Destination");
			bulhht.verifySCC("CommodityCode","AWBNumber");
			libr.quitApp();
