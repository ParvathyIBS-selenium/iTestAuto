...
public class HHT65 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			bmhht.enterRemarks("val~Automation Test Remarks");
			bmhht.clickSave();
			libr.quitApp();
			...
			//Check the Block is captured or not
			cust.searchScreen("OPR023", "AWB Clearance");
			OPR023.listAWB("prop~CarrierNumericCode", "prop~AWBNo");
			int[] verfCols={8};
			String[] actVerfValues={"Blocked"};
			OPR023.verifyBlockDetails(verfCols, actVerfValues,"Damage");
