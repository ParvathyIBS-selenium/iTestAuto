...
public class HHT05 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			sechht.enterValue("awbNumber");
			sechht.selectScreeningMethod("Metal Detection Equipment");
			sechht.enterScreeningDetails("Pieces2");
			sechht.enterScreeningStatus("Pass");
			sechht.saveScreeningDetails();
			sechht.enterValue("awbNumber");
			sechht.verifyScreeningStatus("Completed");
			sechht.verifyScreeningHistoryDetails("X-ray equipment","PASS");
			sechht.verifyScreeningHistoryDetails("Metal Detection Equipment","PASS");
			libr.quitApp();
