...
public class HHT64 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			bmhht.verifyShipment("awbNumber");
			cust.clickBack("Block Management");
			
			bmhht.invokeBlockManagementScreen();
			bmhht.enterValue("ULDNo");
			bmhht.updateFlightDetails("prop~flight_code", "prop~flightNo","currentDay");
			bmhht.verifyShipment("awbNumber");
			cust.clickBack("Block Management");
