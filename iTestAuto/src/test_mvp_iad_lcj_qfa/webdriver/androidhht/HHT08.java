...
public class HHT08 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			gahht.verifyAcceptedPiecesWeight("Pieces", "Weight");
			gahht.verifyOriginAndDestination("prop~FullAWBNo", "Origin", "Destination");
			gahht.verifySCC("prop~FullAWBNo", "CommodityCode");
			libr.quitApp();
