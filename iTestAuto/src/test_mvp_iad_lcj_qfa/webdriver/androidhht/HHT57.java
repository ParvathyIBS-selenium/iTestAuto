...
import screens.DimensionCaptureHHT;
...
public class HHT57 extends BaseSetup {
	...
	public DimensionCaptureHHT dimhht;
	...
	public void setup() {
		...
		dimhht=new DimensionCaptureHHT(driver, excelreadwrite, xls_Read);
	...
	public void getTestSuite(Map<Object, Object> map) {
       ...
       /****OPR355 - Goods Acceptance****/
			...
			dimhht.invokeDimensionCaptureScreen();
		/***** ENTER 1st SET OF DATA****/
			dimhht.enterValue("awbNumber");
			dimhht.enterDimensionDetails("Pieces2", "Weight2", "Dimension");
			dimhht.saveDetails();
			
			/***** ENTER 2nd SET OF DATA****/
			dimhht.enterValue("awbNumber");
			dimhht.enterDimensionDetails("Pieces2", "Weight2", "Dimension");
			dimhht.saveDetails();
