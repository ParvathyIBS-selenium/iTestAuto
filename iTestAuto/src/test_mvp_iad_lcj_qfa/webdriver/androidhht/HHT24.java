...
public class HHT24 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/*** HHT - Build Up List****/
			//Select ULD and click build up and verify its navigating to build up screen
			...
			bulhht.clickBuildUp();	
			bulhht.verifyHHTScreenName("Build Up");
			cust.clickBack("Build Up");
			//Click Assign and click Task complete button from more options			
			bulhht.clickMoreOptions();
			bulhht.clickAssign();
			bulhht.clickMoreOptions();
			bulhht.clickTaskComplete();			
			libr.quitApp();
