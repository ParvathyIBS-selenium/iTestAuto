...
public class HHT229 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws Exception 
	{
		...
		try {
			...
			/********SHR048 - Maintain and list system parameter***/
			cust.searchScreen("SHR048", "SHR048 - Maintain And List System Parameter");
			SHR048.listParameter("operations.shipment.sccexcludedforsegregatedcheckin");
			String SCCs = SHR048.getParameterValue();
			cust.closeTab("SHR048", "Maintain And List System Parameter");
			...
			OPR026.compareSCCs(SCCs,"SCC");
			String SCCValue = cust.data("SCC");
			OPR026.enterSCC(SCCValue);
			OPR026.asIsExecute();
			cust.closeTab("OPR026", "Capture AWB");
			
			/*******SHR006 - Maintain Airport******/
			//Enable "Enable special SCC capture for SU and PLT" parameter
			cust.searchScreen("SHR006", "SHR006 - Maintain Airport");
			SHR006.listAirport("Origin");			
			SHR006.filterParameterBasedOnvalue("val~Enable special SCC capture for SU and PLT");
			String oldValue = SHR006.getEnableSCCParameterValue();
			map.put("oldValue", oldValue);
			SHR006.changeEnableSCCParameterValuetoY();
			cust.closeTab("SHR006", "Maintain Airport");			
			...
			offloadhht.enterAWBNumber("awbNumber");
			offloadhht.enterStorageUnit("val~05710001");
			offloadhht.enterPiecesAndWeight("Pieces", "Weight");
			offloadhht.selectOffloadReasons("Due Payload");
			offloadhht.clickSave();
			offloadhht.clickCON002();
			libr.quitApp();
		...
		finally
		{
			...
			/*******SHR006 - Maintain Airport******/
			//Disable "Enable special SCC capture for SU and PLT" parameter
			cust.searchScreen("SHR006", "SHR006 - Maintain Airport");
			SHR006.listAirport("Origin");
			SHR006.filterParameterBasedOnvalue("val~Enable special SCC capture for SU and PLT");
			SHR006.changeEnableSCCParameterValue(cust.data("oldValue"));
			cust.closeTab("SHR006", "Maintain Airport");
		}
