...
public class HHT133 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			buhht.enterBuildUpdetails("awbNumber2","Pieces", "Weight");
			libr.quitApp();
			...
			OPR344.verifyShipmentDetails(uldNum1,"Pieces2", "Weight2");
			OPR344.clickExpand("pmyKey");
			OPR344.verifyAWBinBuildupSection("prop~AWBNo");
			OPR344.verifyAWBinBuildupSection("prop~AWBNo2");
