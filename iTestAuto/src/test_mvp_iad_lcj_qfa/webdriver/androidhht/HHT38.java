...
import screens.StorageUnitListing_WHS006;
...
public class HHT38 extends BaseSetup {
	...
	public StorageUnitListing_WHS006 WHS006;
	...
	public void setup() {
		...
		WHS006 = new StorageUnitListing_WHS006(driver, excelreadwrite, xls_Read);
	}
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/****WHS006 - Storage Unit Listing****/
			//Get Storage Unit and store in Excel
			cust.searchScreen("WHS006", "Storage Unit Listing");
			WHS006.enterSUType("val~KAR");
			WHS006.selectOccupancyStatus("Empty");
			WHS006.clickList();
			String StorageUnitValue = WHS006.getStorageUnit();
			map.put("SU", StorageUnitValue);
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			cust.closeTab("WHS006", "Storage Unit Listing");
            ...
            OPR335.addStorageUnit("SU");
            OPR335.selectSCCs(2, 1);
			...
			/*******HHT-Relocation*********/
			//Relocate Shipments based on Storage units in Android device
            ...
            relocationhht.clickOnValue("SU");
            relocationhht.clickOnAWB("awbNumber");            
            relocationhht.enterPieces("Pieces");
