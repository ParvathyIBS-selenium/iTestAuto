...
public class HHT87 extends BaseSetup {
	...
	public WarehouseDiscrepancyHHT wdhht;
	...
	public void setup() {
		...
		wdhht = new WarehouseDiscrepancyHHT(driver, excelreadwrite, xls_Read);
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/*** HHT - Warehouse Discrepancy***/
			//Select Missing Cargo in Warehouse as Discrepancy and enter partial pieces and weight
			wdhht.invokeWarehouseDiscrepancyScreen();
			map.put("awbNumber", cust.data("prop~stationCode")+cust.data("prop~AWBNo"));
			wdhht.enterAwbNumber("awbNumber");
			wdhht.selectDiscrepancyCode("Missing Cargo in Warehouse");
			wdhht.enterPiecesAndWeight("Pieces2", "Weight2");
			wdhht.enterRemarks("Remarks");
			wdhht.clickSave();
			...
			cust.listAWB("AWBNo", "prop~CarrierNumericCode", "List Discrepancies");
			int[] verfCols ={10};
			String[] actVerfValues={"MSCA"};
