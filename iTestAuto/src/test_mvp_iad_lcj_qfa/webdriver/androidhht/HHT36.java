...
public class HHT36 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
            ...
            //Verify AWB details by listing with AWB Number
            relocationhht.enterValueWithoutNext("awbNumber"); 
            relocationhht.verifyStatedPiecesWeight("Pieces", "Weight");
            relocationhht.verifyAvailablePiecesWeight("Pieces", "Weight"); 
            cust.clickBack("Relocation");
            
            //Verify AWB details by listing with SU
            ...
            //Verify AWB details by listing with ULD number
            relocationhht.enterValueWithoutNext("UldNum"); 
            relocationhht.clickOnValue("UldNum");
            map.put("AWBNumber2", cust.data("prop~stationCode")+" - "+cust.data("prop~AWBNo2"));
			relocationhht.verifyAWB("AWBNumber2");            
			libr.quitApp();
