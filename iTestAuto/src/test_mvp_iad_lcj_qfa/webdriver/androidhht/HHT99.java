...
public class HHT99 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		/***MESSAGE - loading FWB**/
			...
			shiphht.verifyEmbargoDetails("EmbargoRefName");
			shiphht.verifyShipInsDetails();
			shiphht.verifyRejectButton();
			/******WRITE THE STEP FOR CLICKING THE REJECT BUTTON. 
			 * ON CLICKING IT SHOULD NAVIGATE TO TOKEN SHIPMENT LISTING SCREEN , WHICH IS NOT WORKING AS EXPECCTED NOW
			 */
			libr.quitApp();
