...
import screens.BlockManagementHHT;
...
public class HHT69 extends BaseSetup {
	...
	public BlockManagementHHT bmhht;
	...
	public void setup() {
		...
		bmhht=new BlockManagementHHT(driver, excelreadwrite, xls_Read);
	}
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/**HHT-Block Management**/
			
			/**Creating Block for AWB No**/
			
			bmhht.invokeBlockManagementScreen();
			map.put("awbNumber", cust.data("prop~stationCode")+cust.data("prop~AWBNo"));
			bmhht.enterValue("awbNumber");
			
			//Create Block 1
			
			bmhht.clickNewBlock();
			bmhht.selectBlockTypeCode("Damage");
			bmhht.enterRemarks("val~Automation Test Remarks 1");
			bmhht.clickSave();
			
			//Create Block 2
			bmhht.clickNewBlock();
			bmhht.selectBlockTypeCode("Customs");
			bmhht.enterRemarks("val~Automation Test Remarks 2");
			bmhht.clickSave();
			bmhht.verifyBlocks("Damage","Customs");
			
			//Release Block
			bmhht.releaseBlock("Damage", "Test Remarks");
			bmhht.verifyBlocksNotExist("Damage");
			libr.quitApp();
