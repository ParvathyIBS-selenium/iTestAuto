...
public class HHT58 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Verify shipment details by listing with AWB
			map.put("awbNumber", cust.data("prop~stationCode")+cust.data("prop~AWBNo"));
			weightcaphht.enterValue("awbNumber");	
			weightcaphht.verifyStatedAndAcceptedShipmentDetails("Pieces", "Weight","Pieces", "Weight");
			cust.clickBack("Weight Capture");
			//Verify shipment details by listing with ULD
			weightcaphht.enterValue("UldNum");
			weightcaphht.verifyShipmentDetails("Pieces", "Weight");
			cust.clickBack("Weight Capture");
			libr.quitApp();
