...
public class HHT157 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR335.listAWB(cust.data("AWBNo1"), "prop~CarrierNumericCode"); 
            OPR335.looseShipmentDetails("Location", "Pieces","Weight");
            OPR335.addLooseShipment();
            OPR335.allPartsRecieved();
            OPR335.saveAcceptance();
			...
			//Writing the full AWB No
			cust.setPropertyValue("FullAWBNo", cust.data("prop~stationCode")+"-"+cust.data("prop~AWBNo"), proppath);
			map.put("FullAWBNo2", cust.data("FullAWBNo"));
			map.put("AWBNo2", cust.data("prop~AWBNo"));
			System.out.println(cust.data("AWBNo2"));
			...
			//Goods acceptance
			cust.searchScreen("OPR335", "Goods Acceptance");
			OPR335.listAWB(cust.data("AWBNo2"), "prop~CarrierNumericCode"); 
            OPR335.looseShipmentDetails("Location", "Pieces","Weight");
            OPR335.addLooseShipment();
            OPR335.allPartsRecieved();
            OPR335.saveAcceptance();
			...
			//Adding AWB 2 to ULD
			map.put("awbNumber2", cust.data("prop~stationCode")+cust.data("AWBNo1"));
			...
			bdhht.clickCloseAWBButton();
			//Adding AWB 3 to ULD
			map.put("awbNumber3", cust.data("prop~stationCode")+cust.data("prop~AWBNo"));
			System.out.println(cust.data("awbNumber3"));
			bdhht.addAWB("awbNumber3");
			bdhht.addLocation(cust.data("Location2"));
			bdhht.addPcs("Pieces");
			bdhht.clickSave();
			bdhht.clickCloseAWBButton();
			...
			/*** HHT - Breakdown - breakdown complete****/
