...
public class HHT55 extends BaseSetup {
...
*/			
		...
		*/
			...
			dimhht.verifyStatedPiecesWeight("Pieces", "Weight");
			dimhht.verifyAcceptedPiecesWeight("Pieces", "Weight");
			dimhht.verifyOriginAndDestination("prop~FullAWBNo", "Origin", "Destination");
			libr.quitApp();
