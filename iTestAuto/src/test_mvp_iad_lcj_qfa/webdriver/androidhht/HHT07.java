...
public class HHT07 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR026.clickSave();
			cust.handleAlert("Dismiss", "OPR026");
			...
			/**Selecting screening status to Fail**/
			
			sechht.invokeSecurityAndScreeningScreen();
			
			sechht.enterValue("UldNum");
			sechht.enterScreeningDetails("Pieces");
			sechht.enterScreeningStatus("Fail");
			/**sechht.selectFailedReson()**/ //needs to be scripted
			sechht.saveScreeningDetails();
			sechht.enterValue("UldNum");
			sechht.verifyScreeningStatus("Pending");
			
			/**Updating Screen status to Pass**/
			...
			sechht.saveScreeningDetails();
			sechht.enterValue("UldNum");
			sechht.verifyScreeningStatus("Completed");
			libr.quitApp();
