...
public class HHT84 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			wdhht.verifyStatedPiecesWeight("Pieces", "Weight");
			wdhht.verifyOriginAndDestination("prop~FullAWBNo", "Origin", "Destination");
			wdhht.verifySCC("prop~FullAWBNo", "CommodityCode");			
			libr.quitApp();
