...
public class HHT311 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR026.clickHAWB();
			OPR029.addUpdateHAWBBtn();			
			OPR029.addHAWBDetailsFromOPR026("HAWB","shipperCode","consigneeCode","Origin","Destination","Pieces","Weight");
			OPR029.clickHAWBSaveBtn();
			OPR029.clickHAWBCloseBtn();
