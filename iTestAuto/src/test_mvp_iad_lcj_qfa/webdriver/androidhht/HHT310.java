...
public class HHT310 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
            ...
            //Create ULD and load in Flight1
            ...
            excelRead.writeDataInExcel(map, path1, sheetName, testName);
            OPR344.addNewULDWithAWB("UldNum","0","prop~CarrierNumericCode","prop~AWBNo","Pieces2","Weight2");            
			...
			awbenq.clickExportBtn();
			awbenq.verifyExportDetails("Pieces2", "Weight2", "UldNum","prop~flightNumber");
			cust.clickBack("AWB Enquiry");			
            //Verify Warehouse details for AWB2				
			awbenq.clickWareHouseBtn();
			awbenq.verifyWarehouseDetails("Pieces2", "Weight2");
			libr.quitApp();
