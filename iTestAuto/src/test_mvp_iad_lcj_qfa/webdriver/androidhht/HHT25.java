...
public class HHT25 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String uldNum=map.get("UldNum").toString();
			...
			map.put("pmyKey",uldNum);
			OPR344.searchShipmentInBuildupSection(uldNo);
			OPR344.verifyPOU(uldNum,"Destination");
			OPR344.verifyShipmentDetails(uldNum,"Pieces", "Weight");
