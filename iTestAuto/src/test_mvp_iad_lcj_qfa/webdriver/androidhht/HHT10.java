...
public class HHT10 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			gahht.enterDimensionDetails("Pieces", "Weight","val~10,val~10,val~10");
			...
			//Checking the accepted pcs in the  dashboard
			OPR335.checkAcceptedPcs("Pieces");
