...
import screens.ULDServiceabilityDetailsHHT;
...
public class HHT107 extends BaseSetup {
	...
	public ULDServiceabilityDetailsHHT uldhht;
	...
	public void setup() {
		...
		uldhht = new ULDServiceabilityDetailsHHT(driver, excelreadwrite, xls_Read);
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/*** HHT - ULD Serviceability****/

			uldhht.invokeULDServiceabilityScreen();
			map.put("awbNumber", cust.data("prop~stationCode")+cust.data("prop~AWBNo"));
			uldhht.enterULDNumber("UldNum");			
			uldhht.verifyFieldNames("Overall Status");
			uldhht.verifyFieldNames("Severity");
			uldhht.verifyFieldNames("Damage Details");
			uldhht.verifyFieldNames("Point of Notice");
			uldhht.verifyFieldNames("Facility Type");
			uldhht.verifyFieldNames("Location");
			uldhht.verifyFieldNames("Party Type");
			uldhht.verifyFieldNames("Party");
			libr.quitApp();
