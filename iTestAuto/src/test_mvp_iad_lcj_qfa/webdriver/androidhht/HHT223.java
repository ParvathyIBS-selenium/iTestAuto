...
public class HHT223 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/****Verify the all parts received flag****/
			
			gahht.enterValue("uldNum");
			gahht.enterUldAcceptanceDetails("Location", "awbNumber");
			gahht.verifyAllPartsEnabledStatusInULDAcc("Yes");
			libr.quitApp();
