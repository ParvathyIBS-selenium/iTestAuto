...
public class HHT86 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Select Found Cargo in Warehouse as Discrepancy
			...
			wdhht.selectDiscrepancyCode("Found Cargo in Warehouse");
