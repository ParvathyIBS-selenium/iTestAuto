...
public class HHT52 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/*** HHT - Damage Capture***/
			//Capture details with Partial pieces and weight
			...
			//Capture details for Remaining pieces and weight with different Damage code and Package code
			dchht.enterAwbNumber("awbNumber");
			dchht.enterPiecesAndWeight("Pieces2", "Weight2");
			dchht.selectDamageCode("Others");
			dchht.enterPackageCodeDamageReasonCode("Unpacked","Improper Loading");
			dchht.enterPointOfNotice("Noticed at cargo acceptance");
			dchht.enterRemarks("Remarks");
			dchht.clickSave();
