...
/**Test case name : Capture an Global customer Allotment Booking and Verify the Capacity depletion.
...
public class TC014 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws InterruptedException {
		...
		try {
			...
			map.put("ATA",customfunctions.data("ATD_Local2"));
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			...
			CAP006.enterFlightDetails("carrierCode", "FlightNo1", "Origin", "Transit");
			...
			CAP018.saveBookingDetails("Confirmed","FullFlighNo1","AllotmentID");
			...
			customfunctions.data("AllotmentWeight"),customfunctions.data("Weight1"),
