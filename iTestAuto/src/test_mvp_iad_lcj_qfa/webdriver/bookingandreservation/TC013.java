...
/**
 * Test case name : Capture an Station Allotment Booking and Verify the Capacity depletion..
 * **/
...
public class TC013 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws InterruptedException {
		...
		try {
			...
			CAP012.saveDetails("AllotmentID");
			...
			CAP018.selectStationAllotment(customfunctions.data("AllotmentID"));
