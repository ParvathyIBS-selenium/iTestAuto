...
public class DC12 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws InterruptedException, AWTException {
		...
		try {
          ...
          //Process the message
           ...
           /**** OPR026 - Capture AWB****/
			...
			OPR026.enterShipmentDetails("Pieces", "Weight","Volume","val~DGRS", "val~DANGEROUS GOODS");
			OPR026.clickChargesAcc();
			OPR026.	provideRatingDetails("rateClass","IATARate","IATAcharge","netCharge");
			OPR026.enterPaymentType("val~PP", "val~PP");
			OPR026.saveAWBDGR();
			OPR026.listAWB("prop~AWBNo", "prop~CarrierNumericCode");
			//Capture DGR details
			OPR026.enterSCC("DGR");
			OPR026.clickDGRGoods();
			OPR026.captureDGRDetails("UNID", "ProperShippingName", "Pieces", "Pieces", "PerPkgUnit","PI",true);
			OPR026.asIsExecute();
           ...
           /****FLT006 - Mark Flight Movements*****/
            ...
            String pmkey = Excel.getCellValue(path1,sheetName, "DC12", "UldNum");
			...
			//Deliver Cargo for full pieces and weight
