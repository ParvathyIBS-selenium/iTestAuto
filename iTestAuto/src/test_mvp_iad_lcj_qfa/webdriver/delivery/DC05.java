...
public class DC05 extends BaseSetup {
		...
		try {
          ...
          //Process the message
           ...
           /****FLT006 - Mark Flight Movements*****/
            ...
            String pmkey = Excel.getCellValue(path1,sheetName, "DC05", "UldNum");
			...
			//Capture handover details and generate delivery id for partial pieces and weight
			...
			OPR293.changeDNpcs_wt(customfunctions.data("PartialPieces"), customfunctions.data("PartialWeight"));			
			...
			//Generate delivery id for Remaining pieces and weight
			customfunctions.searchScreen("OPR293", "Delivery Documentation");
			customfunctions.listAWB("AWBNo", "prop~CarrierNumericCode", "Delivery Documentation");
			OPR293.selectAllAWBs();
			OPR293.enterCustomer("CustomerName");
