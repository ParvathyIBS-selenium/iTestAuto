...
public class DeliveryIntegratedTestcases2 extends BaseSetup {
		...
		try {
			...
			customfunctions.switchRole("Origin", "Origin", "RoleGroup");
			 ...
			 //Checking AWB is fresh or Not
	          ...
	          String pmkey = Excel.getCellValue(path1,sheetName, "Delivery_Integrated_Testcases2", "UldNum");
	          OPR367.clickCheckBox_ULD(pmkey);
	          OPR367.enterBreakdownDetails("Location", "Pieces","Weight");
	          //Check Intact checkbox
	         ...
	         int[] n = new int[]{6,7,8};
	         String[] s = new String[]{"2XCS","10","100"};
