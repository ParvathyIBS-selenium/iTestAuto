...
public class DC027 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws InterruptedException, AWTException, IOException {
		...
		try {
           ...
           String pmkey = Excel.getCellValue(path1,sheetName, "DC027", "UldNum");
           OPR367.clickCheckBox_ULD(pmkey);
           OPR367.clickBreakdownButton();
           OPR367.enterLocationPcsAndWgt("prop~AWBNo", "BreakdownLoc", "Pieces","Weight");
           OPR367.enterLocationPcsAndWgt("prop~AWBNo2", "BreakdownLoc", "Pieces","Weight");
           ...
           //Capture hand over details and generate delivery id for AWB2
           cust.searchScreen("OPR293", "Delivery Documentation");
	       ...
	       //Set 'Delivery mode' value to Flight level DN
	       cust.searchScreen("SHR006", "Maintain Airport");
	       SHR006.listAirport("Destination");
	       ...
	       SHR006.changeParameterValue("Parameter2","Flight level DN");
	       SHR006.closeTab("SHR006", "SHR006 - Maintain Airport");
		...
		{
			  //Revert Multiple AWB Support for Gate Pass Reprint paramter 
			   cust.searchScreen("SHR006", "Maintain Airport");   
			   SHR006.listAirport("Destination");
		       SHR006.filterParameterBasedOnvalue("Parameter");
		       if(cust.data("paramVal").equals(""))
		       {
		       ...
		       SHR006.listAirport("Destination");
		       SHR006.filterParameterBasedOnvalue("Parameter2");
		       System.out.println(" paramVal2 ="+cust.data("paramVal2"));
		       if(cust.data("paramVal2").equals(""))
		       {
		    	   SHR006.changeParameterValue("Parameter2","--Select--");
		       }
		       else if(cust.data("paramVal2")!=null)
		       {
