...
public class DataCaptureInternational extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		/**
		 *  1.Create Flight.
		 *  2.Capture AWB details for international route-Cash Agent
		 *  3.Verify Print functionality in OPR339
		 *  4.Check if FWB triggered after AWB execution Message 
		 *  5.Data capture by processing FWB 
		 *  6.Delete AWB, after AWB save
		 *  7.Dg Capture: from CAP018 
		 *  8.Awb capture with house details using FHL message and console check
		 * 
		 * **/
			...
			/**** OPR339 - Security & Screening : print Consignement DeclarationReport****/
			...
			/** Capture AWB Details for awbno1ghaadmin **/
			customfunctions.searchScreen("OPR026","Capture AWB");
