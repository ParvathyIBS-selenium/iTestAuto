...
public class TM05 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           /** Process the message **/
            ...
            OPR344.addNewULDWithAWB("val~BULK","0","prop~CarrierNumericCode","AWBNo1","Pieces","Weight");
            OPR344.closeTab("OPR344", "Export manifest");
            customfunctions.searchScreen("OPR344", "Export manifest");
            OPR344.listFlight("prop~flight_code", "FlightNo","StartDate");
            		OPR344.addNewULDWithAWB("val~BULK","0","prop~CarrierNumericCode","AWBNo2","Pieces","Weight");
            ...
            OPR367.enterBreakdownInstructions("Location", 2);
            ...
            map.put("pmyKey",customfunctions.data("AWBNo1"));
            OPR002.selectAirlinefromShipmentSection("pmyKey");
            OPR002.clickOK();
            OPR002.clickSave();
            String alertText1=customfunctions.handleAlertAndReturnText();
            customfunctions.switchToDefaultAndContentFrame("OPR002");
            customfunctions.handleAlert("Dismiss","OPR002");
            String CTMRefNo1=OPR002.getCTMRefNumber(alertText1);
            System.out.println(CTMRefNo1);
            map.put("CTMRefNo1",CTMRefNo1);
            customfunctions.closeTab("OPR002", "CTM");
            
            /** Adding second shipment using ADD button **/
            
            customfunctions.searchScreen("OPR002", "CTM");
            OPR002.clicklist();
            OPR002.enterOutGoingCarrierCode("CarrierCode2");
            OPR002.CaptureFromFlightDetails("prop~flight_code","FlightNo","StartDate");
            OPR002.addShipment("prop~CarrierNumericCode", "AWBNo2", "Pieces","Weight", "val~Kilogram");
            OPR002.clickSave();
            String alertText2=customfunctions.handleAlertAndReturnText();
            customfunctions.switchToDefaultAndContentFrame("OPR002");
            customfunctions.handleAlert("Dismiss", "OPR002");
            String CTMRefNo2=OPR002.getCTMRefNumber(alertText2);
            System.out.println(CTMRefNo2);
            map.put("CTMRefNo2",CTMRefNo2);
            customfunctions.closeTab("OPR002", "CTM");
			
			/**Relist CTM002 with CTM Referance Number and Do transfer END**/
            
            customfunctions.searchScreen("OPR002", "CTM");
            OPR002.ListWithCTMREFno(customfunctions.data("CTMRefNo2"));
            String pmKeyAWBNo=customfunctions.data("prop~CarrierNumericCode")+" "+customfunctions.data("AWBNo2");
		 	int verfCols[]={7};
			String[] actVerfValuesTransfferedPcs={"0"};
		 	OPR002.verifyTableDetails(verfCols, actVerfValuesTransfferedPcs, pmKeyAWBNo);
		 	OPR002.selectShipment(customfunctions.data("AWBNo2"));
            ...
            String pmKeyCTMRefNo=customfunctions.data("CTMRefNo2");
            ...
            customfunctions.searchScreen("OPR003", "CTM Enquiry");
            customfunctions.listAWB("AWBNo", "prop~CarrierNumericCode", "CTM Enquiry");
            OPR003.selectShipment("AWBNo2");
            OPR003.clickDetails();
            OPR003.verifyDeleteButtonStatus();
            customfunctions.closeTab("OPR003", "CTM Enquiry");
