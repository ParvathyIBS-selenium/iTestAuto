...
public class TM07 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			Thread.sleep(2000);
			 ...
			 //** Create flight F1 with OWN carrier  **//
			...
			customfunctions.closeTab("FLT005", "Maintain Schedule");
			 ...
			 //** Create flight F2 with OAL carrier  **//
	        ...
	        customfunctions.searchScreen("FLT005", "FLT005 - Maintain Flight Schedule");
	        FLT005.listNewFlight("CarrierCode2", "FlightNo2", startDate, endDate);
			...
			customfunctions.setPropertyValue("FullAWBNo", customfunctions.data("prop~stationCode")+"-"+customfunctions.data("prop~AWBNo"), proppath);
			 ...
			 //** Create booking - Shipment1 single leg in F1  **//
			...
			libr.waitForSync(1);
             ...
             //Writing the full AWB No to property file
			customfunctions.setPropertyValue("AWBNo2", customfunctions.data("AWBNo2"), proppath);
			customfunctions.setPropertyValue("AWBNo", customfunctions.data("AWBNo"), proppath);
			customfunctions.setPropertyValue("FullAWBNo2", customfunctions.data("prop~stationCode")+"-"+customfunctions.data("AWBNo2"), proppath);
             
			 //** Create booking - Shipment2 multi leg in F2  **//
            
			customfunctions.createTextMessage("MessageExcelAndSheet", "MessageParam1");
			customfunctions.searchScreen("MSG005", "MSG005 - List Messages");
           	MSG005.loadFromFile("Airline","prop~flight_code", "JMS","", "Origin", "", "FBL_1");       
            ...
            //** Security and screening for S1 and S2 **//			
            ...
            //** Capture AWB details and As-is Execute for S1 and S2  **//		
			
			customfunctions.searchScreen("OPR026","Capture AWB");
			OPR026.listAWB("AWBNo", "prop~CarrierNumericCode");
			OPR026.updateOrigin("Origin");
			OPR026.updateDestination("Transit");
			...
			OPR026.close("OPR026");
			 ...
			 //** Perform Goods acceptance for S1 and S2  **// 
            ...
            customfunctions.searchScreen("OPR335", "Goods Acceptance");
			customfunctions.listAWB("AWBNo2", "prop~CarrierNumericCode", "Goods Acceptance");
            OPR335.looseShipmentDetails("Location", "Pieces","Weight");
            OPR335.addLooseShipment();
            OPR335.allPartsRecieved();
            OPR335.saveAcceptance();
            ...
            //** Perform manifest, flight finalization **//
            ...
            OPR344.manifestDetails();
             ...
             customfunctions.searchScreen("OPR344", "Export manifest");
             OPR344.listFlight("prop~flight_code", "FlightNo","StartDate");
            OPR344.addNewULDWithAWB("val~BULK","0","prop~CarrierNumericCode","prop~AWBNo2","Pieces","Weight");
            OPR344.manifestDetails();
            OPR344.finalizeFlight();
            OPR344.verifyFlightStatus("val~Finalized");
            OPR344.closeTab("OPR344", "Export manifest");
            
            //** Switch to transit station **//
            
			customfunctions.switchRole("Transit", "Origin", "RoleGroup");
			
			 //** Perform flight arrival F1  **//
			...
			FLT006.close("FLT006");
			 ...
			 //** Perform Breakdown of shipments S1 and S2  **//
            ...
            OPR367.clickBreakDownandBreakdownComplete2AWBs("Location","RcvdPcs","RcvdWt");
            OPR367.closeFromOPR004();
			OPR367.closeTab("OPR367", "Import Manifest");
            
            /**CTM Screen OPR002- Perform CTM out for S2**/
			
            customfunctions.searchScreen("OPR002", "CTM");
            OPR002.clicklist();
            OPR002.enterOutGoingCarrierCode("CarrierCode2");
            OPR002.ListwithFromFlightDetails("prop~flight_code","FlightNo","StartDate");
            map.put("pmyKey",customfunctions.data("prop~AWBNo2"));
            ...
            String pmKeyAWBNo=customfunctions.data("prop~CarrierNumericCode")+" "+customfunctions.data("prop~AWBNo2");
		 	int verfCols[]={7};
			String[] actVerfValuesTransfferedPcs={"0"};
		 	OPR002.verifyTableDetails(verfCols, actVerfValuesTransfferedPcs, pmKeyAWBNo);
		 	OPR002.selectShipment(customfunctions.data("prop~AWBNo2"));
		 	OPR002.clickTransferEnd();
            customfunctions.closeTab("OPR002", "CTM");
            
            //** Checking Message FSU TFD message trigger  **//
            ...
            MSG005.clickList();
            String pmKeyTFD=customfunctions.data("prop~CarrierNumericCode")+" - "+customfunctions.data("prop~AWBNo2");
            int verfColsTFD[]={9};
            String[] actVerfValuesTFD={"Sent"};
            MSG005.verifyMessageDetails(verfColsTFD, actVerfValuesTFD, pmKeyTFD,"val~FSU-TFD",false);
            libr.waitForSync(6);
            MSG005.closeTab("MSG005", "MSG005 - List Messages");
            
            
            /********** CTM Enquiry Screen OPR003 - verify details *********/
            
            customfunctions.searchScreen("OPR003", "CTM Enquiry");
            customfunctions.listAWB("AWBNo2", "prop~CarrierNumericCode", "CTM Enquiry");
			...
			String[] actVerfValuesCTMWt={customfunctions.data("Weight")};
		 	...
		 	OPR003.selectShipmentclickDetails("AWBNo2");
		 	
		 	 //** Verify Transferred pieces, weight in CTM screen  **//
		 	
		 	int verfCols1[]={7,8};
			String[] actVerfValuesTransfferedPcs1={customfunctions.data("Pieces"),customfunctions.data("Weight")};
            ...
            MSG005.selectMsgSubType("Outbound CTM");
            MSG005.clickList();
            MSG005.verifyMessageDetails(verfColsTFD, actVerfValuesTFD, pmKeyTFD,"val~FSU-TFD",true);
            libr.waitForSync(6);
            MSG005.closeTab("MSG005", "MSG005 - List Messages");
