...
/** TC_01_Verify ProvideExportCustomDataService trigger from iCargo to  VCCustoms interface as part XFWB processing**/ 
...
public class ProvideExportCustomData_TC_7802 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws IOException {
		...
		try {
			...
			vcc.clickAwbLink();
			vcc.verifyMRN("Customsvalue","val~FWB");
			libr.quitBrowser();
