package cgoimcom;
/**   TC_01_Verify Location of pallets updated in icargo on receiving relocatestorageunit as 1st position of IM  **/
...
public class RelocateStorageUnit_TC_7743 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			jsonbody.postRequest(cust.data("EquipmentID"),cust.data("UldNum"),cust.data("ForwardLocation"),cust.data("OccupancyStatus"),cust.data("WareHouse"));
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
