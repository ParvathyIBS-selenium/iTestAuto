package vpp;
/** TC_02_Verify shipment dimension details recieved from VPP when SU relocation details are sent from iCargo-Webscreen   **/
...
public class PSRAndSaveDimensionDetails_TC_10107 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/******* POST REQUEST****/		
			jsonbody.postRequest(cust.data("AWB"),cust.data("SUWeight"),cust.data("SUVolume"),cust.data("Length"),cust.data("Width"),cust.data("Height"));
