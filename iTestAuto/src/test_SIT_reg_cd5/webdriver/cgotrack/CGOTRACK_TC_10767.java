...
/**  TC_09_Verify LAT in icargo after modification done from AFLS  **/
...
public class CGOTRACK_TC_10767 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			afls.enterAWB("CarrierNumericCode","AWBNo");
			cust.keyPress("TAB");
			afls.clickmodifyBooking();
			afls.enterFlightInfo("carrierCode","FlightNo","Origin", "Destination", "NewBookDate");
			afls.clickSubmitBooking();
			libr.quitBrowser();
			...
			//To verify LAT is stamped in status check popup
			OPR026.verfyLATStamped();
			OPR026.verfyLATValueAfterBookingUpdate("LATData");
			OPR026.LATUpdatedInShipmentStatus("LATData","LATDate");
			/**Verify lat value stamped in OPR026 main screen***/
			OPR026.verfyLATvalue("LATDate");
			cust.closeTab("OPR026", "Capture AWB");
			libr.quitBrowser();
