...
/**TC_02_Verify user is able to print ULD checksheet for OAL ULD.**/
...
public class ULDChecksheet_TC_10370 extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			FlightNum = FlightNum.replace(cust.data("prop~flight_code"), cust.data("otherAirline"));
			...
			OPR344.listFlight("otherAirline", "FlightNo", "StartDate");
			String uldNo = cust.create_uld_number("UldType", "otherAirline");
			...
			SHR094.selectCheckSheetType("val~ULD");
			SHR094.selectTransaction("Buildup Complete");
			...
			checkhht.selectULDTransaction("Buildup Complete");
