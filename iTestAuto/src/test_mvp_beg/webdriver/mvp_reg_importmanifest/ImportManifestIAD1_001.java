...
/**
 * 
 * xFFM and related xFWB have been received

  Documentary check for a loose/ULD AWB
 *
 */

public class ImportManifestIAD1_001 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("TransitAirport", WebFunctions.getPropertyValue(custproppath, "BEG"));
			map.put("OriginAirport", WebFunctions.getPropertyValue(custproppath, "CDG"));
			map.put("DestinationAirport", WebFunctions.getPropertyValue(custproppath, "BUD"));
			map.put("TransitCountry", WebFunctions.getPropertyValue(custproppath, "creditCustomercountryId_RS"));
			...
			map.put("DestinationLoc",cust.data("Transit"));
			...
			map.put("ConsigneeCode", WebFunctions.getPropertyValue(custproppath, "creditCustomerId_HU"));
			map.put("ConsigneeName", WebFunctions.getPropertyValue(custproppath, "creditCustomerName_HU"));
			map.put("ConsigneePostCode", WebFunctions.getPropertyValue(custproppath, "creditCustomerpostCode_HU"));
			map.put("ConsigneeStreetName", WebFunctions.getPropertyValue(custproppath, "creditCustomerstreetName_HU"));
			map.put("ConsigneeCityName", WebFunctions.getPropertyValue(custproppath, "creditCustomercityName_HU"));
			map.put("ConsigneeCountryId", WebFunctions.getPropertyValue(custproppath, "creditCustomercountryId_HU"));
			map.put("ConsigneeCountryName", WebFunctions.getPropertyValue(custproppath, "creditCustomercountryName_HU"));
			map.put("ConsigneeCountrySubDiv", WebFunctions.getPropertyValue(custproppath, "creditCustomercountrySubdivision_HU"));
			map.put("ConsigneePhoneNo", WebFunctions.getPropertyValue(custproppath, "creditCustomertelephoneNo_HU"));
			map.put("ConsigneeEmail", WebFunctions.getPropertyValue(custproppath, "creditCustomeremail_HU"));
			...
			String routing[] = { cust.data("Origin") + ";" + cust.data("OriginAirport") + ";" + cust.data("Transit")
			+ ";" + cust.data("TransitAirport"),cust.data("Origin") + ";" + cust.data("OriginAirport") + ";" + cust.data("Destination")
			...
			MSG005.clickList();
			String pmKeyAWR1=cust.data("prop~CarrierNumericCode")+" - "+cust.data("awb1");
			String pmKeyAWR2=cust.data("prop~CarrierNumericCode")+" - "+cust.data("awb2");
