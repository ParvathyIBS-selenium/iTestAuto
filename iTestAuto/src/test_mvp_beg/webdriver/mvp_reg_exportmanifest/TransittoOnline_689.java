...
public class TransittoOnline_689 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
        	...
        	map.put("AgentCode", WebFunctions.getPropertyValue(custproppath, "creditCustomerId_HU"));

			map.put("ShipperCode", WebFunctions.getPropertyValue(custproppath, "creditCustomerId_HU"));
			map.put("ShipperName", WebFunctions.getPropertyValue(custproppath, "creditCustomerName_HU"));
			map.put("ShipperPostCode", WebFunctions.getPropertyValue(custproppath, "creditCustomerpostCode_HU"));
			map.put("ShipperStreetName", WebFunctions.getPropertyValue(custproppath, "creditCustomerstreetName_HU"));
			map.put("ShipperCityName", WebFunctions.getPropertyValue(custproppath, "creditCustomercityName_HU"));
			map.put("ShipperCountryId", WebFunctions.getPropertyValue(custproppath, "creditCustomercountryId_HU"));
			map.put("ShipperCountryName", WebFunctions.getPropertyValue(custproppath, "creditCustomercountryName_HU"));
			map.put("ShipperCountrySubDiv",
					WebFunctions.getPropertyValue(custproppath, "creditCustomercountrySubdivision_HU"));
			map.put("ShipperPhoneNo", WebFunctions.getPropertyValue(custproppath, "creditCustomertelephoneNo_HU"));
			map.put("ShipperEmail", WebFunctions.getPropertyValue(custproppath, "creditCustomeremail_HU"));
			...
			map.put("CassCode", WebFunctions.getPropertyValue(custproppath, "creditCustomer_CASSCode_HU"));
			map.put("IATACode", WebFunctions.getPropertyValue(custproppath, "creditCustomer_IATACode_HU"));
			map.put("OriginAirport", WebFunctions.getPropertyValue(custproppath, "BUD"));
			...
			cust.setPropertyValue("flightNumber2", cust.data("prop~flight_code_KL") + cust.data("prop~flightNo2"), proppath);
			...
			map.put("AircraftTyp",cust.data("AircraftType").split(",")[0]);
			...
			map.put("AircraftTyp",cust.data("AircraftType").split(",")[1]);
