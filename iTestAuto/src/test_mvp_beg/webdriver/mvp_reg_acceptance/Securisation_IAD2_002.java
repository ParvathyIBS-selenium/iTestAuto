...
/**
 * Screening of secured shipments with fail result, different screening method
**/



public class Securisation_IAD2_002 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("AgentCountryId", WebFunctions.getPropertyValue(custproppath, "creditCustomercountryId_RS"));
			
			
			//Regulated agent details
			map.put("RegulatedAgentCode", WebFunctions.getPropertyValue(custproppath, "regulated_Agent_Carrier_Code"));
			map.put("RegulatedAgentCountryId", WebFunctions.getPropertyValue(custproppath, "regulated_Agent_CountryId"));
            ...
            OPR339.addAgentDetails("AgentType","RegulatedAgentCountryId","AgentCode","Expiry");
            ...
            OPR339.listAWB("AWBNo", "CarrierNumericCode", "OPR339 - Security & Sceening");
            //verification of SCC
            String[] scc2={"NSC",cust.data("SCC").split(",")[0]};
