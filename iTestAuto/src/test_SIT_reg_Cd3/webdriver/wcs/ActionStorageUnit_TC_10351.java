package wcs;
/**  TC_09_Verify iCargo reassigns the Cart to the current flight in the UOB message when the Cart is already assigned in another flight and it is empty  **/
...
public class ActionStorageUnit_TC_10351 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/******* POST REQUEST - Assigning the Cart to first flight ****/		
			jsonbody.postRequest("Cart",cust.data("UldType"),cust.data("ULDNo"),cust.data("carrierCode"),cust.data("Destination"),flightdate,cust.data("FlightNo"));		
			...
			/******* POST REQUEST - Reassigning the same Cart to second flight ****/		
			jsonbody.postRequest("Cart",cust.data("UldType"),cust.data("ULDNo"),cust.data("carrierCode"),cust.data("Destination"),flightdate,cust.data("FlightNo1"));
