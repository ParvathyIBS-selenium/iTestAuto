...
public class PublishShipmentRelocation_TC_3035 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			WHS009. enterLocationnoFrameSwitch("TargetLocation");
			cust.switchToMainScreen("WHS009");
			String []actverfval={cust.data("TargetLocation"),cust.data("Pieces")};
			...
			//verify the ULD details in the publishSipmentRelocation message
			String pmKey2=cust.data("UldNum");
			int[] verfCols2={13};
			String[] actVerfValues2={cust.data("UldNum")};
			Cgospa.verifyFlightDetails(verfCols2, actVerfValues2,pmKey2);
			
			
			//verifying scc details
			map.put("pmKeyDF", "DF");
			Cgospa.verifySCCDetails("pmKeyDF", cust.data("ExpectedSCCs"), cust.data("SCC"));
