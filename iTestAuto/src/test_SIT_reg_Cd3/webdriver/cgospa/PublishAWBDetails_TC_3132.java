package cgospa;
/**  TC_03_Verify AWB  details sent to CGOSPA during loose goods acceptance   **/
...
public class PublishAWBDetails_TC_3132 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			afls.enterBookingDeliveryAndArrivalDate("BookDate", "EndDate");
			...
			cgospa.clickAWBNo();
			int col[] = {10, 11};
			String [] actVal = {cust.data("Pieces"),cust.data("Weight")};
			String pmKey = cust.data("FullFlightNo");
			cgospa.verifyFlightDetails(col, actVal, pmKey);
			
			//verifying scc details for the flight
			cgospa.verifySCCDetails("FullFlightNo", cust.data("ExpectedSCCs1"), cust.data("SCC"));
			...
			String [] actVal1 = {cust.data("Pieces"),cust.data("Weight"),cust.data("HA")+cust.data("Location")};
			cgospa.verifyFlightDetails(col1, actVal1, pmKey1);
			libr.quitBrowser();
