...
/**  TC_05_Verify individual validation checks when RTI is NOK -customs check fails **/
...
public class getRTIstatus_TC_3101 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
           ...
           /**** OPR026 - Capture AWB ****/
			...
			TGC013.clickCHIconAndVerifyTooltip("AWBNo","RTI Status","FYCO Requested");					

			TGC013.clickMoreOption("AWBNo");		
			
			/** Capture AWB Screen **/
			TGC013.clickCaptureAwb();
            TGC013.checkStatusOPR026("val~FYCO Requested");
            ...
            /**** OPR023 - AWB Clearance****/
			 ...
			 OPR023.verifyBlockDetails(verfCols, actVerfValues, "RTI-Customs block au");
