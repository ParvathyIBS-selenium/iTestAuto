...
/** Test Id-2968  Verify ULD details sent to CAFEED after flightclosurefor buildup- Webscreen **/
...
public class UCLS_TC_2968 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String routing[] = { cust.data("Origin") + ";" + cust.data("Transit"),cust.data("Origin") + ";" + cust.data("Transit")};
			...
			map.put("ShipmentDescription", cust.data("ShipmentDesc"));
...
/***Verifying the pieces and weight of the uld having 2 awbs***/
			...
			String[] awb1pcs= {"20"};
			String[] awb1wght= {cust.data("TotalWeight")};
			...
			cust.waitForSync(1);
			OPR344.acceptAlertPopUp("val~The shipment is not booked to the flight. Do you want to proceed?");
			cust.waitForSync(6);
			OPR344.expandULDs();
