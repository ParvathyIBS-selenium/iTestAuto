...
public class UCLS_TC_2965 extends BaseSetup{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cfd.listFlightDetails("FullFlightNo", "Date");
			cfd.verifyULDDetails(col, expValue, cust.data("UldNum"));
			String[] expValue1 = { cust.data("Pieces"),cust.data("ActualWeight")};
			cfd.verifyULDDetails(col, expValue1, cust.data("UldNum1"));
			cfd.clickAWBInsideULD("UldNum", "FullAWBNo");
			cfd.verifyDGDetails("UNID", "PI", "ShippingName");
			libr.quitBrowser();
			...
			cfd.clickAWBInsideULD("UldNum2", "FullAWBNo");
			cfd.verifyDGDetails("UNID", "PI", "ShippingName");
			libr.quitBrowser();
			...
			cfd.listFlightDetails("FullFlightNo1", "Date");
			cfd.verifyULDDetails(col, expValue2, cust.data("UldNum2"));
			cfd.verifyULDDetails(col, expValue1, cust.data("UldNum3"));
			cfd.clickAWBInsideULD("UldNum2", "FullAWBNo");
			cfd.verifyDGDetails("UNID", "PI", "ShippingName");
			libr.quitBrowser();
