...
/** TC_02_Check sheet capture at export manifest and verify in Patriarch system.-HAWB with DG shipment  **/


public class ExportManifestChecksheet_TC_3062 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
          ...
          /******* OPR026 - Capture AWB *****/
			...
			OPR344.clickEditULDdetails("val~BULK");
			OPR344.addAWBDetailsWithHAWB("CarrierNumericCode", "AWBNo","Pieces","Weight");
			OPR344.clickBuildUpComplete();				
			OPR344.expandULDs();
			map.put("pmKey","BULK"+cust.data("CarrierNumericCode")+cust.data("AWBNo")+"11");
			OPR344.verifyHAWBpresent("1 HAWB",cust.data("pmKey"));
