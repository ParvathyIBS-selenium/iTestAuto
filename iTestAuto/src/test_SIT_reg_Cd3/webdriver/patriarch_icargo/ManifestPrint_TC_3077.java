...
/*** TC_10_Print manifest at export manifest for Empty ULDs and verify in Patriarch system.***/
...
public class ManifestPrint_TC_3077 extends BaseSetup 

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			OPR344.addNewULD("UldNum1","Destination");
			OPR344.clickManifest();
			OPR344.selectDocType("ULD_MAWB");
			OPR344.excludeEmptyULDS();
		    ...
		    OPR344.selectDocType("ULD_MAWB");		    
		    OPR344.printManifestOkWithoutFrame();
		    cust.printAndVerifyReport("val~CARGO MANIFEST", "OPR344",cust.data("UldNum"),cust.data("UldNum1"));
	        OPR344.printManifestClose();
