package pchs;
/** TC_04_Verify the ULD location value updated in iCargo when relocation� message is sent from PCHS to iCargo during relocation inside PCHS  **/
...
public class RelocateStorageUnit_TC_8801 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/******* POST REQUEST****/	
			//ULD moved to the entry point of PCHS
			...
			/******* POST REQUEST****/	
			//ULD relocated to another point inside PCHS
			jsonbody.postRequest(cust.data("UldType"),cust.data("ULDNo"),cust.data("carrierCode"),cust.data("PCHSLoc1"));
			
			/** WHS009 - WAREHOUSE RELOCATION **/
			cust.searchScreen("WHS009", "Warehouse Relocation");
			WHS009.enterSU("UldNum");
			WHS009.listAwbDetails();
			WHS009.VerifyCurrentLocOfULD("UldNum","PCHSLoc1");
			cust.closeTab("WHS009", "Warehouse Relocation");
			...
			WHS011.enterAWBdetails("CarrierNumericCode","AWBNo");
			WHS011.clickList(); 
			String[] actVerfVal1={cust.data("PCHSLoc1")};
