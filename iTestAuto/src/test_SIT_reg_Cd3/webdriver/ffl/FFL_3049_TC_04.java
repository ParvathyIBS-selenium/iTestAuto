...
/** TC_04_Verify TCON offload when FFL is received for same pieces and weight.**/

public class FFL_3049_TC_04 extends BaseSetup {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String uldNo = cust.create_TCON_number("val~TC");
			map.put("UldNum", uldNo);
			excelRead.writeDataInExcel(map, path1, sheetName, testName);
			OPR344.addNewBarrowWithAWB("UldNum", "Destination", "CarrierNumericCode", "AWBNo", "Pieces", "Weight");
			OPR344.clickBuildUpCompleteWithBarrow();
