...
//TC_02_Verify the system is overridden the clearing agent and bill to party for an AWB  which is already having agent details during xFIM process



public class IASCB_158890_TC_12803 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Verify clearing agent of the Consignee
			...
			//Verify clearing agent of the Consignee
			OPR001.verifyClearingAgentDisplayed("AWBNo", "ClearingAgent","Origin");
			...
			cust.searchScreen("MSG005", "MSG005 - List Messages");
			MSG005.loadFromFile("All", "ALL", "MQ-SERIES", "", "Destination", "", "XFIM", true);
			...
			cust.searchScreen("OPR367", "Import Manifest");
			OPR367.listFlight("carrierCode", "FlightNo", "StartDate");
			//Verify clearing agent is overridden with the nominated agent 
			OPR367.verifyClearingAgentName("NominatedAgentName");
			OPR367.closeTab("OPR367", "Import Manifest");
			...
			OPR001.listFlightDetails("carrierCode", "FlightNo", "StartDate");
			//Verify clearing agent is overridden with the nominated agent 
			OPR001.verifyClearingAgentDisplayed("AWBNo", "NominatedAgentName","Origin");
			OPR001.closeTab("OPR001", "Import Documentation: OPR001");
