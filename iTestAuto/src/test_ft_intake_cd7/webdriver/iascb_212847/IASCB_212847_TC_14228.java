package iascb_212847;

/** TC_01_verify the ULD Instruction icon in the ULD Sighting app for breakdown ULD when ULD has the instruction **/
...
public class IASCB_212847_TC_14228 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws Exception {
		...
		try {
			...
			String shipments[] = { libr.data("FullAWBNo") + ";" + libr.data("Pieces") + ";" + libr.data("Weight") + ";"+ libr.data("Volume") + ";" + libr.data("ShipmentDesc") };
			...
			OPR367.clickUldInstruction("UldNum");
			OPR367.captureUldInstruction("UldNum","Instruction");
			OPR367.SaveDetails();
			...
			cust.waitForSync(5);
			uldsighthht.verifyULDinstructionsNotificationCount("UldNum", "NotificationCount");
			uldsighthht.clickULDinstructions("UldNum");
			uldsighthht.verifyULDinstructionContent("Instruction");
			uldsighthht.specialInstructionClose();
			libr.quitApp();
