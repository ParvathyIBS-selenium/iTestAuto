...
//TC_03_Verify TO is generated for INTACT ULD when forward zone is provided and sighting is done _ Import



public class IASCB_212839_TC_14452 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("TEPSightingLocation", WebFunctions.getPropertyValue(toproppath, "TEPSightingLocation"));		
			uldsighthht.selectSightingLocation("TEPSightingLocation");
			uldsighthht.clickSight();
			//Entering the FWD zone
			map.put("ForwardZone_CDG", WebFunctions.getPropertyValue(toproppath, "ForwardZone_CDG"));		
			uldsighthht.selectFwLocationAfterSighting("ForwardZone_CDG");	
			...
			to.retrieveAndVerifyOriginLocation("UldNum", "TEPSightingLocation");
			...
			to.verifyShipmentDetails("UldNum", "val~Open", "TEPSightingLocation");

			//verifying the pieces/weight 
			to.verifyPcsWt("UldNum", "Pieces", "Weight");
			libr.quitApp();
			...
			String[] actVerfValues= {WebFunctions.getPropertyValue(toproppath, "ForwardZone_CDG")};
