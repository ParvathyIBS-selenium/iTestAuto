...
/***TC_02_Verify auto generation of Storage unit (SU) in warehouse relocation screen(WHS009) , when SU field is empty (Loose acceptance).***/
public class IASCB_162868_TC_10431_KL extends BaseSetup  {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			WHS009.VerifyCurrentLocOfULD("SU1","Location1");
			cust.closeTab("WHS009", "Warehouse Relocation");
			...
			WHS011.clickList();
			int[] verfCols1={4,5};
			String[] actVerfValues1={cust.data("Location1"),cust.data("SU1")};
			WHS011.verifyWarehouseDetailsWithPmKey(verfCols1, actVerfValues1,"Location1");
