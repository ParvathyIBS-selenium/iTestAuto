...
/** TC_01_Verify the newly added filters in Load plan section of build up planning screen ADD004 **/
public class IASCB_163965_TC_10449_KL extends BaseSetup {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Verifying the text Fields
			String[] textFieldlabels={"SCC","SCC Group"};
			ADD004.verifyTextFields(textFieldlabels);
		    ADD004.verifyUldNumberTextField();
		    //Verifying Drop Down Fields with Values
			String[] drpdnlabels={"Ready for Carriage","Blocked"};
			ADD004.verifyDropDownFields(drpdnlabels);
			//Verifying the checkboxes
			String[] checkboxlabels={"Available at Airport"};
			ADD004.verifyCheckboxes(checkboxlabels);
			ADD004.clickCancelInFilterPopUp();
