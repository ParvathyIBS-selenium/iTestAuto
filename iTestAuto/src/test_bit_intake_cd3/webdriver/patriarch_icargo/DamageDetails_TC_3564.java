...
/** TC3_Capture Damage details while delivery Cargo should be triggered from iCargo to Patriarch - Partial Shipment damage   **/
...
public class DamageDetails_TC_3564  extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR367.closeTab("OPR293", "Delivery Documentation");
			...
			TRC006.addDamageDetails("DmgCode", "DmgPcs", "DamageDetails");
			TRC006.printDamage();
