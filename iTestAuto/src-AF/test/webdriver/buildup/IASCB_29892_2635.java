...
public class IASCB_29892_2635 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/** MSG005 -XFBL Message loading  AWB**/
			...
			/*** MSG005-XFWB message loading AWB ***/
			map.put("FullAWBNo", cust.data("prop~FullAWBNo"));
			map.put("AWBNo", cust.data("prop~AWBNo"));
			...
			OPR344.expandULDs();
			String pmkey=cust.data("UldNum")+cust.data("CarrierNumericCode")+cust.data("AWBNo")+cust.data("val~11");
			map.put("pkey", pmkey);
			OPR344.selectAwbNumberByJS("pkey");
			OPR344.offloadAwbWithLocationPiecesAndReason("SplitPieces1","SplitWeight2","SCC");
			...
			/*** MSG005-Verify XFSU-DIS message ***/
			...
			msgContents.add("val~<DiscrepancyDescriptionCode>SSPD</DiscrepancyDescriptionCode>");
