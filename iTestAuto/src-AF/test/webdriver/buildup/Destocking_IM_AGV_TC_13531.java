...
public class Destocking_IM_AGV_TC_13531 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			ADD013.clickList();
			map.put("IM_Equipment_TOP", WebFunctions.getPropertyValue(toproppath, "IM_Equipment_TOP"));
			map.put("IM_EquipmentTypeTOP_AGV", WebFunctions.getPropertyValue(toproppath, "IM_EquipmentTypeTOP_AGV"));
			ADD013.selectEquipmentType(cust.data("IM_Equipment_TOP"),"IM_EquipmentTypeTOP_AGV");
			...
			ADD017.clickList();
			ADD017.selectVehicleType("FullFlightNo", "val~AGV");
			...
			String ColumnNames[]={"Source HA","Dest. HA","Remarks"};
			String TODetails[]={WebFunctions.getPropertyValue(toproppath, "BuildupHA_CDG"),WebFunctions.getPropertyValue(toproppath, "SightingHA_CDG")};
			WHS052.verifyTOStatus("Status","UldNumber","In Progress/Open");
			WHS052.verifyTODetails(2, ColumnNames, "UldNumber", TODetails);

			WHS052.maximizeAwbDetails("UldNum");
			WHS052.verifyCurrentLocation("UldNum", "Current.Loc","Current.Loc"+"\n"+cust.data("BuildupLocation_CDG"));
			WHS052.verifyDestinationLocation("UldNum", "Dest.Loc","Dest.Loc"+"\n"+WebFunctions.getPropertyValue(toproppath, "IM_EquipmentTypeTOP_AGV_Zone"));
