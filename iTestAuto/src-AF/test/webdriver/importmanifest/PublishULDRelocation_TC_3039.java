...
public class PublishULDRelocation_TC_3039 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			Cgoicss.addLeg();
			Cgoicss.enterLegDetails("ATD_Local", "ATA_Local", "Origin", "Destination", "serviceType", "AircraftType",
					"carrierCode");
			Cgoicss.clickSave();
			libr.quitBrowser();
			...
			MSG005.clickList();
			String pmKeyCGOSPADetails = cust.data("UldNum") + " - " + cust.data("WareHouseCode") + " - "
					+ cust.data("SourceLocation");
