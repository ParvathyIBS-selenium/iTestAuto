...
public class Breakdown_PIT_TC_13547_Descoped extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			WHS013.enterLocation("breakdownPITLocation");
			WHS013.clickList();
			String BreakdownPITZone=WHS013.getZoneCode();
			map.put("BreakdownPIT_Zone_CDG", WebFunctions.getPropertyValue(toproppath, "BreakdownPIT_Zone_CDG"));
			WHS013.verifyZone(cust.data("BreakdownPIT_Zone_CDG"),BreakdownPITZone);
