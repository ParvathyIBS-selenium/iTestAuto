...
public class UCLS_TC_10582 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR344.addNewULDWithAWBAndContour("UldNum","0","CarrierNumericCode","AWBNo1","Pieces1","Weight1","Contour");
			...
			OPR344.captureMoreUldDetails("val~210","80");
			...
			String[] actVerfValues1 ={cust.data("status"),cust.data("Pieces1"),cust.data("Weight1")};
          ...
          // Relaunch browser
			...
			//verfication of Empty Uld details
			
			cfd.verifyULDDetails(col1,awb1Cont,cust.data("UldNum1"));
