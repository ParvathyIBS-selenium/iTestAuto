...
/** 1.14 Test ID : 2617 - TC_01_Verify that ULD is off-loaded automatically based on CPM message. **/

public class IASCB_28065_2617_AF extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR344.addNewULDWithAWBAndContour("UldNum1","0","CarrierNumericCode","awb1","Pieces","Weight","Contour");
			cust.waitForSync(1);
			
			String uldNo2=cust.create_uld_number("UldType", "prop~flight_code");
			map.put("UldNum2", uldNo2);
			OPR344.addNewULDWithAWBAndContour("UldNum2","0","CarrierNumericCode","awb2","Pieces","Weight","Contour");
			cust.waitForSync(1);
			
			String uldNo3=cust.create_uld_number("UldType", "prop~flight_code");
			map.put("UldNum3",uldNo3);
			OPR344.addNewULDWithAWBAndContour("UldNum3","0","CarrierNumericCode","awb3","Pieces","Weight","Contour");
			cust.waitForSync(1);
			
			OPR344.clickBuildUpComplete("UldNum1");
			OPR344.clickBuildUpComplete("UldNum2");
			OPR344.clickBuildUpComplete("UldNum3");
			...
			cust.createTextMessage("MessageExcelAndSheetCPM", "MessageParamCPM");
			String uldwgt= cust.data("actwght");
			String uldDetails[] = { "-12P/"+cust.data("UldNum1")+"/"+cust.data("Destination")+"/"+uldwgt+"/C."+cust.data("Contour") ,"-12P/"+cust.data("UldNum2")+"/"+cust.data("Destination")+"/"+uldwgt+"/C."+cust.data("Contour")};
			
			//Create CPM Message
			cust.createCPM("CPM", uldDetails);
			
			mercuryScreen.clickSendMessage();
			mercuryScreen.enterTelexAddress("SenderAddressMercury", "DestinationAddressMercury",true);
			mercuryScreen.sendMessageInMercury();
			mercuryScreen.verifyMsgStatus("CPM");
			libr.quitBrowser();
			...
			cust.searchScreen("OPR344", "Export manifest");
			OPR344.listFlight("carrierCode", "prop~flightNo","StartDate");
			OPR344.verifyULDInPlannedSection("UldNum3");
			OPR344.verifyFlightStatus("val~Offloaded");
			cust.closeTab("OPR344", "Export Manifest");

			/*******Verify FSU-RCS AWB1 message in MSG005******/
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyRCS1=cust.data("CarrierNumericCode")+" - "+cust.data("awb2");
			int verfColsRCS1[]={9};
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyRCS2=cust.data("CarrierNumericCode")+" - "+cust.data("awb3");
			int verfColsRCS2[]={9};
