...
public class IASCB_100905_TC_2319_Descoped extends BaseSetup {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("SUNumber", cust.data("CarrierNumericCode") + cust.data("AWBNo")+"001");
			WHS011.enterSU("SUNumber");
			WHS011.clickList();
			// Verify SU Number	
			String pmyKeySU = cust.data("Location");			
			int[] verfColsSU={5,9,10};
			String[] actVerfValuesSU ={cust.data("CarrierNumericCode")+cust.data("AWBNo")+"001",cust.data("Pieces"),cust.data("Weight")}; 
			...
			WHS011.enterSU("SUNumber");
			WHS011.clickList();
			WHS011.verifyNoRecoredsFound("val~No rows selected based on the specified filters.");
			cust.closeTab("WHS011", "Warehouse Shipment Enquiry");	
