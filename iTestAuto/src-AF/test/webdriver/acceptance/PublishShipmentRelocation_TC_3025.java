...
/**  TC_01_Verify shipment location details during complete loose acceptance via webscreen  to CGOSPA    **/
...
public class PublishShipmentRelocation_TC_3025 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR026.verifyStatedWeight("statedWeight");
			...
			OPR335.verifySplitWeight(sccs,wgt);
			...
			int[] verfCols1={10,11,12,14};
			String[] actVerfValues1 ={pcs[0],wgt[0],sccs[0],cust.data("HA")+cust.data("Location")};
			Cgospa.verifyFlightDetails(verfCols1, actVerfValues1,su);
			
			
			String su1 =cust.data("CarrierNumericCode")+cust.data("AWBNo")+"002";
			String[] actVerfValues2 ={pcs[1],wgt[1],sccs[1],cust.data("HA1")+cust.data("Location1")};
			Cgospa.verifyFlightDetails(verfCols1, actVerfValues2,su1);
