...
public class TO_BuildUp extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			WHS013.enterLocation("openedPITLocation");
			WHS013.clickList();
			String PITLocationZone=WHS013.getZoneCode();
			map.put("PITLocationZone_CDG", WebFunctions.getPropertyValue(toproppath, "PITLocationZone_CDG"));
			WHS013.verifyZone(cust.data("PITLocationZone_CDG"),PITLocationZone);
			...
			to.selectTask("openedPITLocation");
			to.confirmTaskList();
			to.clickRelocationComplete("openedPITLocation");
			libr.quitApp();
