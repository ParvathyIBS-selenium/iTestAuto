...
public class HHT_Export extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) throws Exception {
		...
		try {
			...
			gahht.enterValueAndVerifyChecksheet("awbNumber");
			...
			buhht.verificationOfSCCField();
			buhht.verifyBuildupLocation("BuildupLoc");
			...
			//Build-Up List HHT
			bulhht.verifyTaskStatusCompleted("Uld");
			libr.quitApp();
			...
			cust.switchRoleToNewRoleGroup("Origin", "FCTL", "val~CDGGENPLUS");
