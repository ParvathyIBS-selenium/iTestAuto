...
public class JSONBody extends CustomFunctions {
	...
	public void postRequest(String awbPrefix,String awbNumber,String timeStamp,String executionResult,String screeningMethod,String rapixEntryLoc,String screener,String su) throws JsonProcessingException
	{
		...
		if(executionResult.equals("P"))
			msg="<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n" + "\r\n" + "<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\">\r\n" + "\r\n" + "<SOAP-ENV:Header>\r\n" + "\r\n" + "<ns0:Action xmlns:ns0=\"http://www.w3.org/2005/08/addressing\">http://www.af-klm.com/services/cargo/publishAWBScreening-V1/saveAWBScreening</ns0:Action>\r\n" + "\r\n" + "<ns0:To xmlns:ns0=\"http://www.w3.org/2005/08/addressing\"/>\r\n" + "\r\n" + "<ns0:MessageID xmlns:ns0=\"http://www.w3.org/2005/08/addressing\">988d2a2e-25df-4985-93e0-b952a89d8f44</ns0:MessageID>\r\n" + "\r\n" + "<ns0:RelatesTo xmlns:ns0=\"http://www.w3.org/2005/08/addressing\" RelationshipType=\"http://www.af-klm.com/soa/tracking/InitiatedBy\">b762bf9e-2487-42a3-bc88-be998364e51d</ns0:RelatesTo>\r\n" + "\r\n" + "<ns0:RelatesTo xmlns:ns0=\"http://www.w3.org/2005/08/addressing\" RelationshipType=\"http://www.af-klm.com/soa/tracking/PrecededBy\">b762bf9e-2487-42a3-bc88-be998364e51d</ns0:RelatesTo>\r\n" + "\r\n" + "<ns0:RelatesToxmlns:ns0=\"http://www.w3.org/2005/08/addressing\" RelationshipType=\"http://www.af-klm.com/soa/tracking/ReplyTo\"/>\r\n" + "\r\n" + " <ns2:trackingMessageHeader xmlns:jms1=\"http://www.tibco.com/namespaces/tnt/plugins/jms\" xmlns:ns0=\"soa://Framework/EEB/Common/Schemas/EEBMessage-v1_0\" xmlns:ns2=\"http://www.af-klm.com/soa/xsd/MessageHeader-V1_0\" xmlns:ns1=\"soa://Framework/Ops/Context/Schemas/LocalContext-v1_0\">\r\n" + "\r\n" + "<ns2:consumerRef>\r\n" + "\r\n" + "<ns2:userID>unknown</ns2:userID>\r\n" + "\r\n" + "<ns2:partyID>AF</ns2:partyID>\r\n" + "\r\n" +"<ns2:consumerID>w07576423</ns2:consumerID>\r\n" + "\r\n" + "<ns2:consumerLocation>CDG</ns2:consumerLocation>\r\n" + "\r\n" + "<ns2:consumerType>A</ns2:consumerType>\r\n" + "\r\n" + "<ns2:consumerTime>2022-06-01T14:44:45Z</ns2:consumerTime>\r\n" + "\r\n" + "</ns2:consumerRef>\r\n" + "\r\n" + "</ns2:trackingMessageHeader>\r\n" + "\r\n" + "</SOAP-ENV:Header>\r\n" + "\r\n" + "<SOAP-ENV:Body>\r\n" + "\r\n" + "<saveAWBScreening xmlns:jms1=\"http://www.tibco.com/namespaces/tnt/plugins/jms\" xmlns=\"http://www.af-klm.com/services/cargo/publishAWBScreening-V1/publishAWBScreening/xsd\" xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:ns0=\"soa://Framework/EEB/Common/Schemas/EEBMessage-v1_0\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">\r\n" + "\r\n" + "<awb>"+fullAWBNumber+"</awb>\r\n" + "\r\n" + " <airport>CDG</airport>\r\n" + "\r\n" + "<method>"+screeningMethod+"</method>\r\n" + "\r\n" + "<storageUnitCode>"+su+"</storageUnitCode>\r\n" + "\r\n" + "<locationCode>"+rapixEntryLoc+"</locationCode>\r\n" + "\r\n" + "<statusCode>"+executionResult+"</statusCode>\r\n" + "\r\n" + "<refusalReason/>\r\n" + "\r\n" + "<recommendationCode/>\r\n" + "\r\n" + "<screenerName>"+screener+"</screenerName>\r\n" + "\r\n" + "<screeningDate>"+timeStamp+"</screeningDate>\r\n" + "\r\n" + "<agent_type>ISS</agent_type>\r\n" + "\r\n" + "<agent_id>"+agentId+"</agent_id>\r\n" + "\r\n" + "<iso_country_code>"+countryCode+"</iso_country_code>\r\n" + "\r\n" + "<expiry>"+expiry+"</expiry>\r\n" + "\r\n" + "</saveAWBScreening>\r\n" + "\r\n" + "</SOAP-ENV:Body>\r\n" + "\r\n" + "</SOAP-ENV:Envelope>"; 
		else
