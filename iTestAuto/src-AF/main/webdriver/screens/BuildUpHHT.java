...
public class BuildUpHHT extends CustomFunctions {
	...
	*/
	 ...
	 */
	public void selectPOU(String location) throws AWTException, InterruptedException
	{
		try
		{
		...
		{
			writeExtent("Fail", "Value "+ data(location)+" not clicked in "+screenName);
		}
     ...
     */
     ...
     /** 
		...
		public void enterULDActualweight(String location,String actwt,String height,String scaleid) throws AWTException, InterruptedException, IOException
		{
			...
			// NO NEED TO SELECT LOCATION WHILE CAPTURING ACTUAL WEIGHT
