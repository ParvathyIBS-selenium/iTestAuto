 ...
 */
	...
	/**
	 * Description... Click DG verified check box
	 * @author A-9844
	 * @throws InterruptedException,IoException
	 */	

	public void clickDGVerified() throws InterruptedException, IOException {


		clickWebElement(sheetName, "btn_dgVerifedBox;xpath", "DG verified checkbox", screenName);
		waitForSync(2);
	}
 ...
 */
		...
		public void capturePI(String PI) throws InterruptedException {
			...
			enterValueInTextbox(sheetName, "inbx_packingInstruction;xpath", data(PI),"PI", screenName);
			keyPress("TAB");
		}
