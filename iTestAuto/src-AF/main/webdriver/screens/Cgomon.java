...
public class Cgomon extends CustomFunctions {
	...
	public Cgomon(WebDriver driver, ExcelReadWrite excelReadWrite, Xls_Read xls_Read2) {
...
/**@author A-10328
 * Description - Click on Flight number
 * @param FlightNo
 * @throws InterruptedException
 * @throws IOException
 */
public void clickFlightNo(String FlightNo) throws InterruptedException, IOException {
	waitForSync(3);
...
/**@author A-10328
* Description - To close the message content
* @throws InterruptedException
* @throws IOException
*/
public void clickBack() throws InterruptedException, IOException {
...
public void verifyMessageContent(List<String> MessageContent,String messageType,boolean msgContentsExists)
	...
	waitForSync(3);
	ele = findDynamicXpathElement("txt_rawmsg;xpath", sheetName,
