 ...
 */
	...
	public void selectScreeningMethod(String screeningMethod) throws InterruptedException, IOException
	{
		//Screening methods
		waitForSync(2);
		selectValueInDropdown(sheetName, "lst_screenMethod;xpath",	data(screeningMethod), "Screening method","VisibleText");
 ...
 * @throws IOException 
	...
	/**
	 * Description... Verify screeningmethodupdated
	 * @author A-10690
	 * @param screeningmethod
	 * @throws InterruptedException
	 */
	public void verifyScreeningMethodupdated(String screeningmethod,Boolean updated) throws InterruptedException
	{
		if(updated)
		{
		String locator = xls_Read.getCellValue(sheetName, "txt_updatedscreeningmethod");
		locator=locator.replace("SM",data(screeningmethod));
...
* @param result
	 ...
	 * @throws IOException 
	 */
	public void editScreeningdetails(String screeningMethod,String pcs,String wt,String result) throws InterruptedException, IOException
	{
		//Screening methods
		waitForSync(2);
		selectValueInDropdown(sheetName, "lst_screenMethod;xpath",	data(screeningMethod), "Screening method","VisibleText");
		...
		clickWebElement(sheetName, "btn_editOk;xpath","OK button", screenName);
