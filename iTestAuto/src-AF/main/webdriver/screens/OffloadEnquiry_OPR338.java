...
public class OffloadEnquiry_OPR338 extends CustomFunctions  {
	...
	String sheetName="OffloadEnquiry_OPR338";
	String ScreenName="Offload Enquiry";
	String screenId="OPR338";


	public OffloadEnquiry_OPR338(WebDriver driver, ExcelReadWrite excelReadWrite,
			Xls_Read xls_Read2) {
