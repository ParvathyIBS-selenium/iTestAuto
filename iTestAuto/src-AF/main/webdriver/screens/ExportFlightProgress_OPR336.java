...
public void verifySatchelHandoverStatus(String status) throws InterruptedException {
	...
	String locator1 = xls_Read.getCellValue(sheetName, "txt_SatchelStatus;xpath");
	String rowcount=driver.findElement(By.xpath(locator1)).getAttribute("data-ic-csid");
			String count=rowcount.substring(2);

	String locator = xls_Read.getCellValue(sheetName, "txt_SatchelHandoverStatus1;xpath");
	...
	{
		writeExtent("Fail", "Could not verify  the status"+data(status));
