...
public class DamageCaptureHHT extends CustomFunctions {
	...
	/**
	 * @author A-9844
	 * Description : Enter damage code packaging
	 * @throws InterruptedException 
	 */
	public void enterDamageCodePackaging(String code) throws InterruptedException
	{
		
		try
		{

		clickActionInHHT("damCaphht_btn_damageCodePackaging;xpath",proppathhht,"Damage Code Packaging",screenName);
		
		waitForSync(2);
		androiddriver.findElement(By.xpath("//android.widget.TextView[@text='"+code+"']")).click();
		writeExtent("Pass", "Point of notice "+code+" is entered "+screenName);
		}
		
		catch(Exception e)
		{
			 writeExtent("Fail", "Failed to enter point of notice "+code+screenName);
		}
