...
public class ExportManifest_OPR344  extends CustomFunctions {
	 ...
	 * @throws IOException
	 */
	public void assignDGSLPopUp() throws InterruptedException, IOException{
		...
		if(size>=1)
		{
			...
			if (actText.contains("Do you want to unassign DG/SL details?"))
			{
				waitForSync(2);  
				clickWebElement(sheetName, "txt_OK;xpath", "Ok Button", screenID);
				waitForSync(2);
	 ...
	 * @throws IOException 
	 */
	public void offloadAwbWithLocationPiecesAndReason(String ofldPcs,String OfldWt,String scc) throws InterruptedException, AWTException, IOException
	{
...
/**
	...
	public void verifyLoadingPriorityfromCFP(String loadingPrio,String awb){
		...
		try
		{
			String actLoadingPrio=driver.findElement(By.xpath(xls_Read.getCellValue(sheetName, "txt_loadingPriority;xpath").replace("awb", data(awb)))).getText();
			waitForSync(1);
