...
public class ImportPlanningProgress_ADD008 extends CustomFunctions {
	...
	/*** @author A-9175
	 * @desc : select BDN Status
	 * @param status
	 * @throws InterruptedException
	 */
	public void selectBDNStatus(String status) throws InterruptedException
	{
		waitForSync(3);
		String locatorbdnStatus=xls_Read.getCellValue(sheetName, "txt_bdnStatus;xpath");
		String bdnstatusoption=driver.findElement(By.xpath(locatorbdnStatus)).getText();
		System.out.println(bdnstatusoption);
		if(bdnstatusoption.contains("--Select--"))
		{
			waitForSync(3);
			clickWebElementByWebDriver(sheetName, "BDNspan_arrow;xpath", "List BDN Status",screenId);
			String locator=xls_Read.getCellValue(sheetName, "BDNhtml_div;xpath");
