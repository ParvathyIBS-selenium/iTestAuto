...

{
	 ...
	 * @throws AWTException
	 */
	public void selectTitleAndSubTitleTab(String titleTab, String subTitleTab)
		...
		try {
			...
			waitForSync(2);
			String subtitle = xls_Read.getCellValue(SheetName, "lst_selectSubTitle;xpath").replace("*",
					data(subTitleTab));
			driver.findElement(By.xpath(subtitle)).click();
			waitForSync(6);
			writeExtent("Pass", "Successfully selected the Title Tab " + data(titleTab) + " and SubTitle Tab "
					+ data(subTitleTab) + " on " + ScreenName);
	 ...
	 * @throws InterruptedException
	 */
	public void enterBookingDeliveryAndArrivalDate(String deliveryDate, String ArrivalDate)
			throws InterruptedException {

		enterValueInTextbox(SheetName, "inbx_bookingDeliveryDate;id", data(deliveryDate), "Booking Delivery Date",
				ScreenName);
		waitForSync(2);
		enterValueInTextbox(SheetName, "inbx_bookingArrivalDate;id", data(ArrivalDate), "Booking Arrival Date",
				ScreenName);
		waitForSync(3);
	}
	 ...
	 * @throws InterruptedException
	 */
	public void enterBookingDeliveryAndArrivalTime(String deliveryTime, String ArrivalTime)
			throws InterruptedException {

		enterValueInTextbox(SheetName, "inbx_bookingDeliveryTime;name", data(deliveryTime), "Booking Delivery Time",
				ScreenName);
		waitForSync(1);
		enterValueInTextbox(SheetName, "inbx_bookingArrivalTime;name", data(ArrivalTime), "Booking Arrival Time",
				ScreenName);
		waitForSync(2);
	}
	...
	public void selectCommodityCode(String commodityCode) {
		...
		selectValueInDropdown(SheetName, "drpdn_commodityCode;id", data(commodityCode), "Select Commodity Code",
				"VisibleText");
		waitForSync(2);
	}
	...
	public void selectServiceLevelAndHandlingNeeds(String serviceLevel, String handlingNeeds) {
		...
		selectValueInDropdown(SheetName, "drpdn_serviceLevel;name", data(serviceLevel), "Select Service Level",
				"VisibleText");
		waitForSync(1);
		selectValueInDropdown(SheetName, "drpdn_handlingNeeds;name", data(handlingNeeds), "Select Handling Needs",
				"VisibleText");
		waitForSync(2);
	}
	...
	public void selectOptionalSCC(String scc) {
		...
		try {
			driver.findElement(
					By.xpath(xls_Read.getCellValue(SheetName, "chk_optionalScc;xpath").replace("*", data(scc))))
					.click();
	...
	public void selectConditionalSCC(String scc) {
		...
		try {
			driver.findElement(
					By.xpath(xls_Read.getCellValue(SheetName, "chk_conditionalScc;xpath").replace("*", data(scc))))
					.click();
			writeExtent("Pass", "Selected SCC ad " + data(scc) + " on " + ScreenName);
	...
	/**
	 * @author A-10690
	 * @Desc To select the given ServiceLevel,product group and corresponding
	 *       Handling Needs
	 * @param serviceLevel
	 * @param handlingNeeds
	 * @param product
	...
	public void selectServiceLevelDetails(String serviceLevel, String productGroup, String handlingNeeds) {
		...
		selectValueInDropdown(SheetName, "drpdn_serviceLevel;name", data(serviceLevel), "Select Service Level",
				"VisibleText");
		selectValueInDropdown(SheetName, "drpdn_productgroup;name", data(productGroup), "Select Service Level",
				"VisibleText");
		waitForSync(1);
		selectValueInDropdown(SheetName, "drpdn_handlingNeeds;name", data(handlingNeeds), "Select Handling Needs",
				"VisibleText");
	...
	public void selectCheckList(String answer1, String answer2) throws InterruptedException, IOException {
		...
		selectValueInDropdown(SheetName, "drpdn_checklistCode1;xpath", data(answer1), "Select checklist answer",
				"VisibleText");
		waitForSync(2);
		selectValueInDropdown(SheetName, "drpdn_checklistCode2;xpath", data(answer2), "Select checklist answer",
				"VisibleText");
	 ...
	 * @throws AWTException
	 */
	public void enterFlightInfo(String carrierCode, String fltNo, String fltOrg, String fltDest, String fltDepDate)
			throws InterruptedException, IOException, AWTException {
		...
		try {
			...
			enterValueInTextbox(SheetName, "inbx_flightDepDate;id", data(fltDepDate), "Flight Depature Date",
					ScreenName);
	...
	/**
	 * @author A-9847
	 * @Desc To make all the RouteSearch and Evaluation settings either to
	 *       Yes/No
	 * @param option
	 *            - yes/No
	 */
	public void selectRouteSearchAndEvaluationSetting(String option) {
		...
		try {
			if (!driver.findElement(By.id("searchOptionsButton")).isDisplayed()) {
				clickWebElement(SheetName, "div_routeSearchTab;id", "Route Search & Evaluation Settings Tab",
						ScreenName);
			}
			...
			if (option.equals("yes")) {
				driver.findElement(
						By.xpath(xls_Read.getCellValue(SheetName, "btn_chkRestriction;xpath").replace("*", "true")))
						.click();
				driver.findElement(
						By.xpath(xls_Read.getCellValue(SheetName, "btn_chkCapacity;xpath").replace("*", "true")))
						.click();
				driver.findElement(By.xpath(xls_Read.getCellValue(SheetName, "btn_chkRate;xpath").replace("*", "true")))
						.click();
				driver.findElement(
						By.xpath(xls_Read.getCellValue(SheetName, "btn_chkAllotment;xpath").replace("*", "true")))
						.click();
				driver.findElement(
						By.xpath(xls_Read.getCellValue(SheetName, "btn_chkLoopUpPrice;xpath").replace("*", "true")))
						.click();
			} else {
				driver.findElement(
						By.xpath(xls_Read.getCellValue(SheetName, "btn_chkRestriction;xpath").replace("*", "false")))
						.click();
				driver.findElement(
						By.xpath(xls_Read.getCellValue(SheetName, "btn_chkCapacity;xpath").replace("*", "false")))
						.click();
				driver.findElement(
						By.xpath(xls_Read.getCellValue(SheetName, "btn_chkRate;xpath").replace("*", "false"))).click();
				driver.findElement(
						By.xpath(xls_Read.getCellValue(SheetName, "btn_chkAllotment;xpath").replace("*", "false")))
						.click();
				driver.findElement(
						By.xpath(xls_Read.getCellValue(SheetName, "btn_chkLoopUpPrice;xpath").replace("*", "false")))
						.click();
			}
	...
	/**
	 * @author A-9175
	 * @Des: capture second flight leg info
	 * @param carrierCode
	 * @param fltNo
	 * @param fltOrg
	 * @param fltDest
	 ...
	 * @throws AWTException
	 */
	public void enterFlightSecondInfo(String carrierCode, String fltNo, String fltOrg, String fltDest,
			String fltDepDate) throws InterruptedException, IOException, AWTException {
		...
		try {
			...
			waitForSync(3);
			enterValueInTextbox(SheetName, "inbx_carrierCodeSecond;id", data(carrierCode), "Carrier Code", ScreenName);
			enterValueInTextbox(SheetName, "inbx_flightNoSecond;id", data(fltNo), "Flight Number", ScreenName);
			keyPress("TAB");
			enterValueInTextbox(SheetName, "inbx_flightOrgSecond;id", data(fltOrg), "Flight Origin", ScreenName);
			enterValueInTextbox(SheetName, "inbx_flightDestSecond;id", data(fltDest), "Flight Destination", ScreenName);
			enterValueInTextbox(SheetName, "inbx_flightDepDateSecond;id", data(fltDepDate), "Flight Depature Date",
					ScreenName);
	...
	public void clickAddNew() throws InterruptedException, IOException {
		...
		clickWebElement(SheetName, "btn_addNewButton;xpath", "Add New Button", ScreenName);
		waitForSync(4);
	}
	 ...
	 * @throws IOException
	 */
	public void clickPartBooking() throws InterruptedException, IOException {

		clickWebElement(SheetName, "btn_partbooking;xpath", "Part Booking Button", ScreenName);
		waitForSync(4);
	}
	...
	public void enterPartshipmentAWBDetails(String awbPre, String awbNumber) throws InterruptedException {

		enterValueInTextbox(SheetName, "inbx_awbPrefixPartShipment;id", data(awbPre), "AWB Prefix", ScreenName);
		enterValueInTextbox(SheetName, "inbox_awbInfo_awbNumber;id", data(awbNumber), "AWB Number", ScreenName);
		waitForSync(2);
	}
	...
	public void clickSearch() throws InterruptedException, IOException {
		...
		waitForSync(4);
		waitTillScreenload(SheetName, "inbx_awbSuffix;id", "AWB Suffix", ScreenName);
	}
	 ...
	 * @throws AWTException
	 */
	public void enterAwbSuffix(String suffix) throws InterruptedException, IOException, AWTException {
		enterValueInTextbox(SheetName, "inbx_awbSuffix;id", suffix, "Suffix Code", ScreenName);
	}
	 ...
	 * @throws IOException
	 */
	public void clickCreatePartBooking() throws InterruptedException, IOException {

		clickWebElement(SheetName, "btn_createPartBooking;xpath", "Create Part Booking Button", ScreenName);
		waitForSync(4);
		waitTillScreenload(SheetName, "tab_flightDetails;xpath", "Flight Details", ScreenName);
	}
	 ...
	 * @throws IOException
	 */
	public void clickEditButtonIcon() throws InterruptedException, IOException {

		clickWebElement(SheetName, "btn_modifyBookingEdit;xpath", "Modify Booking Edit Button", ScreenName);
		waitForSync(4);
		waitTillScreenload(SheetName, "tab_flightDetails;xpath", "Flight Details", ScreenName);
	}
	 ...
	 * @throws IOException
	 */
	public void getTextFlight() throws InterruptedException, IOException {

		List<WebElement> fltNums = driver.findElements(By.xpath(
				"//tbody[@id='ROUTE_FLIGHT_SEGMENTS_FIELD_AREA_0']//tr[contains(@id,'ROUTE_FLIGHT_SEGMENTS_ROW')]//td[4]"));
		for (WebElement flight : fltNums) {
	 ...
	 * @author A-9175
	 */
	public void clickFlightInfoTab() {
		try {
			if (!driver.findElement(By.name("segmentEnforceCapacityCheckbox")).isDisplayed()) {
				clickWebElement(SheetName, "div_flightInfoTab;id", "Flight Info Tab", ScreenName);
			}
		} catch (Exception e) {
			writeExtent("Fail", "Failed to Click the Flight Tab Info on " + ScreenName);
		}
	}
	 ...
	 * @throws InterruptedException
	 */
	public void editPcsWgtInfo(String Pcs, String Wgt, String Vol) throws InterruptedException {
		enterValueInTextbox(SheetName, "txt_editTotalPcs;xpath", data(Pcs), "Edited Pcs", ScreenName);
		enterValueInTextbox(SheetName, "txt_editTotalWgt;xpath", data(Wgt), "Edited Wgt", ScreenName);
		enterValueInTextbox(SheetName, "txt_editTotalVol;xpath", data(Vol), "Edited Vol", ScreenName);
	...
	public void clickSave() throws InterruptedException, IOException {
		try {
			...
			waitForSync(4);
			waitTillScreenload(SheetName, "txt_saveConfirmationMsg;xpath", "Save Information", ScreenName);
			String bookingConfirmation = xls_Read.getCellValue(SheetName, "txt_saveConfirmationMsg;xpath");
			System.out.println(driver.findElements(By.xpath(bookingConfirmation)).size());
			if (driver.findElements(By.xpath(bookingConfirmation)).size() == 1)
				writeExtent("Pass", "Successfully Saved Booking Confirmation on " + ScreenName);
			else
				writeExtent("Fail", "Failed to Save Booking Confirmation on " + ScreenName);
		} catch (Exception e) {
			writeExtent("Fail", "Failed to Save Booking Confirmation on " + ScreenName);
		}
	}
	 ...
	 * @param vol
	 */
	public void enterFlightInfoWithShipmentDetails(String carrierCode, String fltNo, String fltOrg, String fltDest,
			String fltDepDate, String pcs, String wgt, String vol) {
		try {
			if (!driver.findElement(By.name("segmentEnforceCapacityCheckbox")).isDisplayed()) {
				clickWebElement(SheetName, "div_flightInfoTab;id", "Flight Info Tab", ScreenName);
			}
			...
			enterValueInTextbox(SheetName, "inbx_flightDepDate;id", data(fltDepDate), "Flight Depature Date",
					ScreenName);
			enterValueInTextbox(SheetName, "txt_editTotalPcs;xpath", data(pcs), "Shipment Pcs", ScreenName);
			enterValueInTextbox(SheetName, "txt_editTotalWgt;xpath", data(wgt), "Shipment Wgt", ScreenName);
			enterValueInTextbox(SheetName, "txt_editTotalVol;xpath", data(vol), "Shipment Vol", ScreenName);
		} catch (Exception e) {
			writeExtent("Fail", "Failed to enter the Flight Info on " + ScreenName);
		}
	 ...
	 * @throws IOException
	 */
	public void clickPartSubmitBooking() throws InterruptedException, IOException {

		try {
			clickWebElement(SheetName, "btn_submitBooking;xpath", "Part Submit Booking", ScreenName);
			waitTillScreenload(SheetName, "div_bookingConfirm;xpath", "Booking Information", ScreenName);
			String bookingConfirmation = xls_Read.getCellValue(SheetName, "div_bookingConfirm;xpath");
			System.out.println(driver.findElements(By.xpath(bookingConfirmation)).size());
			if (driver.findElements(By.xpath(bookingConfirmation)).size() == 1)
