...
public class Jsonbody extends CustomFunctions {
	...
	/**
	 * @author A-9847
	 * @param type - whether ULD or Cart
	 * @param uldType - whether AKE or KAR
	 * @param uldNo - uld number
	 * @param carrierCode 
	 * @param flightDate
	 * @param flightNo
	 * @param actWgt - Actual weight
	 * @throws JsonProcessingException
	 */
	public void postRequest(String type,String uldType,String uldNo,String carrierCode,String flightDate,String flightNo,String actWgt ) throws JsonProcessingException
	{  
			    ...
			    .header("Content-Type","application/json").log().all().body(obj).post(url);
			      ...
			      if(val==200)
			      {
			    		writeExtent("Pass","Response code of SendWCSUnitStatusUpdate_UOW is "+val);
			      }
			      else
			      {
			    	  writeExtent("Fail","Response code of SendWCSUnitStatusUpdate_UOW is "+val);
			      }
	}
