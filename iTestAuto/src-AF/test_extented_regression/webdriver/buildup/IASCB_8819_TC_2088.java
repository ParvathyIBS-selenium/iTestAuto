...
/** Provision to perform HAWB buildup using scanner and tablet   **/


public class IASCB_8819_TC_2088 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/**** XFZB Message loading ****/

			cust.createXMLMessage("MessageExcelAndSheetXFZB", "MessageParamXFZB");
			String hawbNo=cust.data("AWBNo")+"H1";
			map.put("hawbNo", hawbNo);
			cust.modifyXml("XFZB","ns2:BusinessHeaderDocument", "ID", hawbNo);
			MSG005.loadFromFile("All", "ALL", "MQ-SERIES", "", "Origin", "", "XFZB", true);
			cust.closeTab("MSG005", "List Messages");

			/****  OPR029-Capture HAWB  ***/

			cust.searchScreen("OPR029","Capture HAWB");
			OPR029.listHAWB("prop~AWBNo", "prop~CarrierNumericCode");
			...
			cust.closeTab("OPR029", "Capture HAWB");
			...
			buhht.clickSelectHAWB();
			buhht.clickSelectAll();
			buhht.clickOk();
			buhht.clickSave();
			...
			OPR344.maximizeAllDetails(cust.data("UldNum"));
			OPR344.verifyHAWBpresent("1 HAWB",cust.data("awbNumber"));
			OPR344.verifyPiecesWeight(cust.data("Pieces")+"/"+cust.data("Pieces")+" Pcs",cust.data("Weight")+" /"+cust.data("Weight")+" kg",cust.data("awbNumber"));
