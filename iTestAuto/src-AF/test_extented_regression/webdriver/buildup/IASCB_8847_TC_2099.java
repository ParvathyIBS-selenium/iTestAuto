...
public class IASCB_8847_TC_2099 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("FlightNumber", cust.data("prop~flight_code")+" "+ cust.data("FlightNo"));
			...
			/**ssm loading flight 1**/

			map.put("FlightNum",cust.data("FullFlightNo"));
			...
			/**ssm loading flight 2**/

			map.put("FlightNum",cust.data("FullFlightNo1"));
			cust.createTextMessage("MessageExcelAndSheetSSM", "MessageParamSSM");
			...
			/**** XFBL Message loading flight f1 ****/
			...
			OPR343.listFlightDetails("carrierCode", "FlightNo1","StartDate");
			OPR343.clickprint("FullFlightNo1");
			OPR343.verifySatchelGeneration("Satchel","FullFlightNo1");
			...
			int[] cols={3};
			String[] values={"Manifested In"+" "+cust.data("FlightNumber")+" "+cust.data("StartDate")+" "+cust.data("Destination")};
			OPR086.verifyAWBDetails(cols, values, cust.data("AWBNo"));
			OPR086.verifySatchelStatusFontColor("AWBNo");
