...
public class PublishShipmentRelocation_TC_10207 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String[] actVerfValues1 ={pmKey1,cust.data("Pieces1").split(",")[0],cust.data("Weight1").split(",")[0],cust.data("HA").split(",")[0]+cust.data("Location")};
			Cgospa.verifyFlightDetails(verfCols1, actVerfValues1,pmKey1);

			//verifiying Target Location details
			String[] actVerfValues2 ={pmKey2,cust.data("Pieces1").split(",")[1],cust.data("Weight1").split(",")[1],cust.data("HA").split(",")[1]+cust.data("TargetLocation")};
