...
/** TC_21_Verify Recalculation of frangible to compressible loability status for rigid ratio update in built up volume***/


public class IASCB_19268_TC_11190 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
							...
							cust.data("awbNumber2") + ";" + cust.data("Pieces") + ";" + cust.data("Weight") + ";"
									...
									cust.data("awbNumber3") + ";" + cust.data("Pieces") + ";" + cust.data("Weight") + ";"
											...
											cust.data("awbNumber4") + ";" + cust.data("Pieces") + ";" + cust.data("Weight") + ";"
													+ cust.data("Volume").split(",")[2] + ";" + cust.data("ShipmentDesc").split(",")[1]};
			String scc[] = { cust.data("SCC").split(",")[0], cust.data("SCC").split(",")[1], cust.data("SCC").split(",")[2], cust.data("SCC").split(",")[1] };
		...
		OPR026.asIsExecute();
			...
			OPR344.listFlight("carrierCode", "FlightNo","StartDate");
			OPR344.clickEditULDdetailsByJS("UldNum");
			OPR344.addAWBstoExistingULDwithPcsWeight("UldNum","CarrierNumericCode","AWBNo4","Pieces","Weight");
			cust.waitForSync(1);
			OPR344.clickEditULDdetailsByJS("UldNum");
			...
			//Verify recalculated loadability status getting displayed as Compressible 
			cust.searchScreen("OPR063", "Dead load statement");
			OPR063.listFlightDetails("carrierCode", "FlightNo", "StartDate");
			OPR063.selectULD(cust.data("UldNum"));
			OPR063.clickULDLoadingInstuctor();
			...
			//Verify recalculated loadability status getting displayed as Compressible in cafeed
			int[] col = {20};
