...
/*TC_01_Verify the Piercible loadability status when an awb built in ULD contains PRC SCC*/

public class IASCB_19268_TC_11133 extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Verify loadability status getting displayed as Piercible in cafeed
			int[] col = {20};
