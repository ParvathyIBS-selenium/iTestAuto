...
/**TC_23_Verify Recalculation of mixed  to rigid loability status when RIGID SCC AWB assigned to ULD - scanner***/


public class IASCB_19268_TC_11192 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//Verify loadability status getting displayed as Mixed
			...
			buhht.enterAWBDetailsWithoutPcsWgt("FullAWBNo3");
			map.put("SCC",cust.data("SCC").split(",")[2]);
			...
			//Verify loadability status getting displayed as Rigid in cafeed
			int[] col = {20};
