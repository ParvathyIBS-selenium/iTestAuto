...
/**TC_09_Verify shipment location details sent to CGOSPA for manual relocation of complete pieces and weight during export operations using HHT**/
...
public class PublishShipmentRelocation_TC_3033 extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			relocationhht.enterValue("awbnumber");
			libr.waitForSync(3);
			...
			String su =cust.data("CarrierNumericCode")+cust.data("AWBNo")+"002";
			int[] verfCols1={10,11,14};
			String[] actVerfValues1 ={cust.data("Pieces"),cust.data("Weight"),cust.data("HA")+cust.data("Relocation")};
			...
			map.put("awbNumber", cust.data("prop~stationCode")+cust.data("AWBNo"));
