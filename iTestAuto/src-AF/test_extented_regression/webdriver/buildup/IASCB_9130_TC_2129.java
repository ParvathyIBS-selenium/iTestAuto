...
public class IASCB_9130_TC_2129 extends BaseSetup{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			WHS013.verifyZone(cust.data("StorageAreaZone_CDG"),CTXZoneSU1);
			...
			WHS013.verifyZone(cust.data("StorageAreaZone_CDG"),CTXZoneSU2);
			...
			to.verifySourcelocandDestLocIsDifferent("destnLocationSU1","descPITLocationOpenedSU1");
			to.clickRefresh();
			to.searchShipment("SU2");
			...
			to.verifySourcelocandDestLocIsDifferent("destnLocationSU2","descPITLocationOpenedSU2");
			libr.quitApp();
