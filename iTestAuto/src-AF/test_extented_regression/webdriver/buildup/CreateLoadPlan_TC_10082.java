...
/**  TC_03_Verify load plan details are updated in icargo when multiple CFP message is received for same flight or date.    **/
...
public class CreateLoadPlan_TC_10082 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			aflsfp.enterFlightInstructionRemarks("UpdatedRemarks");
			aflsfp.clickSave();
			aflsfp.clickWHHandOver();
			aflsfp.verifyWHHandOverStatus();
			libr.quitBrowser();
			...
			ADD004.listFlight("carrierCode","FlightNo","StartDate");
			ADD004.verifyShipmentInLoadPlan("AWBNo");
			//Verifying updated loading priority and flight instruction
			ADD004.verifyLoadingPriorityfromCFP("UpdatedloadingPrio", "AWBNo");
			ADD004.verifyFlightInstruction("UpdatedRemarks");
			//Allocating
			...
			String[] text={cust.data("Remarks"),cust.data("UpdatedRemarks")};
			bulhht.verifyFlightInstruction("FlightNum",text);
			libr.quitApp();
