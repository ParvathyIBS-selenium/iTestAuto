...
public class PublishShipmentRelocation_TC_3034 extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String[] actVerfValues1 ={cust.data("Pieces1"),cust.data("Weight1"),cust.data("HA")+cust.data("Relocation")};
