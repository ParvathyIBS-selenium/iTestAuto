...
/***Activation  of relocation task at export station**/
...
public class IASCB_9130_TC_2131 extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			MSG005.verifyMessageDetails(verfColsRCS, actVerfValuesRCS, pmKeyRCS,"val~XFWB",false);
			libr.waitForSync(1);
			...
			MSG005.selectStatus("Sent");
			MSG005.clickList();
			String pmKeyRCS1=cust.data("CarrierNumericCode")+" - "+cust.data("AWBNo");
			int verfColsRCS1[]={9};
			...
			//Manual relocation from the destination Control Location to the Rapix Exit Point
			cust.searchScreen("WHS011", "Warehouse Relocation");
			WHS011.enterAWBdetails("CarrierNumericCode","prop~AWBNo");
			WHS011.clickList();
			WHS011.clickAWBcheckBox();
