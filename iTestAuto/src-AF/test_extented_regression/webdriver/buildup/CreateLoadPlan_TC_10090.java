...
/** TC_11_Verify load plan details are created in icargo through CFP message for an INTACT shipment   **/
...
public class CreateLoadPlan_TC_10090 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String loadingPrio=aflsfp.getLoadingPriority("FullAWBNo");
			map.put("loadingPriority",loadingPrio);
			...
			ADD004.verifyLoadingPriorityfromCFP("loadingPriority", "AWBNo");
			...
			String[] intructions={cust.data("Remarks")};
			bulhht.verifyFlightInstruction("FlightNumber",intructions);
			libr.quitApp();
