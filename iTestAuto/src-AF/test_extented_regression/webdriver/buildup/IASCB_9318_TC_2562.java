...
/**Enhancement to the Capture Overhang Details**/
...
public class IASCB_9318_TC_2562 extends BaseSetup
{
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			buhht.verifyPieces(cust.data("Pieces"));
			buhht.clickMoreOptions();
			buhht.clickCaptureOverhangIndent();
			buhht.verifyDimensions("F");
			buhht.verifyDimensions("L");
			buhht.verifyDimensions("R");
			buhht.verifyDimensions("A");
			libr.quitApp();
