...
/**  
2312: TC_02_Display of split indicator against the AWB in the AWB list for OAL AWB.

.  **/



public class IASCB_96755_TC_2312 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			FLT006.listFlightDetails("carrierCode","prop~flightNo", "StartDate");
			...
			bdhht.verifySplitIndicator("Uld", "FullAWBNo");
			bdhht.verifySCC("SCC");
			bdhht.verifyOriginAndDestination("Origin", "Destination");
			bdhht.verifyPiecesWeight(cust.data("Pieces1").split(",")[0], cust.data("Weight1").split(",")[0], "val~Manifested");
			bdhht.verifyPiecesWeight("0", "0", "val~Received");
