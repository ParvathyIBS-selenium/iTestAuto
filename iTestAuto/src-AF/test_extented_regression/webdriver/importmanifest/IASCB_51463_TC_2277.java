...
/** TC_02_capture the contour of Pallets-PMC type **/


public class IASCB_51463_TC_2277 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			uldsighthht.verifyContourFiledIsPresent("val~Contour");
			uldsighthht.verifyNoDefaultContourIsDisplayed("val~Select Contour");
