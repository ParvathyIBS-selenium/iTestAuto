...
/**  Verify LPS time in Import Manifest Screen for Transit Shipment - Multiple onward flight  **/
...
public class IASCB_19907_TC_2251 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String STA=cust.timeCalculation(currtimeCDG, "dd-MMM-yyyy HH:mm","HOUR",4);
			...
			FLT003.enterFlightDetails("Route2", "scheduleType", "FCTL", "Office", "flightType");
			String currtimeCDG3=cust.createDateFormatWithTimeZone("dd-MMM-yyyy HH:mm", 0, "DAY", "Europe/Paris");
			String STD3=cust.timeCalculation(currtimeCDG3, "dd-MMM-yyyy HH:mm","HOUR",7);
			map.put("STDTime", STD3.split(" ")[1]);
			String STA3=cust.timeCalculation(currtimeCDG3, "dd-MMM-yyyy HH:mm","HOUR",9);
			...
			String FlightNum4 = WebFunctions.getPropertyValue(proppath, "flightNumber");
			FlightNum4 = FlightNum4.replace(cust.data("prop~flight_code"),cust.data("carrierCode"));
			map.put("FullFlightNo4", FlightNum4);
			map.put("FlightNo4", FlightNum3.substring(2));

			FLT003.enterFlightDetails("Route2", "scheduleType", "FCTL", "Office", "flightType");
			String currtimeCDG4=cust.createDateFormatWithTimeZone("dd-MMM-yyyy HH:mm", 0, "DAY", "Europe/Paris");
			String STD4=cust.timeCalculation(currtimeCDG4, "dd-MMM-yyyy HH:mm","HOUR",8);
			map.put("STDTime", STD4.split(" ")[1]);
			String STA4=cust.timeCalculation(currtimeCDG4, "dd-MMM-yyyy HH:mm","HOUR",10);
			map.put("STATime", STA4.split(" ")[1]);
			map.put("STDDate", STD4.split(" ")[0]);
			map.put("STADate", STA4.split(" ")[0]);
			FLT003.enterLegCapacityDetails("STDDate","STADate","STDTime","STATime", "AircraftType", "");		
			cust.switchToWindow("getParent");
			cust.switchToFrame("contentFrame", "FLT003");
			FLT003.clickSave();
			...
			String FlightNum5 = WebFunctions.getPropertyValue(proppath, "flightNumber");
			FlightNum5 = FlightNum5.replace(cust.data("prop~flight_code"),cust.data("carrierCode"));
			map.put("FullFlightNo5", FlightNum5);
			map.put("FlightNo5", FlightNum5.substring(2));

			FLT003.enterFlightDetails("Route2", "scheduleType", "FCTL", "Office", "flightType");
			String currtimeCDG5=cust.createDateFormatWithTimeZone("dd-MMM-yyyy HH:mm", 0, "DAY", "Europe/Paris");
			String STD5=cust.timeCalculation(currtimeCDG5, "dd-MMM-yyyy HH:mm","HOUR",9);
			map.put("STDTime", STD5.split(" ")[1]);
			String STA5=cust.timeCalculation(currtimeCDG5, "dd-MMM-yyyy HH:mm","HOUR",11);
			map.put("STATime", STA5.split(" ")[1]);
			map.put("STDDate", STD5.split(" ")[0]);
			map.put("STADate", STA5.split(" ")[0]);
			FLT003.enterLegCapacityDetails("STDDate","STADate","STDTime","STATime", "AircraftType", "");		
			cust.switchToWindow("getParent");
			cust.switchToFrame("contentFrame", "FLT003");
			FLT003.clickSave();
			...
			String shipment1[] = { libr.data("FullAWBNo1") + ";" + cust.data("Pieces1") + ";" + cust.data("Weight1")
			...
			String shipment2[] = { libr.data("FullAWBNo1") + ";" + cust.data("Pieces2") + ";" + cust.data("Weight2")
			+ ";" + cust.data("Volume2") + ";" + libr.data("ShipmentDesc") };
			cust.createXMLMessage("MessageExcelAndSheetXFBL", "MessageParamXFBL");
			cust.createXFBLMessage("XFBL_2", shipment2, sccs, routings);
			Cgocxml.sendMessageCgoCXML("ICARGO");

			/****** Loading XFBL for Fourth Flight ***/
			// Create the message XFBL with AWB1
			map.put("FullFlightNumber", cust.data("FullFlightNo4"));
			map.put("FBLDate", cust.createDateFormat("ddMMMyyyy", 0, "DAY", "").toUpperCase());
			cust.createXMLMessage("MessageExcelAndSheetXFBL", "MessageParamXFBL");
			String shipment3[] = { libr.data("FullAWBNo2") + ";" + cust.data("Pieces1") + ";" + cust.data("Weight1")
			+ ";" + cust.data("Volume1") + ";" + libr.data("ShipmentDesc") };
			cust.createXFBLMessage("XFBL_2", shipment3, sccs, routings);
			Cgocxml.sendMessageCgoCXML("ICARGO");

			/****** Loading XFBL for fith Flight ***/
			// Create the message XFBL with AWB2
			map.put("FullFlightNumber", cust.data("FullFlightNo5"));
			String shipment4[] = { libr.data("FullAWBNo2") + ";" + cust.data("Pieces2") + ";" + cust.data("Weight2")
			+ ";" + cust.data("Volume2") + ";" + libr.data("ShipmentDesc") };
			cust.createXMLMessage("MessageExcelAndSheetXFBL", "MessageParamXFBL");
			cust.createXFBLMessage("XFBL_2", shipment4, sccs, routings);
			Cgocxml.sendMessageCgoCXML("ICARGO");

			/***** XFWB Loading for AWB ***/
			// Create XFWB message
			map.put("awbnumber", cust.data("FullAWBNo1"));
			map.put("Pcs", cust.data("Piecesnew"));
			map.put("Wgt", cust.data("Weightnew"));
			...
			String shipment[] = { libr.data("FullAWBNo1") + ";" + cust.data("Piecesnew") + ";" + cust.data("Weightnew")
			+ ";" + cust.data("Front1") + ";" + libr.data("ShipmentDesc"),libr.data("FullAWBNo2") + ";" + cust.data("Piecesnew") + ";" + cust.data("Weightnew")
			+ ";" + cust.data("Front1") + ";" + libr.data("ShipmentDesc") };
			...
			//Buildup closure time for Flight F4
			Date buildup_ClosureTimeF4=OPR367.buildupClosureTimeCalculation(STD4, milestoneCalcTimeForBuildupClosure);

			//Buildup closure time for Flight F5
			Date buildup_ClosureTimeF5=OPR367.buildupClosureTimeCalculation(STD5, milestoneCalcTimeForBuildupClosure);


			//verify LPS for Transit Shipment - Single onward flight
			Date lps=OPR367.min(CIQF1,buildup_ClosureTimeF2,buildup_ClosureTimeF3,buildup_ClosureTimeF4,buildup_ClosureTimeF5);
