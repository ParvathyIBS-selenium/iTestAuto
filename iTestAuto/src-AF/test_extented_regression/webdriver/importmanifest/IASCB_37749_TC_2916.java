...
public class IASCB_37749_TC_2916 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			msgContentsPresent1.add("val~<ram:TransportSplitDescription>P</ram:TransportSplitDescription>");
			...
			msgContentsPresent2.add("val~<ram:TransportSplitDescription>P</ram:TransportSplitDescription>");
