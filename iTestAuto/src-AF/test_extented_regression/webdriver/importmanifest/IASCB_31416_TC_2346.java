...
/** Check sheet indication in Import documentation for not captured Checksheet **/  
...
public class IASCB_31416_TC_2346 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("Pieces2",cust.data("Pieces"));
			map.put("Weight2",cust.data("Weight"));
			map.put("HAWB","H"+cust.data("AWBNo2"));
			map.put("FullAWBNo1", cust.data("FullAWBNo2"));
			...
			cust.createXMLMessage("MessageExcelAndSheetXFWB", "MessageParamXFWB");
			Cgocxml.sendMessageCgoCXML("ICARGO");
			map.put("HAWB","H"+cust.data("AWBNo3"));
			map.put("Pieces2",cust.data("Pieces1"));
			map.put("Weight2",cust.data("Weight1"));
			map.put("FullAWBNo1", cust.data("FullAWBNo3"));
			...
			OPR001.verifyCheckSheetColumnStatus("awbNumber","blocker");	
			OPR001.verifyYellowIndicator("AWBNo","warning",false);	
			OPR001.verifyYellowIndicator("AWBNo2","warning",false);	
			OPR001.verifyYellowIndicator("AWBNo3","warning",true);	
