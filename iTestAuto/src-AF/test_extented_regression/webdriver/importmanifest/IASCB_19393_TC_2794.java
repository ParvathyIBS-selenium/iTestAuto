...
/**Verify bulk filter in ULD Sighting application **/
...
public class IASCB_19393_TC_2794 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			uldsighthht.clickBulkOption();
			uldsighthht.clickDoneInFilter();
			uldsighthht.clickApply();
			//verifying BULK ulds displayed after applying filter
			uldsighthht.verifyBulkTypeUld("val~BULK");
			libr.quitApp();
