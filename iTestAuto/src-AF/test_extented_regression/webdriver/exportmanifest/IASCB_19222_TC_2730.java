...
/** Verify that flight Date and time is displayed in red when estimated time is updated **/
...
public class IASCB_19222_TC_2730 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			ADD007.verifyFlightDate("StartDate");
			...
			//Calculate ETD exceeding STD
			map.put("ETD",cust.timeCalculation(cust.data("STD"), "HH:mm","HOUR",1));
			FLT006.enterETDDetails("StartDate","ETD");		
			FLT006.clickSave();
			...
			ADD007.clickContinuousCheckbox();
			ADD007.clickList();
			ADD007.verifyFlightTime("ETD", "val~E");
			ADD007.verifyFlightDate("StartDate");
			...
			FLT006.listFlight("carrierCode", "FlightNo", "StartDate");
			//Calculate ETD
			String atdTime=cust.timeCalculation(cust.data("ETD"), "HH:mm","HOUR",1);
			map.put("ATD", atdTime);
			FLT006.enterFlightMovementDepartureDetail("ATD","StartDate");	
			FLT006.clickSave();
			FLT006.closeTab("FLT006", "Mark Flight Movements");		
			...
			ADD007.clickContinuousCheckbox();
			ADD007.clickList();
			ADD007.verifyFlightTime("ATD", "val~A");
			ADD007.verifyFlightDate("StartDate");
			ADD007.verifyFlightTimeColour("Grey");
			cust.closeTab("ADD007", "Export Planning Progress");
