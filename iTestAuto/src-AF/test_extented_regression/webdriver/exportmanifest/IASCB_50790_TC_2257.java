...
/* TC_03_Manually Update actual weight of ULD from weight scale. */

//Pending verification in SHR011 due to defect 1512
...
public class IASCB_50790_TC_2257  extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String currtDate = cust.createDateFormatWithTimeZone("dd-MMM-YYYY", 0, "DAY", "Europe/Amsterdam");
			String endDate = cust.createDateFormat("dd-MMM-YYYY", 0, "DAY", "Europe/Amsterdam");
			map.put("StartDate", startDate);
			map.put("currtDate", currtDate);
			...
			map.put("FWBDate",
					cust.createDateFormat("ddMMMyy", 0, "DAY", "Europe/Amsterdam").toUpperCase());
			...
			uldsighthht.captureActualWeight("ScaleWeight");
