...

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			Cgomon.clickFlightNo("FullFlightNo");
			List <String> msgContents=new ArrayList<String>();
			msgContents.add("val~<CharacteristicCode>"+cust.data("UldType")+"</CharacteristicCode>");
			msgContents.add("val~<ID>"+cust.data("ULDNo")+"</ID>" );
			msgContents.add("val~<PrimaryID schemeAgencyID=\"3\">"+cust.data("prop~flight_code")+"</PrimaryID>");
			Cgomon.verifyMessageContent(msgContents,"XFUM",true);
			Cgomon.clickBack();
			...
			Cgomon.clickSearch();
			Cgomon.verifyMessageStatusForFlight("FullFlightNo", "Outgoing XFUM", "AFLS_MSCO_CXML");
			Cgomon.clickFlightNo("FullFlightNo");
			List <String> msgContents1=new ArrayList<String>();
			msgContents1.add("val~<ram:CharacteristicCode>"+cust.data("UldType")+"</ram:CharacteristicCode>");
			msgContents1.add("val~<ram:ID>"+cust.data("ULDNo")+"</ram:ID>" );
			msgContents1.add("val~<ram:PrimaryID schemeAgencyID=\"3\">"+cust.data("prop~flight_code")+"</ram:PrimaryID>");		
			Cgomon.verifyMessageContent(msgContents1,"XFUM",true);
			Cgomon.clickBack();
			libr.quitBrowser();
