...
//Verify FUM/xFUM message triggers during CART unassignment from scanner

public class IASCB_109216_TC_2921 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cust.searchScreen("OPR344", "Export manifest");
			OPR344.listFlight("prop~flight_code", "FlightNo", "StartDate");
			//verifying offloaded ULD in the planned section
			...
			/**Verifying CART ID**/
			msgContentsPresent.add("val~<CharacteristicCode>"+"BLK"+"</CharacteristicCode>"+"\n"+"<ID>"+cust.data("ULDNo")+"</ID>" );
			...
			/**Verifying Contour Code**/
			msgContentsPresent.add("val~<ContourCode>"+cust.data("Contour")+"</ContourCode>" );
