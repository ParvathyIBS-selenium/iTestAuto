...
/* TC_04_error when Manually Update actual weight of ULD from weight scale.. */
...
public class IASCB_50790_TC_2258  extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			uldsighthht.captureWeight("Weight");
			uldsighthht.verifyError("The weight and it\'s confirmation do not match. Please re-enter the weights");
			uldsighthht.clickCloseBtnForCaptureWeight();
			libr.quitApp();
