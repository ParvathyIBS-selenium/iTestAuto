...
/** TC_06_Verify unique Sender address for outgoing XFZB or FZB for AMS(DL shipment) **/
...
public class IASCB_149878_TC_9278_AF_Descoped extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			/** Verifying Unique Sender Address in the Outgoing XFZB **/
			List <String> msgContents1=new ArrayList<String>();				
			msgContents1.add("val~<SenderParty>"+"\n"+"<PrimaryID schemeID="+"\"C\""+">"+cust.data("UniqueSenderAddress")+"</PrimaryID>"+"\n"+"</SenderParty>");								
			MSG005.verifyMessageContent(msgContents1,"XFZB",true);
			MSG005.closeView();
