...
/**  TC_01_Verify AWB  details sent to CGOSPA during AWB As-is-execution -paper capture  **/
...
public class PublishAWBDetails_TC_3130 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//verifying the PublisAWBDetailsn message details
			...
			MSG005.verifyIfMessageTriggered(pmKeyCGOSPADetails,cust.data("ProfileId"),"AWBDTL",true);	
            MSG005.clickCheckBox("pmKeyCGOSPADetail");
			MSG005.clickView();
			List <String> msgContents=new ArrayList<String>();
			msgContents.add("val~totalNumberOfPieces>"+cust.data("Pieces"));
			msgContents.add("val~totalStatedWeight>"+cust.data("statedWeight"));
			msgContents.add("val~agentCode>"+cust.data("AgentCode"));
			msgContents.add("val~customerCode>"+cust.data("shipperCode"));
			msgContents.add("val~customerCode>"+cust.data("consigneeCode"));
			msgContents.add("val~ItemTotalCharge>"+cust.data("Totalcharge"));
			...
			cgospa.clickAWBNo();
			//verifying scc details for the flight
			cgospa.verifySCCDetails("FullFlightNo", cust.data("ExpectedSCCs"), cust.data("SCC"));

			//verifying the details in publishAWBDetails message reflected in CGOSPA
			int col[] = { 10, 11, 15};
			String[] actVal = { cust.data("Pieces"), cust.data("Weight"),"N" };
			String pmKey = cust.data("FullFlightNo");
