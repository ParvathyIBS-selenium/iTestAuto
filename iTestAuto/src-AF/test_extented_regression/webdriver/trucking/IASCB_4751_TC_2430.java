	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			if(cust.data("tokenInWaitingArea").equals("true"))
			{
				...
				//verifying generated token number is displayed
				serpointhht.verifyGeneratedTokenNo("TokenId");

				serpointhht.clickDock();
				serpointhht.enterToken("TokenId");

				//selecting Service Point 
				serpointhht.enterServicePointName("CallForwardTo");
