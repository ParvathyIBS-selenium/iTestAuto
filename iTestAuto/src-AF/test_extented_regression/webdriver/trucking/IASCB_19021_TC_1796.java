...
/**
 *  1796 - TC_04_Check the display of tokens based on public side filter.
 **/


public class IASCB_19021_TC_1796 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			TGC010.enterToken("PublicToken");
			TGC010.selectSource("KioskLocation");
			TGC010.clickList();
			TGC010.verifyTokenDisplayed("PublicToken", true);
