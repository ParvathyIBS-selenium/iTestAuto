...
/**
 * Test ID : 1828 - TC_01_Verify that fields vehicle number and expiry date are present

 **/


public class IASCB_19076_TC_1828 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("FirstName", cust.data("Name").split(" ")[0]);
			map.put("LastName", cust.data("Name").split(" ")[1]);
			...
			//Capture truck details, truck type as "Truck"
			TGC013.captureTruckDetails("4","VehicleNo");

			//Capture registration number
			TGC013.enterRegistrationNumber("val~12345");
