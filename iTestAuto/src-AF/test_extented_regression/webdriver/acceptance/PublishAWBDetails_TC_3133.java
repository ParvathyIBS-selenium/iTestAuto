package acceptance;
/**  TC_04_Verify AWB  details sent to CGOSPA during ULD acceptance   **/
...
public class PublishAWBDetails_TC_3133 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//verifying the details in publishAWBDetails message reflected in CGOSPA
			int col1[] = { 10, 11,14 };
			String pmKey1 = cust.data("UldNum");
