...
/**TC_03_Verify shipment location details during complete ULD acceptance via webscreen  to CGOSPA**/
...
public class PublishShipmentRelocation_TC_3027 extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			//verifying scc details for the Uldnum
			...
			String[] actVerfValues1 ={cust.data("Pieces"),cust.data("Weight"),cust.data("HA")+cust.data("Location")};
			...
			//built up the uld to the flight
