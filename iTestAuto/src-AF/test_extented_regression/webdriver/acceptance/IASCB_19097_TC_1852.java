package acceptance;
/**  TC_22_Verify the icargo system receives the screening status from external system with status as Fail  **/
...
public class IASCB_19097_TC_1852 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			relocationhht.enterDestLocation("RapixEntryLocation_second");
			...
			OPR023.verifyBlockDetails(verfCols, actVerfValues, "RESTRICTED BY BLOCKS");
