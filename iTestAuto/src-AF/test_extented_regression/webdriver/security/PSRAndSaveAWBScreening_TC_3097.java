...
/**  TC_08_Verify block is not released when screening is not complete for All the pieces of AWB from RAPIX.- web **/
...
public class PSRAndSaveAWBScreening_TC_3097 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR335.selectSCC(cust.data("SCC").split(",")[0]);

			OPR335.addLooseShipment();

			//Accepting into SU2
			OPR335.enterLooseShipmentDetails("Location1", "Pcs2","Wgt2");
			OPR335.selectSCC(cust.data("SCC").split(",")[1]);
			...
			/******* PAWBS POST REQUEST for SU1 - only SU1 pcs are screened as Pass ****/	
			...
			String SUs[]={cust.data("SU1")};
			String ScreeningMethods[]={cust.data("screenmethod")};
			String ScreenedPcs[]={cust.data("Pcs").split(",")[0]};
			String ScreenedWgt[]={cust.data("Wgt").split(",")[0]};
			String ScreeningResult[]={cust.data("ScreeningResult").split(",")[1]};
			...
			jsonbody.postRequest(cust.data("CarrierNumericCode"), cust.data("AWBNo"), timeStamp,cust.data("ScreeningResult").split(",")[0],screenmethod,cust.data("RapixEntryLocation"),cust.data("ScreenerName"),cust.data("SU2"));

			/**** OPR339 - Security & Screening ****/
			cust.searchScreen("OPR339", "Security and Screening");
			OPR339.listAWBNo("AWBNo", "CarrierNumericCode", "OPR339 - Security & Sceening");

			String SUs1[]={cust.data("SU1"),cust.data("SU2")};
			String ScreeningMethods1[]={cust.data("screenmethod"),cust.data("screenmethod")};
			String ScreenedPcs1[]={cust.data("Pcs").split(",")[0], cust.data("Pcs").split(",")[1]};
			String ScreenedWgt1[]={cust.data("Wgt").split(",")[0], cust.data("Wgt").split(",")[1]};
			String ScreeningResult1[]={cust.data("ScreeningResult").split(",")[1],cust.data("ScreeningResult").split(",")[1]};

			OPR339.verifyScreeningDetailsOfMultipleSUs(SUs1,ScreeningMethods1,ScreeningResult1,ScreenedPcs1,ScreenedWgt1);		
			OPR339.verifyScreenerDetails("ScreenerName",timeStamp.split(" ")[0]);
			String Sccnotpresent1[]={"NSC"};
			OPR339.verifySccNotPresent(Sccnotpresent1);
			String Sccpresent1[]={"SPX"};
			OPR339.verifyScc(Sccpresent1);
			cust.closeTab("OPR339", "Security & Screening");  
