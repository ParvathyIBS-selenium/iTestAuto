...
public class IASCB_87313_TC_4342 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String supplCustoms[]={"MRN","RegulatedAgent","Expiry","screenmethod","UserName","SDtime",};
			String source[]={"val~FWB","val~FWB","val~FWB","val~FWB","val~FWB","val~FWB"};
			String infoId[]={"val~EXP","val~ISS","val~ ","val~ ","val~ ","val~ "};
			String customsInfoId[]={"val~M","val~RA","val~ED","val~SM","val~SN","val~SD"};	
