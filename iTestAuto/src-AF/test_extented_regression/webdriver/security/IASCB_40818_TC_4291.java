...
/***TC_06_Display of screening methods when first screening gets failed and second gets passed***/
...
public class IASCB_40818_TC_4291 extends BaseSetup
{
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
		   ...
		   cust.loginICargoSTG(iCargo[1], iCargo[2]);
			...
			OPR026.verifySecurityStatus("IN ERROR");
			...
			String ScreeningMethodFailCode = screeningMethod[0].substring(0, 3);
					...
					"Contents of Consignment"+"\n"+
							...
							cust.data("Origin")+"\n"+
									...
									"Security Status"+"\n"+
											...
											"Received from"+"\n"+
											cust.data("val~NSC"),
											cust.data("ScreeningMethodFailCode"));
					...
					"Contents of Consignment"+"\n"+
							...
							cust.data("Origin")+"\n"+
									...
									"Security Status"+"\n"+
											...
											"Received from"+"\n"+
											cust.data("val~SPX"),
											cust.data("ScreeningMethodPassCode"));
