package security;
/**  TC_04_Verify block not release when shipment screening status Fail is received from RAPIX  **/
...
public class PSRAndSaveAWBScreening_TC_3093 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		cust.createXMLMessage("MessageExcelAndSheetXFZB", "MessageParamXFZB");
			...
			relocationhht.enterValueWithoutNext("SU");
			...
			OPR339.verifyFailureReason("FailureReason");
			...
			//Verifying Screening method can be Edited
			OPR339.clickEditScreeningInfo();
			String[] screeningMethod={cust.data("ScreeningMethodEdit").split(",")[0],cust.data("ScreeningMethodEdit").split(",")[1]};
			map.put("ScreeningMethodEditCode", screeningMethod[0]);
			String ScreeningMethodedited = screeningMethod[1];
			map.put("ScreeningMethodEdited",ScreeningMethodedited);	
			OPR339.selectScreeningMethod("ScreeningMethodEdited");
	        OPR339.clickOk();
			...
			//verification of Edited Screening Method
			cust.searchScreen("OPR339", "Security and Screening");
			...
			cust.printAndVerifyReport("val~Consignment Security Declaration","OPR339",
				cust.data("ScreeningMethodEditCode"));
			...
			//Verifying Screening method can be Deleted
			OPR339.deleteScreeningDetails(1);;
			String[] screeningMethodNew={cust.data("ScreeningMethodToAdd").split(",")[0],cust.data("ScreeningMethodToAdd").split(",")[1]};
			map.put("ScreeningMethodNewCode", screeningMethodNew[0]);
			String ScreeningMethodAdd = screeningMethodNew[1];
			map.put("ScreeningMethodAdd",ScreeningMethodAdd);	
			OPR339.selectScreeningMethod("ScreeningMethodAdd");
			OPR339.enterPcsToBeScreened("Pieces");
            OPR339.enterWgtOfScreenedPcs("Weight");
            OPR339.selectScreeningStatus("val~Pass");
            OPR339.clickOk();
	        OPR339.saveSecurityDetails();
			cust.closeTab("OPR339", "Security & Sceening");
			...
			OPR339.clickPrintForVerification();
			cust.printAndVerifyReport("val~Consignment Security Declaration","OPR339",
					cust.data("val~SPX"),cust.data("ScreeningMethodNewCode"));
			cust.closeTab("OPR339", "Security & Screening"); 
