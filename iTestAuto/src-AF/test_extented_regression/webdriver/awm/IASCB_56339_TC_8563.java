...
/***TC_03_Verify Super user is able to view the list of ULDs assigned both to TOP and RFS**/
public class IASCB_56339_TC_8563 extends BaseSetup {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String flightdate2 = cust.createDateFormatWithTimeZone("yyyy-MM-dd", 0, "DAY", "");
			map.put("XFWBDate", flightdate2);
			...
			map.put("AircrafTyp", cust.data("AircraftType").split(",")[0]);
			...
			map.put("FBLDate", cust.createDateFormat("ddMMM", 0, "DAY", "").toUpperCase());
			map.put("AircrafTyp", cust.data("AircraftType").split(",")[1]);
			cust.createTextMessage("MessageExcelAndSheetSSM", "MessageParamSSM");
			MSG005.loadFromFile("All", "ALL", "MQ-SERIES", "", "Origin", "", "SSM_NEW");
			...
			ADD013.enterToDate("Date");
			ADD013.enterFlightCode("carrierCode");
			ADD013.enterFlightNum("FlightNo2");
			ADD013.clickList();
			ADD013.selectEquipmentType(cust.data("EquipmentType2"), "Equipment2");
			cust.waitForSync(1);
			cust.closeTab("ADD013", "Assign outbound flight to equipment");
			...
			ADD017.verifyULDdetails("UldNum2", "Equipment2",true);
			libr.quitBrowser();
