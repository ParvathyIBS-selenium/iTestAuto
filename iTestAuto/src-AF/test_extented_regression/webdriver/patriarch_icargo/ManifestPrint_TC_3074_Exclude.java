...
/*** TC_07_Print manifest at export manifest for THRU shipments and verify in Patriarch system.**/
...
public class ManifestPrint_TC_3074_Exclude extends BaseSetup

{
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String routing[] = { cust.data("Origin") + ";" + cust.data("Transit")};
			...
			OPR344.selectAdditionalDocType("ULD_MAWB_THRU");
			OPR344.printManifestOkWithoutFrame();
			cust.printAndVerifyReport("val~CARGO MANIFEST", "OPR344",cust.data("carrierCode")+" "+cust.data("FlightNo"),cust.data("UldNum"),cust.data("FullAWBNo"));
