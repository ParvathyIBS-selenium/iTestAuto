...
/**TC_04_Capture Payment Advice  from icargo and verify in Patriarch system-for credit payment when AWB is reopened and executed again with modified pcs -wgt**/
...
public class PaymentAdvice_TC_3082_Exclude extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			cust.setPropertyValue("FullAWBNo", cust.data("prop~CarrierNumericCode") + "-" + cust.data("prop~AWBNo"),
					proppath);
			...
			OPR026.updateStatedValues("Pieces", "Weight", "Volume");
			OPR026.asIsExecuteCXML();
			cust.closeTab("OPR026", "Capture AWB");
