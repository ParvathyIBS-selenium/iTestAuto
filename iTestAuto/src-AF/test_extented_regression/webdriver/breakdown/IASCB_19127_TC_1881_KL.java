...
/**
 * 
 *  1881 - TC_02_Capture the instruction for breakdown transaction
 *
 *
 */

public class IASCB_19127_TC_1881_KL extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			bdhht.clickInstructionIcon("FullAWBNo");
			bdhht.verifyRemarks("Remarks");
			bdhht.clickClose();
			libr.quitApp();
