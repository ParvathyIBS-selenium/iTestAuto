...
//			// Maintain Flight Screen (FLT005) . Taking fresh flight
		   ...
		   cust.switchRole("Transit", "FCTL", "RoleGroup");
			...
			WHS013.clickList();
			String Zone=WHS013.getZoneCode();
			map.put("Breakdown_StorageAreaZone_Transit", WebFunctions.getPropertyValue(toproppath, "Breakdown_StorageAreaZone_Transit"));
			WHS013.verifyZone(cust.data("Breakdown_StorageAreaZone_Transit"),Zone);
