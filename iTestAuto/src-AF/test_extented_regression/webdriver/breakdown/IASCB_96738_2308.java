package breakdown;
/**Verify the breakdown Start date and time displayed in listing screen (Intact ULD)  **/
...
public class IASCB_96738_2308 extends BaseSetup {
	...
	@DataProvider(name = "IASCB_96738_2308")
	...
	@Test(dataProvider = "IASCB_96738_2308")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ConsigneeCode", WebFunctions.getPropertyValue(custproppath, "creditCustomerId_FR1"));
			map.put("ConsigneeName", WebFunctions.getPropertyValue(custproppath, "creditCustomerName_FR1"));
			map.put("ConsigneePostCode", WebFunctions.getPropertyValue(custproppath, "creditCustomerpostCode_FR1"));
			map.put("ConsigneeStreetName", WebFunctions.getPropertyValue(custproppath, "creditCustomerstreetName_FR1"));
			map.put("ConsigneeCityName", WebFunctions.getPropertyValue(custproppath, "creditCustomercityName_FR1"));
			map.put("ConsigneeCountryId", WebFunctions.getPropertyValue(custproppath, "creditCustomercountryId_FR1"));
			map.put("ConsigneeCountryName", WebFunctions.getPropertyValue(custproppath, "creditCustomercountryName_FR1"));
			map.put("ConsigneeCountrySubDiv",WebFunctions.getPropertyValue(custproppath, "creditCustomercountryName_FR1"));
			map.put("ConsigneePhoneNo", WebFunctions.getPropertyValue(custproppath, "creditCustomertelephoneNo_FR1"));
			map.put("ConsigneeEmail", WebFunctions.getPropertyValue(custproppath, "creditCustomeremail_FR1"));
			...
			String shipment[] = { cust.data("FullAWBNo") + ";" + cust.data("Pieces") + ";" + cust.data("Weight") + ";"
					+ cust.data("Volume") + ";" + cust.data("ShipmentDesc"),cust.data("FullAWBNo2") + ";" + cust.data("Pieces") + ";" + cust.data("Weight") + ";"
			...
			OPR367.selectBDInstructionforULD("UldNum", "val~Intact Unit");
			...
			bdlsthht.verifySLATime("ATA","StartDate");	
			bdlsthht.verifyEPSTime("ATA","StartDate","Destination");	
			bdlsthht.verifyLPSTimeWithoutDeliverySlot("ATA","BCT","StartDate");
			libr.quitApp();
