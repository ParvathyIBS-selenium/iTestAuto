...
public class IASCB_19229_TC_2928 extends BaseSetup {
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			String startDate = cust.createDateFormatWithTimeZone("dd-MMM-YYYY", 1, "DAY", "Europe/Amsterdam");
			String endDate = cust.createDateFormatWithTimeZone("dd-MMM-YYYY", 8, "DAY", "Europe/Amsterdam");
			map.put("StartDate", startDate);
			map.put("EndDate", endDate);
			map.put("SSMStartDate", cust.createDateFormatWithTimeZone("ddMMM", 1, "DAY", "Europe/Amsterdam"));
			map.put("SSMEndDate", cust.createDateFormatWithTimeZone("ddMMM",8, "DAY", "Europe/Amsterdam"));
			...
			String flightdate1 = cust.createDateFormatWithTimeZone("yyyy-MM-dd", 1, "DAY", "Europe/Amsterdam");
			...
			int milestoneCalcTime =Integer.parseInt(cust.data("milestoneCalc"));
			OPR367.verifyLPSForTerminalShipment(ATA_Date_TimeText, milestoneCalcTime,"UldNum");
