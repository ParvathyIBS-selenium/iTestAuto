...
/**  Verify icargo requests for DG Details to Cafeed for Found AWB**/

public class ProvideDG_TC_2954 extends BaseSetup {
	int counter = 0;
	...
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			OPR367.addNewULDWithExistingAWB("val~BULK", "CarrierNumericCode", "AWBNo", "Pieces", "Weight");
			OPR367.SaveDetails();
