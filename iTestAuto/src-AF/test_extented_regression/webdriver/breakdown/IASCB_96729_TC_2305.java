package breakdown;
/**    Breakdown status filter in Breakdown List HHT screen   **/
...
public class IASCB_96729_TC_2305 extends BaseSetup {
	...
	@DataProvider(name = "IASCB_96729_TC_2305")
	...
	@Test(dataProvider = "IASCB_96729_TC_2305")
	public void getTestSuite(Map<Object, Object> map) {
		...
		try {
			...
			map.put("ULDNo", uldNo.substring(3, 8));
			...
			String uld[] = { cust.data("UldType1") + ";" + cust.data("ULDNo") + ";" + cust.data("carrierCode"),cust.data("UldType") + ";" + cust.data("ULDNo1") + ";" + cust.data("carrierCode"),cust.data("UldType") + ";" + cust.data("ULDNo2") + ";" + cust.data("carrierCode") };
			...
			String uldss[]={cust.data("UldNum"),cust.data("UldNum1"),cust.data("UldNum2")};
			OPR367.verifyUldDetails(3,uldss);			
			OPR367.SaveDetails();
			...
			//In-Progress ULD
			OPR367.clickCheckBox_ULD(uldNo1);
			OPR367.clickBreakdownButton();
			OPR367.enterBdnDetails_multipleShipments(1,Location,Pieces,Weight);
			...
			bdlsthht.verifyStatusFilters(false,"UldNum2");

			//Verifying Breakdown Status filter - In Progress
			bdlsthht.clickBreakdownListFilter();	
			bdlsthht.selectBDStatus("val~Completed",false);
			bdlsthht.selectBDStatus("val~In Progress",true);
			bdlsthht.clickOK();
			...
			bdlsthht.clickBreakdownListFilter();	
			bdlsthht.selectBDStatus("val~In Progress",false);
			bdlsthht.selectBDStatus("val~Not Started",true);
			bdlsthht.clickOK();
			bdlsthht.verifyStatusFilters(false,"UldNum");
			bdlsthht.verifyStatusFilters(false,"UldNum1");
			bdlsthht.verifyStatusFilters(true,"UldNum2");				
			libr.quitApp();
